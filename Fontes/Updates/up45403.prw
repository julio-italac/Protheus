...
/*/
//--------------------------------------------------------------------
User Function UP45403( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP45403" )
				Else
					MsgStop( "Atualização não realizada.", "UP45403" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'Follow up Contas a Receber'											, ; //X2_NOME
	'Follow up Contas a Receber'											, ; //X2_NOMESPA
	'Follow up Contas a Receber'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Prefixo'																, .F. }, ; //X3_TITSPA
	{ 'Prefixo'																, .F. }, ; //X3_TITENG
	{ 'Prefixo'																, .F. }, ; //X3_DESCRIC
	{ 'Prefixo'																, .F. }, ; //X3_DESCSPA
	{ 'Prefixo'																, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ 'SE1->E1_PREFIXO'														, .F. }, ; //X3_RELACAO
	{ ''																	, .F. }, ; //X3_F3
	{ 0																		, .F. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .F. }, ; //X3_RESERV
	{ ''																	, .F. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 9																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Numero Tit.'															, .F. }, ; //X3_TITULO
	{ 'Numero Tit.'															, .F. }, ; //X3_TITSPA
	{ 'Numero Tit.'															, .F. }, ; //X3_TITENG
	{ 'Numero do Tititulo'													, .F. }, ; //X3_DESCRIC
	{ 'Numero do Tititulo'													, .F. }, ; //X3_DESCSPA
	{ 'Numero do Tititulo'													, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ 'SE1->E1_NUM'															, .F. }, ; //X3_RELACAO
	{ ''																	, .F. }, ; //X3_F3
	{ 0																		, .F. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .F. }, ; //X3_RESERV
	{ ''																	, .F. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Sequencia'															, .F. }, ; //X3_TITSPA
	{ 'Sequencia'															, .F. }, ; //X3_TITENG
	{ 'Sequencia'															, .F. }, ; //X3_DESCRIC
	{ 'Sequencia'															, .F. }, ; //X3_DESCSPA
	{ 'Sequencia'															, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ 'U_AFIN034GNU()'														, .F. }, ; //X3_RELACAO
	{ ''																	, .F. }, ; //X3_F3
	{ 0																		, .F. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .F. }, ; //X3_RESERV
	{ ''																	, .F. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 200																	, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Desc. Atend.'														, .F. }, ; //X3_TITULO
	{ 'Desc. Atend.'														, .F. }, ; //X3_TITSPA
	{ 'Desc. Atend.'														, .F. }, ; //X3_TITENG
	{ 'Descricao do Atendimento'											, .F. }, ; //X3_DESCRIC
	{ 'Descricao do Atendimento'											, .F. }, ; //X3_DESCSPA
	{ 'Descricao do Atendimento'											, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ ''																	, .F. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZAC'																	, .F. }, ; //X3_ARQUIVO
	{ '09'																	, .F. }, ; //X3_ORDEM
	{ 'ZAC_VALOR'															, .F. }, ; //X3_CAMPO
	{ 'N'																	, .F. }, ; //X3_TIPO
	{ 9																		, .F. }, ; //X3_TAMANHO
	{ 2																		, .F. }, ; //X3_DECIMAL
	{ 'Vr Tratado'															, .F. }, ; //X3_TITULO
	{ 'Vr Tratado'															, .F. }, ; //X3_TITSPA
	{ 'Vr Tratado'															, .F. }, ; //X3_TITENG
	{ 'Vr Tratado'															, .F. }, ; //X3_DESCRIC
	{ 'Vr Tratado'															, .F. }, ; //X3_DESCSPA
	{ 'Vr Tratado'															, .F. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ ''																	, .F. }, ; //X3_OBRIGAT
	{ ''																	, .F. }, ; //X3_VLDUSER
	{ 'V=VRB;D=DEV;M=MUL;O=OUT'												, .F. }, ; //X3_CBOX
	{ ''																	, .F. }, ; //X3_CBOXSPA
	{ ''																	, .F. }, ; //X3_CBOXENG
	{ ''																	, .F. }, ; //X3_PICTVAR
	{ ''																	, .F. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZAC'																	, .F. }, ; //X3_ARQUIVO
	{ '11'																	, .F. }, ; //X3_ORDEM
	{ 'ZAC_CODUSU'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 6																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Cod Usuario'															, .F. }, ; //X3_TITULO
	{ 'Cod Usuario'															, .F. }, ; //X3_TITSPA
	{ 'Cod Usuario'															, .F. }, ; //X3_TITENG
	{ 'Cod Usuario'															, .F. }, ; //X3_DESCRIC
	{ 'Cod Usuario'															, .F. }, ; //X3_DESCSPA
	{ 'Cod Usuario'															, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ 'RETCODUSR( )'														, .F. }, ; //X3_RELACAO
	{ 'US1'																	, .F. }, ; //X3_F3
	{ 0																		, .F. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .F. }, ; //X3_RESERV
	{ ''																	, .F. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'ZAC'																	, .F. }, ; //X3_ARQUIVO
	{ '12'																	, .F. }, ; //X3_ORDEM
	{ 'ZAC_NOMUSU'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 50																	, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Nome Usuario'														, .F. }, ; //X3_TITULO
	{ 'Nome Usuario'														, .F. }, ; //X3_TITSPA
	{ 'Nome Usuario'														, .F. }, ; //X3_TITENG
	{ 'Nome Usuario'														, .F. }, ; //X3_DESCRIC
	{ 'Nome Usuario'														, .F. }, ; //X3_DESCSPA
	{ 'Nome Usuario'														, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ 'FWGETUSERNAME(RETCODUSR())'											, .F. }, ; //X3_RELACAO
	{ ''																	, .F. }, ; //X3_F3
	{ 0																		, .F. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .F. }, ; //X3_RESERV
	{ ''																	, .F. }, ; //X3_CHECK
...
aAdd( aSIX, { ;
	'ZAC'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZAC_FILIAL+ZAC_PREFIX+ZAC_NUM+ZAC_TIPO+ZAC_SEQ'						, ; //CHAVE
	'Prefixo+Numero Tit.+Tipo+Sequencia'									, ; //DESCRICAO
	'Prefixo+Numero Tit.+Tipo+Sequencia'									, ; //DESCSPA
	'Prefixo+Numero Tit.+Tipo+Sequencia'									, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP45403" ) ) ) ;
