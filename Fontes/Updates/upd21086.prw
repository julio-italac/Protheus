...
ฑฑบ Programa ณ UPD21086 บ Autor ณ TOTVS Protheus     บ Data ณ  18/09/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPD21086   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPD21086( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPD21086" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPD21086" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  18/09/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  18/09/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hash Consult'															, ; //X3_TITULO
	'Hash Consult'															, ; //X3_TITSPA
	'Hash Consult'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome Antigo'															, ; //X3_TITULO
	'Nome Antigo'															, ; //X3_TITSPA
	'Nome Antigo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Insc antiga'															, ; //X3_TITULO
	'Insc antiga'															, ; //X3_TITSPA
	'Insc antiga'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'End Antigo'															, ; //X3_TITULO
	'End Antigo'															, ; //X3_TITSPA
	'End Antigo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Bairro Antig'															, ; //X3_TITULO
	'Bairro Antig'															, ; //X3_TITSPA
	'Bairro Antig'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Bairro Novo'															, ; //X3_TITULO
	'Bairro Novo'															, ; //X3_TITSPA
	'Bairro Novo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Mun Antigo'															, ; //X3_TITULO
	'Mun Antigo'															, ; //X3_TITSPA
	'Mun Antigo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod mun Anti'															, ; //X3_TITULO
	'Cod mun Anti'															, ; //X3_TITSPA
	'Cod mun Anti'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod Mun Novo'															, ; //X3_TITULO
	'Cod Mun Novo'															, ; //X3_TITSPA
	'Cod Mun Novo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cep Antigo'															, ; //X3_TITULO
	'Cep Antigo'															, ; //X3_TITSPA
	'Cep Antigo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sit Sint ant'															, ; //X3_TITULO
	'Sit Sint ant'															, ; //X3_TITSPA
	'Sit Sint ant'															, ; //X3_TITENG
	'Situacao Cad Sintegra Ant'												, ; //X3_DESCRIC
	'Situacao Cad Sintegra Ant'												, ; //X3_DESCSPA
	'Situacao Cad Sintegra Ant'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sit Sint Nov'															, ; //X3_TITULO
	'Sit Sint Nov'															, ; //X3_TITSPA
	'Sit Sint Nov'															, ; //X3_TITENG
	'Situacao Cd Sintegra Nova'												, ; //X3_DESCRIC
	'Situacao Cd Sintegra Nova'												, ; //X3_DESCSPA
	'Situacao Cd Sintegra Nova'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt Cons St A'															, ; //X3_TITULO
	'Dt Cons St A'															, ; //X3_TITSPA
	'Dt Cons St A'															, ; //X3_TITENG
	'Data Cons Sintegra Antiga'												, ; //X3_DESCRIC
	'Data Cons Sintegra Antiga'												, ; //X3_DESCSPA
	'Data Cons Sintegra Antiga'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt Cons ST N'															, ; //X3_TITULO
	'Dt Cons ST N'															, ; //X3_TITSPA
	'Dt Cons ST N'															, ; //X3_TITENG
	'Data Cons Sintegra Nova'												, ; //X3_DESCRIC
	'Data Cons Sintegra Nova'												, ; //X3_DESCSPA
	'Data Cons Sintegra Nova'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At St Ant'															, ; //X3_TITULO
	'Dt At St Ant'															, ; //X3_TITSPA
	'Dt At St Ant'															, ; //X3_TITENG
	'Data Atual Sint Antiga'												, ; //X3_DESCRIC
	'Data Atual Sint Antiga'												, ; //X3_DESCSPA
	'Data Atual Sint Antiga'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At St Nov'															, ; //X3_TITULO
	'Dt At St Nov'															, ; //X3_TITSPA
	'Dt At St Nov'															, ; //X3_TITENG
	'Data Atual Sint Nova'													, ; //X3_DESCRIC
	'Data Atual Sint Nova'													, ; //X3_DESCSPA
	'Data Atual Sint Nova'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At Reg An'															, ; //X3_TITULO
	'Dt At Reg An'															, ; //X3_TITSPA
	'Dt At Reg An'															, ; //X3_TITENG
	'Data Atual Reg Antiga'													, ; //X3_DESCRIC
	'Data Atual Reg Antiga'													, ; //X3_DESCSPA
	'Data Atual Reg Antiga'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At Reg No'															, ; //X3_TITULO
	'Dt At Reg No'															, ; //X3_TITSPA
	'Dt At Reg No'															, ; //X3_TITENG
	'Data Atual Reg Nova'													, ; //X3_DESCRIC
	'Data Atual Reg Nova'													, ; //X3_DESCSPA
	'Data Atual Reg Nova'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Bloqueio Ant'															, ; //X3_TITULO
	'Bloqueio Ant'															, ; //X3_TITSPA
	'Bloqueio Ant'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Bloqueio Nov'															, ; //X3_TITULO
	'Bloqueio Nov'															, ; //X3_TITSPA
	'Bloqueio Nov'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hr Reg Antig'															, ; //X3_TITULO
	'Hr Reg Antig'															, ; //X3_TITSPA
	'Hr Reg Antig'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hr Reg Novo'															, ; //X3_TITULO
	'Hr Reg Novo'															, ; //X3_TITSPA
	'Hr Reg Novo'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt Cons RC A'															, ; //X3_TITULO
	'Dt Cons RC A'															, ; //X3_TITSPA
	'Dt Cons RC A'															, ; //X3_TITENG
	'Data Cons Receita Antiga'												, ; //X3_DESCRIC
	'Data Cons Receita Antiga'												, ; //X3_DESCSPA
	'Data Cons Receita Antiga'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt Cons RC N'															, ; //X3_TITULO
	'Dt Cons RC N'															, ; //X3_TITSPA
	'Dt Cons RC N'															, ; //X3_TITENG
	'Data Cons Receita Nova'												, ; //X3_DESCRIC
	'Data Cons Receita Nova'												, ; //X3_DESCSPA
	'Data Cons Receita Nova'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At RC Ant'															, ; //X3_TITULO
	'Dt At RC Ant'															, ; //X3_TITSPA
	'Dt At RC Ant'															, ; //X3_TITENG
	'Data Atual Recei Antiga'												, ; //X3_DESCRIC
	'Data Atual Recei Antiga'												, ; //X3_DESCSPA
	'Data Atual Recei Antiga'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt At RC Nov'															, ; //X3_TITULO
	'Dt At RC Nov'															, ; //X3_TITSPA
	'Dt At RC Nov'															, ; //X3_TITENG
	'Data Atual Receita Nova'												, ; //X3_DESCRIC
	'Data Atual Receita Nova'												, ; //X3_DESCSPA
	'Data Atual Receita Nova'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sit Rec Anti'															, ; //X3_TITULO
	'Sit Rec Anti'															, ; //X3_TITSPA
	'Sit Rec Anti'															, ; //X3_TITENG
	'Sit Receita Antiga'													, ; //X3_DESCRIC
	'Sit Receita Antiga'													, ; //X3_DESCSPA
	'Sit Receita Antiga'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Sit Rec Nova'															, ; //X3_TITULO
	'Sit Rec Nova'															, ; //X3_TITSPA
	'Sit Rec Nova'															, ; //X3_TITENG
	'Sit Receit Nova'														, ; //X3_DESCRIC
	'Sit Receit Nova'														, ; //X3_DESCSPA
	'Sit Receit Nova'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Usr Atualiz'															, ; //X3_TITULO
	'Usr Atualiz'															, ; //X3_TITSPA
	'Usr Atualiz'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'At Cli/Cisp'															, ; //X3_TITULO
	'At Cli/Cisp'															, ; //X3_TITSPA
	'At Cli/Cisp'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
...
aAdd( aSIX, { ;
	'ZGF'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZGF_FILIAL+ZGF_CODCLI+ZGF_LOJA+ZGF_HASH'								, ; //CHAVE
	'CLIENTE+LOJA+HASH'														, ; //DESCRICAO
	'CLIENTE+LOJA+HASH'														, ; //DESCSPA
	'CLIENTE+LOJA+HASH'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
