...
/*/
//--------------------------------------------------------------------
User Function UPD37704( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD37704" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD37704" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'Z19'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'Z19_OPERAC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tps. Operaca'														, .T. }, ; //X3_TITULO
	{ 'Tps. Operaca'														, .T. }, ; //X3_TITSPA
	{ 'Tps. Operaca'														, .T. }, ; //X3_TITENG
	{ 'Tipos de Operacao'													, .T. }, ; //X3_DESCRIC
	{ 'Tipos de Operacao'													, .T. }, ; //X3_DESCSPA
	{ 'Tipos de Operacao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'NaoVazio()'															, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD37704" ) ) ) ;
