...
/*/
//--------------------------------------------------------------------
User Function UP42164( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP42164" )
				Else
					MsgStop( "Atualização não Realizada.", "UP42164" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Relat Fech F'															, ; //X3_TITULO
	'Relat Fech F'															, ; //X3_TITSPA
	'Relat Fech F'															, ; //X3_TITENG
	'Relat Fechamento Financei'												, ; //X3_DESCRIC
	'Relat Fechamento Financei'												, ; //X3_DESCSPA
	'Relat Fechamento Financei'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Recebe Relatório de fechamento' )
aAdd( aHlpPor, 'financeiro.' )

aHlpEng := {}
aAdd( aHlpEng, 'Recebe Relatório de fechamento' )
aAdd( aHlpEng, 'financeiro.' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Recebe Relatório de fechamento' )
aAdd( aHlpSpa, 'financeiro.' )

PutSX1Help( "PZZL_REFFIN", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZL_REFFIN" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP42164" ) ) ) ;
