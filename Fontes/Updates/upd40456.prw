...
/*/
//--------------------------------------------------------------------
User Function UPD40456( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD40456" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD40456" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZZQ'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZZQ_PRODUT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 170																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Exceto Produ'														, .T. }, ; //X3_TITULO
	{ 'Exceto Produ'														, .T. }, ; //X3_TITSPA
	{ 'Exceto Produ'														, .T. }, ; //X3_TITENG
	{ 'Exceto Produto'														, .T. }, ; //X3_DESCRIC
	{ 'Exceto Produto'														, .T. }, ; //X3_DESCSPA
	{ 'Exceto Produto'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD40456" ) ) ) ;
