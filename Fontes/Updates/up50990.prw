...
/*/
//--------------------------------------------------------------------
User Function UP50990( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP50990" )
				Else
					MsgStop( "Atualização não realizada.", "UP50990" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Total Value'															, .T. }, ; //X3_TITENG
	{ 'Valor total do item'													, .T. }, ; //X3_DESCRIC
	{ 'Valor Total del Item'												, .T. }, ; //X3_DESCSPA
	{ 'Item Total Value'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ 'A120Total(M->C7_TOTAL).And.MaFisRef("IT_VALMERC","MT120",M->C7_TOTAL)'	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_CONTEXT
	{ '  x'																	, .T. }, ; //X3_OBRIGAT
	{ 'U_AOMS073("C7_PRODUTO")'												, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SC7'																	, .T. }, ; //X3_ARQUIVO
	{ '20'																	, .T. }, ; //X3_ORDEM
	{ 'C7_VLDESC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vl. Desconto'														, .T. }, ; //X3_TITULO
	{ 'Vl.Descuento'														, .T. }, ; //X3_TITSPA
	{ 'Disc.Vl.'															, .T. }, ; //X3_TITENG
	{ 'Valor do Desconto do item'											, .T. }, ; //X3_DESCRIC
	{ 'Valor del Descuento'													, .T. }, ; //X3_DESCSPA
	{ 'Discount Value'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ 'Positivo().And.A120ZeraDesc().And.MaFisRef("IT_DESCONTO","MT120",M->C7_VLDESC)', .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ 'Positivo().And.MaFisRef("IT_BASEIPI","MT120",M->C7_BASEIPI)'			, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ 'Valor Base de ICMS'													, .T. }, ; //X3_DESCSPA
	{ 'ICMS Basis Value'													, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ 'Positivo().And.MaFisRef("IT_BASEICM","MT120",M->C7_BASEICM)'			, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ 'Valor do ICMS do item'												, .T. }, ; //X3_DESCRIC
	{ 'Valor del ICMS del item'												, .T. }, ; //X3_DESCSPA
	{ 'Item ICMS Value'														, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ 'Positivo().And.MaFisRef("IT_VALICM","MT120",M->C7_VALICM)'			, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'SC7'																	, .T. }, ; //X3_ARQUIVO
	{ '34'																	, .T. }, ; //X3_ORDEM
	{ 'C7_ICMCOMP'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'ICMS Compl.'															, .T. }, ; //X3_TITULO
	{ 'ICMS Compl.'															, .T. }, ; //X3_TITSPA
	{ 'Comp. ICMS'															, .T. }, ; //X3_TITENG
	{ 'Valor Icms Complementar'												, .T. }, ; //X3_DESCRIC
	{ 'Valor ICMS Complementario'											, .T. }, ; //X3_DESCSPA
	{ 'ICMS Compl. Value'													, .T. }, ; //X3_DESCENG
	{ '@e 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ 'MAFISREF("IT_VALCMP","MT120",M->C7_ICMCOMP)'							, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP50990" ) ) ) ;
