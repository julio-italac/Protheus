...
ฑฑบ Programa ณ UP16681N บ Autor ณ TOTVS Protheus     บ Data ณ  16/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UP16681N   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UP16681N( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UP16681N" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UP16681N" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tipo Agendam'															, ; //X3_TITULO
	'Tipo Agendam'															, ; //X3_TITSPA
	'Tipo Agendam'															, ; //X3_TITENG
	'Tipo de Agendamento'													, ; //X3_DESCRIC
	'Tipo de Agendamento'													, ; //X3_DESCSPA
	'Tipo de Agendamento'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	'Cod.Rede'																, ; //X3_TITSPA
	'Cod.Rede'																, ; //X3_TITENG
	'Codigo da Rede'														, ; //X3_DESCRIC
	'Codigo da Rede'														, ; //X3_DESCSPA
	'Codigo da Rede'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Situacao Ped'															, ; //X3_TITULO
	'Situacao Ped'															, ; //X3_TITSPA
	'Situacao Ped'															, ; //X3_TITENG
	'Codigo Situacao Pedido Ve'												, ; //X3_DESCRIC
	'Codigo Situacao Pedido Ve'												, ; //X3_DESCSPA
	'Codigo Situacao Pedido Ve'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	120																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs.CondPag'															, ; //X3_TITULO
	'Obs.CondPag'															, ; //X3_TITSPA
	'Obs.CondPag'															, ; //X3_TITENG
	'Observacao Condicao Pagto'												, ; //X3_DESCRIC
	'Observacao Condicao Pagto'												, ; //X3_DESCSPA
	'Observacao Condicao Pagto'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	120																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs.Ped.Vend'															, ; //X3_TITULO
	'Obs.Ped.Vend'															, ; //X3_TITSPA
	'Obs.Ped.Vend'															, ; //X3_TITENG
	'Observacao Pedido Vendas'												, ; //X3_DESCRIC
	'Observacao Pedido Vendas'												, ; //X3_DESCSPA
	'Observacao Pedido Vendas'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Obs.NFE'																, ; //X3_TITSPA
	'Obs.NFE'																, ; //X3_TITENG
	'Observacao Nota fiscal El'												, ; //X3_DESCRIC
	'Observacao Nota fiscal El'												, ; //X3_DESCSPA
	'Observacao Nota fiscal El'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Placa 2'																, ; //X3_TITSPA
	'Placa 2'																, ; //X3_TITENG
	'Placa do Veiculo 2'													, ; //X3_DESCRIC
	'Placa do Veiculo 2'													, ; //X3_DESCSPA
	'Placa do Veiculo 2'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Placa 3'																, ; //X3_TITSPA
	'Placa 3'																, ; //X3_TITENG
	'Placa do Veiculo 3'													, ; //X3_DESCRIC
	'Placa do Veiculo 3'													, ; //X3_DESCSPA
	'Placa do Veiculo 3'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Placa 4'																, ; //X3_TITSPA
	'Placa 4'																, ; //X3_TITENG
	'Placa do veiculo 4'													, ; //X3_DESCRIC
	'Placa do veiculo 4'													, ; //X3_DESCSPA
	'Placa do veiculo 4'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  16/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Tipo de Agendamento' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_TPAGEN", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_TPAGEN" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Codigo da Rede' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_COREDE", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_COREDE" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Gerente' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_GERENT", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_GERENT" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Codigo Situa็ใo Pedido Vendas' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_SITPED", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_SITPED" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Observa็ใo Condi็ใo Pagto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_OBSCPA", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_OBSCPA" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Observa็ใo Pedido Vendas' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_OBSPVE", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_OBSPVE" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Observa็ใo Nota fiscal Eletronica' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_OBSNFE", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_OBSNFE" + CRLF

//
// Helps Tabela ZFU
//
aHlpPor := {}
aAdd( aHlpPor, 'Placa do Veiculo 2' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFU_PLACA2", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFU_PLACA2" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Placa do Veiculo 3' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFU_PLACA3", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFU_PLACA3" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Placa do Veํculo 4' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFU_PLACA4", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFU_PLACA4" + CRLF
