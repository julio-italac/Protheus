...
/*/
//--------------------------------------------------------------------
User Function UP42943( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP42943" )
				Else
					MsgStop( "Atualização não Realizada.", "UP42943" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'EI'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_OUSER'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'User. Inf.OL'														, .T. }, ; //X3_TITULO
	{ 'User. Inf.OL'														, .T. }, ; //X3_TITSPA
	{ 'User. Inf.OL'														, .T. }, ; //X3_TITENG
	{ 'Usuario Informou o Op.Log'											, .T. }, ; //X3_DESCRIC
	{ 'Usuario Informou o Op.Log'											, .T. }, ; //X3_DESCSPA
	{ 'Usuario Informou o Op.Log'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'EJ'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_ODATA'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data inf.'															, .T. }, ; //X3_TITULO
	{ 'Data inf.'															, .T. }, ; //X3_TITSPA
	{ 'Data inf.'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'EK'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_OHORA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hora Inf.'															, .T. }, ; //X3_TITULO
	{ 'Hora Inf.'															, .T. }, ; //X3_TITSPA
	{ 'Hora Inf.'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP42943" ) ) ) ;
