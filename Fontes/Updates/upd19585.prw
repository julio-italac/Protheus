...
ฑฑบ Programa ณ UPD19585 บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPD19585   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPD19585( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPD19585" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPD19585" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	'ZBP'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZBP'+cEmpr																, ; //X2_ARQUIVO
	'Regras de Bloqueio de PV'												, ; //X2_NOME
	'Regras de Bloqueio de PV'												, ; //X2_NOMESPA
	'Regras de Bloqueio de PV'												, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tp. Operacao'															, ; //X3_TITULO
	'Tp. Operacao'															, ; //X3_TITSPA
	'Tp. Operacao'															, ; //X3_TITENG
	'Tipo da Operacao'														, ; //X3_DESCRIC
	'Tipo da Operacao'														, ; //X3_DESCSPA
	'Tipo da Operacao'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Vazio() .OR. ExistCpo("ZB4")'											, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Estado'																, ; //X3_TITSPA
	'Estado'																, ; //X3_TITENG
	'Sigla da Federacao'													, ; //X3_DESCRIC
	'Sigla da Federacao'													, ; //X3_DESCSPA
	'Sigla da Federacao'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Vazio() .OR. ExistCpo("SX5","12"+M->ZBP_ESTADO)'						, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Municipio'																, ; //X3_TITSPA
	'Municipio'																, ; //X3_TITENG
	'Nome Municipio'														, ; //X3_DESCRIC
	'Nome Municipio'														, ; //X3_DESCSPA
	'Nome Municipio'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'IF(INCLUI,"",POSICIONE("CC2",1,XFILIAL("CC2")+ZBP->ZBP_ESTADO+ZBP->ZBP_CODMUN,"CC2_MUN"))', ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'E_Field2(ZBP->ZBP_ESTADO+ZBP->ZBP_CODMUN,"CC2",1,"CC2_MUN")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tp Cliente'															, ; //X3_TITULO
	'Tp Cliente'															, ; //X3_TITSPA
	'Tp Cliente'															, ; //X3_TITENG
	'Tipo do Cliente'														, ; //X3_DESCRIC
	'Tipo do Cliente'														, ; //X3_DESCSPA
	'Tipo do Cliente'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Vazio().OR.Pertence("FLRSX")'											, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'Vazio().OR.ExistCpo("SA1",M->ZBP_CLIENT)'								, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'Vazio().OR.ExistCpo("SA1",M->ZBP_CLIENT+M->ZBP_CLILOJ)'				, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'IF(INCLUI,"",POSICIONE("SA1",1,XFILIAL("SA1")+ZBP->ZBP_CLIENT+ALLTRIM(ZBP->ZBP_CLILOJ),"A1_NREDUZ"))', ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'E_Field2(ZBP->ZBP_CLIENT+ALLTRIM(ZBP->ZBP_CLILOJ),"SA1",1,"A1_NREDUZ")'	, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'Vazio().OR.ExistCpo("SBM",M->ZBP_GRUPO)'								, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'IF(INCLUI,"",POSICIONE("SBM",1,XFILIAL("SBM")+ZBP->ZBP_GRUPO,"BM_DESC"))'	, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SBM",1,XFILIAL("SBM")+ZBP->ZBP_GRUPO,"BM_DESC")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'Vazio().OR.ExistCpo("SYD",M->ZBP_NCM)'									, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Cod. Prod.'															, ; //X3_TITSPA
	'Cod. Prod.'															, ; //X3_TITENG
	'Codigo de Produto'														, ; //X3_DESCRIC
	'Codigo de Produto'														, ; //X3_DESCSPA
	'Codigo de Produto'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Vazio().OR.ExistCpo("SB1",M->ZBP_PRODUT)'								, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Produto'																, ; //X3_TITSPA
	'Produto'																, ; //X3_TITENG
	'Nome do Produto'														, ; //X3_DESCRIC
	'Nome do Produto'														, ; //X3_DESCSPA
	'Nome do Produto'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'IF(INCLUI,"",POSICIONE("SB1",1,XFILIAL("SB1")+ZBP->ZBP_PRODUT,"B1_DESC"))'	, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SB1",1,XFILIAL("SB1")+ZBP->ZBP_PRODUT,"B1_DESC")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'ZBP'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZBP_FILIAL+ZBP_OPERAC+ZBP_ESTADO+ZBP_CODMUN+ZBP_TIPCLI+ZBP_CLIENT+ZBP_CLILOJ+ZBP_GRUPO+ZBP_NCM+ZBP_PRODUT', ; //CHAVE
	'Oper+Est+Mun+Tp Cli+Cli+Loj+Grupo+NCM+Prod'							, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
