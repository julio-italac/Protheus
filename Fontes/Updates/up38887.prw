...
/*/
//--------------------------------------------------------------------
User Function UP38887( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP38887" )
				Else
					MsgStop( "Atualização não Realizada.", "UP38887" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	200																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs Lib. Ger'															, ; //X3_TITULO
	'Obs Lib. Ger'															, ; //X3_TITSPA
	'Obs Lib. Ger'															, ; //X3_TITENG
	'Obs Liberacao Gerente'													, ; //X3_DESCRIC
	'Obs Liberacao Gerente'													, ; //X3_DESCSPA
	'Obs Liberacao Gerente'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt Lib. Ger.'															, ; //X3_TITULO
	'Dt Lib. Ger.'															, ; //X3_TITSPA
	'Dt Lib. Ger.'															, ; //X3_TITENG
	'Dt Liberacao Gerente'													, ; //X3_DESCRIC
	'Dt Liberacao Gerente'													, ; //X3_DESCSPA
	'Dt Liberacao Gerente'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hr Lib. Ger.'															, ; //X3_TITULO
	'Hr Lib. Ger.'															, ; //X3_TITSPA
	'Hr Lib. Ger.'															, ; //X3_TITENG
	'Hr Liberacao Gerente'													, ; //X3_DESCRIC
	'Hr Liberacao Gerente'													, ; //X3_DESCSPA
	'Hr Liberacao Gerente'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Dt Lib. Ger.'															, ; //X3_TITSPA
	'Dt Lib. Ger.'															, ; //X3_TITENG
	'Data Liberacao Gerente'												, ; //X3_DESCRIC
	'Data Liberacao Gerente'												, ; //X3_DESCSPA
	'Data Liberacao Gerente'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP38887" ) ) ) ;
