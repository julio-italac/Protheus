...
ฑฑบ Programa ณ UPD20950 บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPD20950   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPD20950( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPD20950" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPD20950" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	'ZGC'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZGC'+cEmpr																, ; //X2_ARQUIVO
	'DADOS DE CTE'															, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'Hora de emissao'														, ; //X3_DESCRIC
	'Hora de emissao'														, ; //X3_DESCSPA
	'Hora de emissao'														, ; //X3_DESCENG
	'@H'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'XML CTE'																, ; //X3_TITSPA
	'XML CTE'																, ; //X3_TITENG
	'XML do CTE'															, ; //X3_DESCRIC
	'XML do CTE'															, ; //X3_DESCSPA
	'XML do CTE'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nota Fis.CTE'															, ; //X3_TITULO
	'Nota Fis.CTE'															, ; //X3_TITSPA
	'Nota Fis.CTE'															, ; //X3_TITENG
	'Nota fiscal  CTE'														, ; //X3_DESCRIC
	'Nota fiscal  CTE'														, ; //X3_DESCSPA
	'Nota fiscal  CTE'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Serie NF CTE'															, ; //X3_TITULO
	'Serie NF CTE'															, ; //X3_TITSPA
	'Serie NF CTE'															, ; //X3_TITENG
	'Serie Nota fiscal Cte'													, ; //X3_DESCRIC
	'Serie Nota fiscal Cte'													, ; //X3_DESCSPA
	'Serie Nota fiscal Cte'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Fornecedor Nota Fiscal'												, ; //X3_DESCRIC
	'Fornecedor Nota Fiscal'												, ; //X3_DESCSPA
	'Fornecedor Nota Fiscal'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Loja Forn.'															, ; //X3_TITSPA
	'Loja Forn.'															, ; //X3_TITENG
	'Loja do Fornecedor NF.'												, ; //X3_DESCRIC
	'Loja do Fornecedor NF.'												, ; //X3_DESCSPA
	'Loja do Fornecedor NF.'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt.Emiss.Cte'															, ; //X3_TITULO
	'Dt.Emiss.Cte'															, ; //X3_TITSPA
	'Dt.Emiss.Cte'															, ; //X3_TITENG
	'Data de Emissao Cte'													, ; //X3_DESCRIC
	'Data de Emissao Cte'													, ; //X3_DESCSPA
	'Data de Emissao Cte'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Data Alterac'															, ; //X3_TITULO
	'Data Alterac'															, ; //X3_TITSPA
	'Data Alterac'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Numero Cte'															, ; //X3_TITULO
	'Numero Cte'															, ; //X3_TITSPA
	'Numero Cte'															, ; //X3_TITENG
	'Numero do CTE'															, ; //X3_DESCRIC
	'Numero do CTE'															, ; //X3_DESCSPA
	'Numero do CTE'															, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Serie do CTE'															, ; //X3_TITULO
	'Serie do CTE'															, ; //X3_TITSPA
	'Serie do CTE'															, ; //X3_TITENG
	'Serie do CTE'															, ; //X3_DESCRIC
	'Serie do CTE'															, ; //X3_DESCSPA
	'Serie do CTE'															, ; //X3_DESCENG
	'9999'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Situacao do Registro'													, ; //X3_DESCSPA
	'Situacao do Registro'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'N=Nao Processado;P=Processado;R=Rejeitado'								, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Empr.WebServ'															, ; //X3_TITULO
	'Empr.WebServ'															, ; //X3_TITSPA
	'Empr.WebServ'															, ; //X3_TITENG
	'Codigo Empresa WebServer'												, ; //X3_DESCRIC
	'Codigo Empresa WebServer'												, ; //X3_DESCSPA
	'Codigo Empresa WebServer'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Transp. CTE'															, ; //X3_TITULO
	'Transp. CTE'															, ; //X3_TITSPA
	'Transp. CTE'															, ; //X3_TITENG
	'Transportadora do CTE'													, ; //X3_DESCRIC
	'Transportadora do CTE'													, ; //X3_DESCSPA
	'Transportadora do CTE'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Recno CKOCOL'															, ; //X3_TITULO
	'Adicional 1'															, ; //X3_TITSPA
	'Adicional 1'															, ; //X3_TITENG
	'Campo Adicional 1'														, ; //X3_DESCRIC
	'Campo Adicional 1'														, ; //X3_DESCSPA
	'Campo Adicional 1'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cnpj Tra CTE'															, ; //X3_TITULO
	'Cnpj Tra CTE'															, ; //X3_TITSPA
	'Cnpj Tra CTE'															, ; //X3_TITENG
	'Cnpj Transportadora CTE'												, ; //X3_DESCRIC
	'Cnpj Transportadora CTE'												, ; //X3_DESCSPA
	'Cnpj Transportadora CTE'												, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	0																		, ; //X3_DECIMAL
	'Recno SF2'																, ; //X3_TITULO
	'Adicional 2'															, ; //X3_TITSPA
	'Adicional 2'															, ; //X3_TITENG
	'Campo Adicional 2'														, ; //X3_DESCRIC
	'Campo Adicional 2'														, ; //X3_DESCSPA
	'Campo Adicional 2'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Adicional 3'															, ; //X3_TITULO
	'Adicional 3'															, ; //X3_TITSPA
	'Adicional 3'															, ; //X3_TITENG
	'Campo Adicional 3'														, ; //X3_DESCRIC
	'Campo Adicional 3'														, ; //X3_DESCSPA
	'Campo Adicional 3'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Adicional 4'															, ; //X3_TITULO
	'Adicional 4'															, ; //X3_TITSPA
	'Adicional 4'															, ; //X3_TITENG
	'Campo Adicional 4'														, ; //X3_DESCRIC
	'Campo Adicional 4'														, ; //X3_DESCSPA
	'Campo Adicional 4'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Adicional 5'															, ; //X3_TITULO
	'Adicional 5'															, ; //X3_TITSPA
	'Adicional 5'															, ; //X3_TITENG
	'Campo Adicional 5'														, ; //X3_DESCRIC
	'Campo Adicional 5'														, ; //X3_DESCSPA
	'Campo Adicional 5'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	18																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Adicional 6'															, ; //X3_TITULO
	'Adicional 6'															, ; //X3_TITSPA
	'Adicional 6'															, ; //X3_TITENG
	'Campo Adicional 6'														, ; //X3_DESCRIC
	'Campo Adicional 6'														, ; //X3_DESCSPA
	'Campo Adicional 6'														, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	18																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Adicional 7'															, ; //X3_TITULO
	'Adicional 7'															, ; //X3_TITSPA
	'Adicional 7'															, ; //X3_TITENG
	'Campo Adicional 7'														, ; //X3_DESCRIC
	'Campo Adicional 7'														, ; //X3_DESCSPA
	'Campo Adicional 7'														, ; //X3_DESCENG
	'@E 9,999,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	18																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Adicional 8'															, ; //X3_TITULO
	'Adicional 8'															, ; //X3_TITSPA
	'Adicional 8'															, ; //X3_TITENG
	'Campo Adicional 8'														, ; //X3_DESCRIC
	'Campo Adicional 8'														, ; //X3_DESCSPA
	'Campo Adicional 8'														, ; //X3_DESCENG
	'@E 9,999,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	18																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Adicional 9'															, ; //X3_TITULO
	'Adicional 9'															, ; //X3_TITSPA
	'Adicional 9'															, ; //X3_TITENG
	'Campo Adicional 9'														, ; //X3_DESCRIC
	'Campo Adicional 9'														, ; //X3_DESCSPA
	'Campo Adicional 9'														, ; //X3_DESCENG
	'@E 9,999,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	18																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Adicional 10'															, ; //X3_TITULO
	'Adicional 10'															, ; //X3_TITSPA
	'Adicional 10'															, ; //X3_TITENG
	'Campo Adicional 10'													, ; //X3_DESCRIC
	'Campo Adicional 10'													, ; //X3_DESCSPA
	'Campo Adicional 10'													, ; //X3_DESCENG
	'@E 9,999,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	400																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Retorno Inte'															, ; //X3_TITULO
	'Retorno Inte'															, ; //X3_TITSPA
	'Retorno Inte'															, ; //X3_TITENG
	'Retorno Integracao Italac'												, ; //X3_DESCRIC
	'Retorno Integracao Italac'												, ; //X3_DESCSPA
	'Retorno Integracao Italac'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Status CTE'															, ; //X3_TITULO
	'Status CTE'															, ; //X3_TITSPA
	'Status CTE'															, ; //X3_TITENG
	'Status da Integracao CTE'												, ; //X3_DESCRIC
	'Status da Integracao CTE'												, ; //X3_DESCSPA
	'Status da Integracao CTE'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Fluxo Integ.'															, ; //X3_TITULO
	'Fluxo Integ.'															, ; //X3_TITSPA
	'Fluxo Integ.'															, ; //X3_TITENG
	'Fluxo da Integracao'													, ; //X3_DESCRIC
	'Fluxo da Integracao'													, ; //X3_DESCSPA
	'Fluxo da Integracao'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Totvs Colaboracao-->Italac;2=Italac-->RDC;3=RDC-->Italac'			, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'XML Enviado'															, ; //X3_TITULO
	'XML Enviado'															, ; //X3_TITSPA
	'XML Enviado'															, ; //X3_TITENG
	'XML Enviado para o RDC'												, ; //X3_DESCRIC
	'XML Enviado para o RDC'												, ; //X3_DESCSPA
	'XML Enviado para o RDC'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  02/08/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
