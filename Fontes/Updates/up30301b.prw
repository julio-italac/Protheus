...
/*/
//--------------------------------------------------------------------
User Function UP30301B( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP30301B" )
				Else
					MsgStop( "Atualização não Realizada.", "UP30301B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZM0'																	, .T. }, ; //X3_ARQUIVO
	{ '25'																	, .T. }, ; //X3_ORDEM
	{ 'ZM0_DSCBNT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Desc LP Trsf'														, .T. }, ; //X3_TITULO
	{ 'Desc LP Trsf'														, .T. }, ; //X3_TITSPA
	{ 'Desc LP Trsf'														, .T. }, ; //X3_TITENG
	{ 'Indicativo para execução'											, .T. }, ; //X3_DESCRIC
	{ 'Indicativo para execução'											, .T. }, ; //X3_DESCSPA
	{ 'Indicativo para execução'											, .T. }, ; //X3_DESCENG
	{ '9'																	, .T. }, ; //X3_PICTURE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP30301B" ) ) ) ;
