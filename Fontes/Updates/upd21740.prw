...
ฑฑบ Programa ณ UPD21740 บ Autor ณ TOTVS Protheus     บ Data ณ  04/10/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPD21740   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPD21740( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPD21740" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPD21740" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  04/10/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  04/10/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZW_FILIAL+ ZW_BLQLCR'													, ; //CHAVE
	'Bloqueio Credito'														, ; //DESCRICAO
	'Bloqueio Credito'														, ; //DESCSPA
	'Bloqueio Credito'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZW_FILIAL + ZW_BLQLCR+ZW_ITEM'											, ; //CHAVE
	'Bloqueio de credito + Item'											, ; //DESCRICAO
	'Bloqueio de credito + Item'											, ; //DESCSPA
	'Bloqueio de credito + Item'											, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'ZW_BLQLCR + ZW_ITEM'													, ; //CHAVE
	'Bloqueio de credito + item para todas as filiais'						, ; //DESCRICAO
	'Bloqueio de credito + item para todas as filiais'						, ; //DESCSPA
	'Bloqueio de credito + item para todas as filiais'						, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'5'																		, ; //ORDEM
	'ZW_CLIENTE+ZW_STATUS+ZW_BLQLCR'										, ; //CHAVE
	'cliente+status+bloqueio'												, ; //DESCRICAO
	'cliente+status+bloqueio'												, ; //DESCSPA
	'cliente+status+bloqueio'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'6'																		, ; //ORDEM
	'ZW_CLIENTE+ZW_STATUS+ZW_BLQLCR+ZW_ITEM'								, ; //CHAVE
	'CLIENTE+STATUS+BLQLCR+ITEM'											, ; //DESCRICAO
	'CLIENTE+STATUS+BLQLCR+ITEM'											, ; //DESCSPA
	'CLIENTE+STATUS+BLQLCR+ITEM'											, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'7'																		, ; //ORDEM
	'ZW_FILIAL+ZW_IDPED+ZW_BLQLCR+ZW_ITEM'									, ; //CHAVE
	'filial+idped+bloqueio+item'											, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'8'																		, ; //ORDEM
	'ZW_IDPED+ZW_BLQLCR+ZW_ITEM'											, ; //CHAVE
	'idped+bloqueio+item'													, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'E'																		, ; //ORDEM
	'ZW_TIPO+ZW_BLOQ+ZW_ITEM+ZW_NUMPED+ZW_STATUS'							, ; //CHAVE
	'TIPO+BLOQUEIO+ITEM+NUMPED+STATUS'										, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  04/10/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
