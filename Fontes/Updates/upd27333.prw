...
/*/
//--------------------------------------------------------------------
User Function UPD27333( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD27333" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD27333" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '71'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_NFSED'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'NF. Sedex?'															, .T. }, ; //X3_TITULO
	{ 'NF. Sedex?'															, .T. }, ; //X3_TITSPA
	{ 'NF. Sedex?'															, .T. }, ; //X3_TITENG
	{ 'NF. Sedex?'															, .T. }, ; //X3_DESCRIC
	{ 'NF. Sedex?'															, .T. }, ; //X3_DESCSPA
	{ 'NF. Sedex?'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '71'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_PVREF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'PV Referen'															, .T. }, ; //X3_TITULO
	{ 'PV Referen'															, .T. }, ; //X3_TITSPA
	{ 'PV Referen'															, .T. }, ; //X3_TITENG
	{ 'PV Referencia'														, .T. }, ; //X3_DESCRIC
	{ 'PV Referencia'														, .T. }, ; //X3_DESCSPA
	{ 'PV Referencia'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "Vazio() .OR. ExistCpo('SC5')"										, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '71'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_QTPA'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Qtde Palle'															, .T. }, ; //X3_TITULO
	{ 'Qtde Palle'															, .T. }, ; //X3_TITSPA
	{ 'Qtde Palle'															, .T. }, ; //X3_TITENG
	{ 'Quantidade Pallet'													, .T. }, ; //X3_DESCRIC
	{ 'Quantidade Pallet'													, .T. }, ; //X3_DESCSPA
	{ 'Quantidade Pallet'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '72'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_NFREF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'NF. Refer.'															, .T. }, ; //X3_TITULO
	{ 'NF. Refer.'															, .T. }, ; //X3_TITSPA
	{ 'NF. Refer.'															, .T. }, ; //X3_TITENG
	{ 'NF. Referencia'														, .T. }, ; //X3_DESCRIC
	{ 'NF. Referencia'														, .T. }, ; //X3_DESCSPA
	{ 'NF. Referencia'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '73'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_SERNF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Serie NF Ref'														, .T. }, ; //X3_TITULO
	{ 'Serie NF Ref'														, .T. }, ; //X3_TITSPA
	{ 'Serie NF Ref'														, .T. }, ; //X3_TITENG
	{ 'Serie NF. Referencia'												, .T. }, ; //X3_DESCRIC
	{ 'Serie NF. Referencia'												, .T. }, ; //X3_DESCSPA
	{ 'Serie NF. Referencia'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD27333" ) ) ) ;
