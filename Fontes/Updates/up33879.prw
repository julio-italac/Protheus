...
/*/
//--------------------------------------------------------------------
User Function UP33879( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP33879" )
				Else
					MsgStop( "Atualização não Realizada.", "UP33879" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'EX'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_GPADV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Gera Pal.Dev'														, .T. }, ; //X3_TITULO
	{ 'Gera Pal.Dev'														, .T. }, ; //X3_TITSPA
	{ 'Gera Pal.Dev'														, .T. }, ; //X3_TITENG
	{ 'Gera Pallet de Devolucao?'											, .T. }, ; //X3_DESCRIC
	{ 'Gera Pallet de Devolucao?'											, .T. }, ; //X3_DESCSPA
	{ 'Gera Pallet de Devolucao?'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'EY'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_TRAPA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Transp.Pal.D'														, .T. }, ; //X3_TITULO
	{ 'Transp.Pal.D'														, .T. }, ; //X3_TITSPA
	{ 'Transp.Pal.D'														, .T. }, ; //X3_TITENG
	{ 'Transportadora Pallet Dev'											, .T. }, ; //X3_DESCRIC
	{ 'Transportadora Pallet Dev'											, .T. }, ; //X3_DESCSPA
	{ 'Transportadora Pallet Dev'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. ExistCpo("SA1")'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'EZ'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_LTRAP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lj.Tra.Pal.D'														, .T. }, ; //X3_TITULO
	{ 'Lj.Tra.Pal.D'														, .T. }, ; //X3_TITSPA
	{ 'Lj.Tra.Pal.D'														, .T. }, ; //X3_TITENG
	{ 'Loja Transportador Pallet'											, .T. }, ; //X3_DESCRIC
	{ 'Loja Transportador Pallet'											, .T. }, ; //X3_DESCSPA
	{ 'Loja Transportador Pallet'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Gera Pallet de Devolução?' )

PutSX1Help( "PC5_I_GPADV", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C5_I_GPADV" )

aHlpPor := {}
aAdd( aHlpPor, 'Transportadora Pallet Devolução' )

PutSX1Help( "PC5_I_TRAPA", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C5_I_TRAPA" )

aHlpPor := {}
aAdd( aHlpPor, 'Loja Transportador Pallet Devolução' )

PutSX1Help( "PC5_I_LTRAP", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C5_I_LTRAP" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP33879" ) ) ) ;
