...
/*/
//--------------------------------------------------------------------
User Function UPD32088( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD32088" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD32088" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("  /G1/G2/G3/G9/G0")'										, .T. }, ; //X3_VLDUSER
	{ 'G1=Grupo 1;G2=Grupo 2;G3=Grupo 3;G9=Outros;G0=Indefinido'			, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z2'																	, .T. }, ; //X3_ORDEM
	{ 'B1_I_BIGRP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'C Grp PRD BI'														, .T. }, ; //X3_TITULO
	{ 'C Grp PRD BI'														, .T. }, ; //X3_TITSPA
	{ 'C Grp PRD BI'														, .T. }, ; //X3_TITENG
	{ 'Codigo Grupo PRD BI'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Grupo PRD BI'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Grupo PRD BI'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. ExistCpo("SX5","ZA"+M->B1_I_BIGRP)'						, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z3'																	, .T. }, ; //X3_ORDEM
	{ 'B1_I_BIGRD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Grupo PRD BI'														, .T. }, ; //X3_TITULO
	{ 'Grupo PRD BI'														, .T. }, ; //X3_TITSPA
	{ 'Grupo PRD BI'														, .T. }, ; //X3_TITENG
	{ 'Grupo PRD BI'														, .T. }, ; //X3_DESCRIC
	{ 'Grupo PRD BI'														, .T. }, ; //X3_DESCSPA
	{ 'Grupo PRD BI'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF(INCLUI,"",POSICIONE("SX5",1,xFilial("SX5")+"ZA"+SB1->B1_I_BIGRP,"X5_DESCRI"))', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SX5",1,xFilial("SX5")+"ZA"+SB1->B1_I_BIGRP,"X5_DESCRI")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ 'A'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z4'																	, .T. }, ; //X3_ORDEM
	{ 'B1_I_BIFAM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'C Familia BI'														, .T. }, ; //X3_TITULO
	{ 'C Familia BI'														, .T. }, ; //X3_TITSPA
	{ 'C Familia BI'														, .T. }, ; //X3_TITENG
	{ 'Codigo Familia BI'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Familia BI'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Familia BI'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. ExistCpo("SX5","ZB"+M->B1_I_BIFAM)'						, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ 'Z5'																	, .T. }, ; //X3_ORDEM
	{ 'B1_I_BIFAD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Familia BI'															, .T. }, ; //X3_TITULO
	{ 'Familia BI'															, .T. }, ; //X3_TITSPA
	{ 'Familia BI'															, .T. }, ; //X3_TITENG
	{ 'Familia BI'															, .T. }, ; //X3_DESCRIC
	{ 'Familia BI'															, .T. }, ; //X3_DESCSPA
	{ 'Familia BI'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF(INCLUI,"",POSICIONE("SX5",1,xFilial("SX5")+"ZB"+SB1->B1_I_BIFAM,"X5_DESCRI"))', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SX5",1,xFilial("SX5")+"ZB"+SB1->B1_I_BIFAM,"X5_DESCRI")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ 'A'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX7, { ;
	'B1_I_BIFAM'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SX5",1,xFilial("SX5")+"ZB"+M->B1_I_BIFAM,"X5_DESCRI")'		, ; //X7_REGRA
	'B1_I_BIFAD'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'B1_I_BIGRP'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SX5",1,xFilial("SX5")+"ZA"+M->B1_I_BIGRP,"X5_DESCRI")'		, ; //X7_REGRA
	'B1_I_BIGRD'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD32088" ) ) ) ;
