...
/*/
//--------------------------------------------------------------------
User Function UPD31665( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD31665" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD31665" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SZW'																	, .T. }, ; //X3_ARQUIVO
	{ 'B0'																	, .T. }, ; //X3_ORDEM
	{ 'ZW_PEDIMPO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Num Ped Imp'															, .T. }, ; //X3_TITULO
	{ 'Num Ped Imp'															, .T. }, ; //X3_TITSPA
	{ 'Num Ped Imp'															, .T. }, ; //X3_TITENG
	{ 'Numero Pedido Importado'												, .T. }, ; //X3_DESCRIC
	{ 'Numero Pedido Importado'												, .T. }, ; //X3_DESCSPA
	{ 'Numero Pedido Importado'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD31665" ) ) ) ;
