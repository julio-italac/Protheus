...
/*/
//--------------------------------------------------------------------
User Function UP44767B( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP44767B" )
				Else
					MsgStop( "Atualização não realizada.", "UP44767B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Integ. DIMEP'															, ; //X3_TITULO
	'Integ. DIMEP'															, ; //X3_TITSPA
	'Integ. DIMEP'															, ; //X3_TITENG
	'Integracao com o DIMEP'												, ; //X3_DESCRIC
	'Integracao com o DIMEP'												, ; //X3_DESCSPA
	'Integracao com o DIMEP'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP44767B" ) ) ) ;
