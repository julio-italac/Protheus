...
/*/
//--------------------------------------------------------------------
User Function UP37291( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP37291" )
				Else
					MsgStop( "Atualização não Realizada.", "UP37291" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'ZGL'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZGL'+cEmpr																, ; //X2_ARQUIVO
	'Itens Atendidos Operador Logis'										, ; //X2_NOME
	'Itens Atendidos Operador Logis'										, ; //X2_NOMESPA
	'Itens Atendidos Operador Logis'										, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'x'																		, ; //X3_OBRIGAT
	'U_AOMS128V("ZGL_FORNEC")'												, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'x'																		, ; //X3_OBRIGAT
	'U_AOMS128V("ZGL_LOJA")'												, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'If(Inclui,"",POSICIONE("SA2",1,xFilial("SA2")+ZGL->ZGL_FORNEC+ZGL->ZGL_LOJA,"A2_NOME"))', ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SA2",1,xFilial("SA2")+ZGL->ZGL_FORNEC+ZGL->ZGL_LOJA,"A2_NOME")'	, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'x'																		, ; //X3_OBRIGAT
	'U_AOMS128V("ZGL_PRODUT")'												, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'If(Inclui,"",POSICIONE("SB1",1,xFilial("SB1")+ZGL->ZGL_PRODUT,"B1_DESC"))'	, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SB1",1,xFilial("SB1")+ZGL->ZGL_PRODUT,"B1_DESC")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSIX, { ;
	'ZGL'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZGL_FILIAL+ZGL_FORNEC+ZGL_LOJA+ZGL_PRODUT'								, ; //CHAVE
	'Filial+Fornecedor+Loja+Produto'										, ; //DESCRICAO
	'Filial+Fornecedor+Loja+Produto'										, ; //DESCSPA
	'Filial+Fornecedor+Loja+Produto'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	'ZGL_FORNEC'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'U_AOMS128G("ZGL_FORNEC")'												, ; //X7_REGRA
	'ZGL_NOMFOR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'ZGL_PRODUT'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'U_AOMS128G("ZGL_PRODUT")'												, ; //X7_REGRA
	'ZGL_DESCPR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aHlpEng := {}
aAdd( aHlpEng, 'Código do Fornecedor.' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Código do Fornecedor.' )

PutSX1Help( "PZGL_FORNEC", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZGL_FORNEC" )

aHlpPor := {}
aAdd( aHlpPor, 'Loja do Fornecedor.' )

aHlpEng := {}
aAdd( aHlpEng, 'Loja do Fornecedor.' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Loja do Fornecedor.' )

PutSX1Help( "PZGL_LOJA  ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZGL_LOJA" )

aHlpPor := {}
aAdd( aHlpPor, 'Nome do Fornecedor' )

aHlpEng := {}
aAdd( aHlpEng, 'Nome do Fornecedor' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Nome do Fornecedor' )

PutSX1Help( "PZGL_NOMFOR", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZGL_NOMFOR" )

aHlpPor := {}
aAdd( aHlpPor, 'Código do Produto.' )

aHlpEng := {}
aAdd( aHlpEng, 'Código do Produto.' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Código do Produto.' )

PutSX1Help( "PZGL_PRODUT", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZGL_PRODUT" )
...
PutSX1Help( "PZGL_DESCPR", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZGL_DESCPR" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP37291" ) ) ) ;
