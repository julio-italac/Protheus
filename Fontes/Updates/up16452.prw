...
/*/
//--------------------------------------------------------------------
User Function UP16452( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP16452" )
				Else
					MsgStop( "Atualização não Realizada.", "UP16452" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Abatimentos Contrato'													, ; //XB_DESCRI
	'Abatimentos Contrato'													, ; //XB_DESCSPA
	'Abatimentos Contrato'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZAZ'																	} ) //XB_CONTEM
