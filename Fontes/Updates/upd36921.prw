...
/*/
//--------------------------------------------------------------------
User Function UPD36921( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD36921" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD36921" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Qtde de Volumes tipo 1'												, .T. }, ; //X3_DESCRIC
	{ 'Ctd de volúmenes tipo 1'												, .T. }, ; //X3_DESCSPA
	{ 'Qty of Volumes type 1'												, .T. }, ; //X3_DESCENG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD36921" ) ) ) ;
