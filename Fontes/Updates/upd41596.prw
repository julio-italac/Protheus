...
/*/
//--------------------------------------------------------------------
User Function UPD41596( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD41596" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD41596" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'PBZ'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PBZ'+cEmpr																, ; //X2_ARQUIVO
	'Cadastro de Produto x Centro C'										, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
...
aAdd( aSX3, { ;
	...
	'IF(INCLUI,"",POSICIONE("SB1",1,XFILIAL("SB1")+PBZ->PBZ_CODIGO,"B1_DESC"))'	, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("SB1",1,XFILIAL("SB1")+PBZ->PBZ_CODIGO,"B1_DESC")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	'Cod. C.C.'																, ; //X3_TITSPA
	'Cod. C.C.'																, ; //X3_TITENG
	'Codigo C.Custo'														, ; //X3_DESCRIC
	'Codigo C.Custo'														, ; //X3_DESCSPA
	'Codigo C.Custo'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'ExistCpo("CTT")'														, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x xx', ; //X3_USADO
	''																		, ; //X3_RELACAO
	'CTT'																	, ; //X3_F3
	0																		, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'IF(INCLUI,"",POSICIONE("CTT",1,XFILIAL("CTT")+PBZ->PBZ_CUSTO,"CTT_DESC01"))', ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'POSICIONE("CTT",1,XFILIAL("CTT")+PBZ->PBZ_CUSTO,"CTT_DESC01")'			, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	'Conversao'																, ; //X3_TITSPA
	'Conversao'																, ; //X3_TITENG
	'Conversao'																, ; //X3_DESCRIC
	'Conversao'																, ; //X3_DESCSPA
	'Conversao'																, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'A093Prod(.F.).and.existchav("SB1").and.IIF(Subs(M->B1_COD,1,3)=="MOD",A010MOD(),.T.) .And. A010GRADE() .And. Freeforuse("SB1")', ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x xx', ; //X3_USADO
	''																		, ; //X3_RELACAO
	''																		, ; //X3_F3
	1																		, ; //X3_NIVEL
...
aAdd( aSIX, { ;
	'PBZ'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'PBZ_FILIAL+PBZ_CODIGO+PBZ_CUSTO'										, ; //CHAVE
	'FILIAL+PRODUTO+CC'														, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSX7, { ;
	'PBZ_CODIGO'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SB1",1,XFILIAL("SB1")+M->PBZ_CODIGO,"B1_DESC")'				, ; //X7_REGRA
	'PBZ_DESPRO'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'PBZ_CUSTO'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("CTT",1,XFILIAL("CTT")+M->PBZ_CUSTO,"CTT_DESC01")'			, ; //X7_REGRA
	'PBZ_DESCUS'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD41596" ) ) ) ;
