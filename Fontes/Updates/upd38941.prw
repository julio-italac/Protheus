...
/*/
//--------------------------------------------------------------------
User Function UPD38941( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD38941" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD38941" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("ZL4",M->ZE0_TPCUS)'										, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZE0'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'ZE0_GRPCT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Grupo Custo'															, .T. }, ; //X3_TITULO
	{ 'Grupo Custo'															, .T. }, ; //X3_TITSPA
	{ 'Grupo Custo'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("ZL5",M->ZE0_TPCUS+M->ZE0_GRPCT)'							, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ 'ZL5'																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'ZE0'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZE0_EVCUS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ev Custo'															, .T. }, ; //X3_TITULO
	{ 'Ev Custo'															, .T. }, ; //X3_TITSPA
	{ 'Ev Custo'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("ZL6",M->ZE0_TPCUS+M->ZE0_GRPCT+M->ZE0_EVCUS,6)'			, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ 'F3ITLC'																, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'ZE0'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZE0_SEVCT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Sub Ev Cust'															, .T. }, ; //X3_TITULO
	{ 'Sub Ev Cust'															, .T. }, ; //X3_TITSPA
	{ 'Sub Ev Cust'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("ZL6",M->ZE0_TPCUS+M->ZE0_GRPCT+M->ZE0_EVCUS+M->ZE0_SEVCT ,6)'	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ 'F3ITLC'																, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'ZE0'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZE0_DATARQ'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Competencia'															, .T. }, ; //X3_TITULO
	{ 'Competencia'															, .T. }, ; //X3_TITSPA
	{ 'Competencia'															, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX7, { ;
	'ZE0_EVCUS'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ALLTRIM(POSICIONE("ZL6",6,XFILIAL("ZL6")+M->ZE0_TPCUS+M->ZE0_GRPCT+M->ZE0_EVCUS,"ZL6_DESEVE"))', ; //X7_REGRA
	'ZE0_DEVCT'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'ZE0_GRPCT'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ALLTRIM(POSICIONE("ZL5",3,XFILIAL("ZL5")+M->ZE0_TPCUS+M->ZE0_GRPCT,"ZL5_DESGRP"))', ; //X7_REGRA
	'ZE0_DGRPCT'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'ZE0_SEVCT'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("ZL6",6,XFILIAL("ZL6")+M->ZE0_TPCUS+M->ZE0_GRPCT+M->ZE0_EVCUS+M->ZE0_SEVCT,"ZL6_DSUBEV")', ; //X7_REGRA
	'ZE0_DSECT'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'ZE0_TPCUS'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ALLTRIM(POSICIONE("ZL4",1,XFILIAL("ZL4")+M->ZE0_TPCUS,"ZL4_DESCR"))'		, ; //X7_REGRA
	'ZE0_DTPCT'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Grupo Custo do Leite'													, ; //XB_DESCRI
	'Grupo Custo do Leite'													, ; //XB_DESCSPA
	'Grupo Custo do Leite'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZL5'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod Grp Cust'															, ; //XB_DESCRI
	'Cod Grp Cust'															, ; //XB_DESCSPA
	'Cod Grp Cust'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'Tipo Custo+cod Grp C'													, ; //XB_DESCRI
	'Tipo Custo+cod Grp C'													, ; //XB_DESCSPA
	'Tipo Custo+cod Grp C'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'03'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Tipo Custo'															, ; //XB_DESCRI
	'Tipo Custo'															, ; //XB_DESCSPA
	'Tipo Custo'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD38941" ) ) ) ;
