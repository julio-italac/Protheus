...
/*/
//--------------------------------------------------------------------
User Function UP25552( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP25552" )
				Else
					MsgStop( "Atualização não Realizada.", "UP25552" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
If ( lOpen := MyOpenSm0(.T.) )
	...
	If lOpen
		...
		For nI := 1 To Len( aRecnoSM0 )
			...
			If !( lOpen := MyOpenSm0(.T.) ) // .F. JPP TESTE
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Evento Emissao Reinf'													, ; //XB_DESCRI
	'Evento Emissao Reinf'													, ; //XB_DESCSPA
	'Evento Emissao Reinf'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'C00'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista Produtos Reinf'													, ; //XB_DESCRI
	'Lista Produtos Reinf'													, ; //XB_DESCSPA
	'Lista Produtos Reinf'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SB1'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP25552" ) ) ) ;
