...
/*/
//--------------------------------------------------------------------
User Function UPD24714( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD24714" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD24714" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZLU'																	, .T. }, ; //X3_ARQUIVO
	{ '99'																	, .T. }, ; //X3_ORDEM
	{ 'ZLU_EXCMIX'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Exclui MIX?'															, .T. }, ; //X3_TITULO
	{ 'Exclui MIX?'															, .T. }, ; //X3_TITSPA
	{ 'Exclui MIX?'															, .T. }, ; //X3_TITENG
	{ 'Exclui MIX?'															, .T. }, ; //X3_DESCRIC
	{ 'Exclui MIX?'															, .T. }, ; //X3_DESCSPA
	{ 'Exclui MIX?'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD24714" ) ) ) ;
