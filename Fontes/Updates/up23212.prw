...
/*/
//--------------------------------------------------------------------
User Function UP23212( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP23212" )
				Else
					MsgStop( "Atualização não Realizada.", "UP23212" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Tipos de Refeicoes'													, ; //XB_DESCRI
	'Tipos de Refeicoes'													, ; //XB_DESCSPA
	'Tipos de Refeicoes'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SPM'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Filiais'														, ; //XB_DESCRI
	'Lista de Filiais'														, ; //XB_DESCSPA
	'Lista de Filiais'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZZM'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP23212" ) ) ) ;
