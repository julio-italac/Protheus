...
/*/
//--------------------------------------------------------------------
User Function UP48654( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP48654" )
				Else
					MsgStop( "Atualização não realizada.", "UP48654" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Reab. Log.'															, ; //X3_TITSPA
	'Reab. Log.'															, ; //X3_TITENG
	'Reabertura Logistica'													, ; //X3_DESCRIC
	'Reabertura Logistica'													, ; //X3_DESCSPA
	'Reabertura Logistica'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	'Reab. Com.'															, ; //X3_TITSPA
	'Reab. Com.'															, ; //X3_TITENG
	'Reabertura Comercial'													, ; //X3_DESCRIC
	'Reabertura Comercial'													, ; //X3_DESCSPA
	'Reabertura Comercial'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP48654" ) ) ) ;
