...
/*/
//--------------------------------------------------------------------
User Function UP46970( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP46970" )
				Else
					MsgStop( "Atualização não realizada.", "UP46970" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nao Int RVI'															, .T. }, ; //X3_TITULO
	{ 'Nao Int RVI'															, .T. }, ; //X3_TITSPA
	{ 'Nao Int RVI'															, .T. }, ; //X3_TITENG
	{ 'Nao Integra o RVI no Fin.'											, .T. }, ; //X3_DESCRIC
	{ 'Nao Integra o RVI no Fin.'											, .T. }, ; //X3_DESCSPA
	{ 'Nao Integra o RVI no Fin.'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_NINTAV'															, .T. }, ; //X3_CAMPO
	{ 'L'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nao Int. AVI'														, .T. }, ; //X3_TITULO
	{ 'Nao Int. AVI'														, .T. }, ; //X3_TITSPA
	{ 'Nao Int. AVI'														, .T. }, ; //X3_TITENG
	{ 'Nao integra o AVI no Fin.'											, .T. }, ; //X3_DESCRIC
	{ 'Nao integra o AVI no Fin.'											, .T. }, ; //X3_DESCSPA
	{ 'Nao integra o AVI no Fin.'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '20'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_NINTCV'															, .T. }, ; //X3_CAMPO
	{ 'L'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nao Int. CVI'														, .T. }, ; //X3_TITULO
	{ 'Nao Int. CVI'														, .T. }, ; //X3_TITSPA
	{ 'Nao Int. CVI'														, .T. }, ; //X3_TITENG
	{ 'Nao integra o CVI'													, .T. }, ; //X3_DESCRIC
	{ 'Nao integra o CVI'													, .T. }, ; //X3_DESCSPA
	{ 'Nao integra o CVI'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP46970" ) ) ) ;
