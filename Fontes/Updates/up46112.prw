...
/*/
//--------------------------------------------------------------------
User Function UP46112( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP46112" )
				Else
					MsgStop( "Atualização não realizada.", "UP46112" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZFK'																	, .F. }, ; //X3_ARQUIVO
	{ '05'																	, .F. }, ; //X3_ORDEM
	{ 'ZFK_TIPOI'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 1																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Tipo Integ.'															, .F. }, ; //X3_TITULO
	{ 'Tipo Integ.'															, .F. }, ; //X3_TITSPA
	{ 'Tipo Integ.'															, .F. }, ; //X3_TITENG
	{ 'Tipo de Integracao'													, .F. }, ; //X3_DESCRIC
	{ 'Tipo de Integracao'													, .F. }, ; //X3_DESCSPA
	{ 'Tipo de Integracao'													, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	...
	{ ''																	, .F. }, ; //X3_OBRIGAT
	{ ''																	, .F. }, ; //X3_VLDUSER
	{ '1=Vinc NF x Ped (RDC);2=XML de NF (TMS);3=Canc NF (TMS);4=Vinc NF x Ped x Carga (TMS);5= Lib s/ NFe (TMS);6= Lib s/ NFe CI.(TMS)', .F. }, ; //X3_CBOX
	{ '1=Vinc NF x Ped (RDC);2=XML de NF (TMS);3=Canc NF (TMS);4=Vinc NF x Ped x Carga (TMS);5= Lib s/ NFe (TMS);6= Lib s/ NFe CI.(TMS)', .F. }, ; //X3_CBOXSPA
	{ '1=Vinc NF x Ped (RDC);2=XML de NF (TMS);3=Canc NF (TMS);4=Vinc NF x Ped x Carga (TMS);5= Lib s/ NFe (TMS);6= Lib s/ NFe CI.(TMS)', .F. }, ; //X3_CBOXENG
	{ ''																	, .F. }, ; //X3_PICTVAR
	{ ''																	, .F. }, ; //X3_WHEN
	{ ''																	, .F. }, ; //X3_INIBRW
	{ ''																	, .F. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'ZFK'																	, .F. }, ; //X3_ARQUIVO
	{ '30'																	, .F. }, ; //X3_ORDEM
	{ 'ZFK_CARGA'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 6																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Carga Proth.'														, .F. }, ; //X3_TITULO
	{ 'Carga Proth.'														, .F. }, ; //X3_TITSPA
	{ 'Carga Proth.'														, .F. }, ; //X3_TITENG
	{ 'Carga do Protheus'													, .F. }, ; //X3_DESCRIC
	{ 'Carga do Protheus'													, .F. }, ; //X3_DESCSPA
	{ 'Carga do Protheus'													, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ ''																	, .F. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFK'																	, .F. }, ; //X3_ARQUIVO
	{ '31'																	, .F. }, ; //X3_ORDEM
	{ 'ZFK_CARTMS'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 9																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Carga Mult.'															, .F. }, ; //X3_TITULO
	{ 'Carga Mult.'															, .F. }, ; //X3_TITSPA
	{ 'Carga Mult.'															, .F. }, ; //X3_TITENG
	{ 'Carga do Multiembarcador'											, .F. }, ; //X3_DESCRIC
	{ 'Carga do Multiembarcador'											, .F. }, ; //X3_DESCSPA
	{ 'Carga do Multiembarcador'											, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ ''																	, .F. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFK'																	, .F. }, ; //X3_ARQUIVO
	{ '32'																	, .F. }, ; //X3_ORDEM
	{ 'ZFK_PRTPED'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 10																	, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Protoc.Int.P'														, .F. }, ; //X3_TITULO
	{ 'Protoc.Int.P'														, .F. }, ; //X3_TITSPA
	{ 'Protoc.Int.P'														, .F. }, ; //X3_TITENG
	{ 'Protocolo de int. do Ped.'											, .F. }, ; //X3_DESCRIC
	{ 'Protocolo de int. do Ped.'											, .F. }, ; //X3_DESCSPA
	{ 'Protocolo de int. do Ped.'											, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ ''																	, .F. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFK'																	, .F. }, ; //X3_ARQUIVO
	{ '33'																	, .F. }, ; //X3_ORDEM
	{ 'ZFK_PRTMS'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 40																	, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Protoc. TMS'															, .F. }, ; //X3_TITULO
	{ 'Protoc. TMS'															, .F. }, ; //X3_TITSPA
	{ 'Protoc. TMS'															, .F. }, ; //X3_TITENG
	{ 'Protocolo Integracao TMS'											, .F. }, ; //X3_DESCRIC
	{ 'Protocolo Integracao TMS'											, .F. }, ; //X3_DESCSPA
	{ 'Protocolo Integracao TMS'											, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .F. }, ; //X3_USADO
	{ ''																	, .F. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP46112" ) ) ) ;
