...
/*/
//--------------------------------------------------------------------
User Function UP48915( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP48915" )
				Else
					MsgStop( "Atualização não Realizada.", "UP48915" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZBG'																	, .T. }, ; //X3_ARQUIVO
	{ '85'																	, .T. }, ; //X3_ORDEM
	{ 'ZBG_WEBINT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'WebServ.Inte'														, .T. }, ; //X3_TITULO
	{ 'WebServ.Inte'														, .T. }, ; //X3_TITSPA
	{ 'WebServ.Inte'														, .T. }, ; //X3_TITENG
	{ 'Webservice de Integracao'											, .T. }, ; //X3_DESCRIC
	{ 'Webservice de Integracao'											, .T. }, ; //X3_DESCSPA
	{ 'Webservice de Integracao'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. Pertence("CE")'											, .T. }, ; //X3_VLDUSER
	{ 'C=Cia do Leite;E=Evomilk;'											, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SA2'																	, .T. }, ; //X3_ARQUIVO
	{ 'FW'																	, .T. }, ; //X3_ORDEM
	{ 'A2_L_ENVEV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Env.Evomilk?'														, .T. }, ; //X3_TITULO
	{ 'Env.Evomilk?'														, .T. }, ; //X3_TITSPA
	{ 'Env.Evomilk?'														, .T. }, ; //X3_TITENG
	{ 'Envia para a Evomilk?'												, .T. }, ; //X3_DESCRIC
	{ 'Envia para a Evomilk?'												, .T. }, ; //X3_DESCSPA
	{ 'Envia para a Evomilk?'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Webservice de Integração' )

PutSX1Help( "PZBG_WEBINT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZBG_WEBINT" )
...
PutSX1Help( "PZBH_WEBINT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZBH_WEBINT" )
...
PutSX1Help( "PZBI_WEBINT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZBI_WEBINT" )
...
PutSX1Help( "PZBM_WEBINT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZBM_WEBINT" )
...
PutSX1Help( "PZBN_WEBINT", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZBN_WEBINT" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP48915" ) ) ) ;
