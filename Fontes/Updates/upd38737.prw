...
/*/
//--------------------------------------------------------------------
User Function UPD38737( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD38737" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD38737" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX5, { ;
	...
	'ZD'																	, ; //X5_TABELA
	'5'																		, ; //X5_CHAVE
	'Atendidos + Parcial entregue'											, ; //X5_DESCRI
	''																		, ; //X5_DESCSPA
	''																		} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'ZD'																	, ; //X5_TABELA
	'6'																		, ; //X5_CHAVE
	'Parcialmente Atendidos'												, ; //X5_DESCRI
	''																		, ; //X5_DESCSPA
	''																		} ) //X5_DESCENG
...
aAdd( aSX1, { ;
	'MTR120'																, ; //X1_GRUPO
	'07'																	, ; //X1_ORDEM
	'Lista quais ?'															, ; //X1_PERGUNT
	'¿Lista Cuales ?'														, ; //X1_PERSPA
	'List ?'																, ; //X1_PERENG
	'mv_ch7'																, ; //X1_VARIAVL
	'C'																		, ; //X1_TIPO
	1																		, ; //X1_TAMANHO
...
aAdd( aSX1, { ;
	'RCOM011'																, ; //X1_GRUPO
	'14'																	, ; //X1_ORDEM
	'Posição Pedido ?'														, ; //X1_PERGUNT
	'Posição Pedido ?'														, ; //X1_PERSPA
	'Posição Pedido ?'														, ; //X1_PERENG
	'MV_CH0'																, ; //X1_VARIAVL
	'N'																		, ; //X1_TIPO
	1																		, ; //X1_TAMANHO
	0																		, ; //X1_DECIMAL
	...
	''																		, ; //X1_CNT01
	''																		, ; //X1_VAR02
	'Pedidos Atendid'														, ; //X1_DEF02
	'Pedidos Atendid'														, ; //X1_DEFSPA2
	'Pedidos Atendid'														, ; //X1_DEFENG2
	''																		, ; //X1_CNT02
	''																		, ; //X1_VAR03
	'Ped.Nao Atendid'														, ; //X1_DEF03
	'Ped.Nao Atendid'														, ; //X1_DEFSPA3
	'Ped.Nao Atendid'														, ; //X1_DEFENG3
	''																		, ; //X1_CNT03
	''																		, ; //X1_VAR04
	'Parc. Atendidos'														, ; //X1_DEF04
	'Parc. Atendidos'														, ; //X1_DEFSPA4
	'Parc. Atendidos'														, ; //X1_DEFENG4
	''																		, ; //X1_CNT04
	''																		, ; //X1_VAR05
	'Nao Aten+Parcia'														, ; //X1_DEF05
	'Nao Aten+Parcia'														, ; //X1_DEFSPA5
	'Nao Aten+Parcia'														, ; //X1_DEFENG5
	''																		, ; //X1_CNT05
	''																		, ; //X1_F3
	''																		, ; //X1_PYME
	''																		, ; //X1_GRPSXG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD38737" ) ) ) ;
