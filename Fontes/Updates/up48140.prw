...
/*/
//--------------------------------------------------------------------
User Function UP48140( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP48140" )
				Else
					MsgStop( "Atualização não realizada.", "UP48140" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=sell;2=Rbx.Prc;3=Dt.Critc;4=Tabl.;5=Dif.Imp;6=In.Prod;7=Pr.Prod;8=Dif.Prc;9=Contr;10=Aniv;11=Re/Inaug;12=Mkt/Trade;13=UHT MGR', .T. }, ; //X3_CBOX
	{ '1=sell;2=Rbx.Prc;3=Dt.Critc;4=Tabl.;5=Dif.Imp;6=In.Prod;7=Pr.Prod;8=Dif.Prc;9=Contr;10=Aniv;11=Re/Inaug;12=Mkt/Trade;13=UHT MGR', .T. }, ; //X3_CBOXSPA
	{ '1=sell;2=Rbx.Prc;3=Dt.Critc;4=Tabl.;5=Dif.Imp;6=In.Prod;7=Pr.Prod;8=Dif.Prc;9=Contr;10=Aniv;11=Re/Inaug;12=Mkt/Trade;13=UHT MGR', .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP48140" ) ) ) ;
