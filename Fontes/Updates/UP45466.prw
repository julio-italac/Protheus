...
/*/
//--------------------------------------------------------------------
User Function UP45466( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP45466" )
				Else
					MsgStop( "Atualização não realizada.", "UP45466" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Aniversario;2=Inauguracao/Reinauguracao;3=Acao Comercial;4=Rebaixa de preco;5=Introducao de produto;6=Contrato;7=Investimento', ; //X3_CBOX
	'1=Aniversario;2=Inauguracao/Reinauguracao;3=Acao Comercial;4=Rebaixa de preco;5=Introducao de produto;6=Contrato;7=Investimento', ; //X3_CBOXSPA
	'1=Aniversario;2=Inauguracao/Reinauguracao;3=Acao Comercial;4=Rebaixa de preco;5=Introducao de produto;6=Contrato;7=Investimento', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Sub.Tipo'																, ; //X3_TITENG
	'Sub.Tipo'																, ; //X3_DESCRIC
	'Subtipo de Acordo Comerci'												, ; //X3_DESCSPA
	'Subtipo de Acordo Comerci'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1-sell_in/out;2-Rbxa.Prc;3-Dt.Critc;4-Tabl.;5-Dif.Imp;6-Int.Prod;7-Prom.Prod;8-Dif.Prc;9-Contr;10-Aniv;11-Re/Inaug;12-Mkt/Trade', ; //X3_CBOX
	'1-sell_in/out;2-Rbxa.Prc;3-Dt.Critc;4-Tabl.;5-Dif.Imp;6-Int.Prod;7-Prom.Prod;8-Dif.Prc;9-Contr;10-Aniv;11-Re/Inaug;12-Mkt/Trade', ; //X3_CBOXSPA
	'1-sell_in/out;2-Rbxa.Prc;3-Dt.Critc;4-Tabl.;5-Dif.Imp;6-Int.Prod;7-Prom.Prod;8-Dif.Prc;9-Contr;10-Aniv;11-Re/Inaug;12-Mkt/Trade', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Periodo neg.'															, ; //X3_TITULO
	'Periodo neg.'															, ; //X3_TITSPA
	'Periodo neg.'															, ; //X3_TITENG
	'Periodo neg.'															, ; //X3_DESCRIC
	'Periodo neg.'															, ; //X3_DESCSPA
	'Periodo neg.'															, ; //X3_DESCENG
	'@R 99/9999'															, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
	''																		, ; //X3_F3
...
aAdd( aSXA, { ;
	'ZK1'																	, ; //XA_ALIAS
	'1'																		, ; //XA_ORDEM
	'Dados da verba'														, ; //XA_DESCRIC
	'Dados da verba'														, ; //XA_DESCSPA
	'Dados da verba'														, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP45466" ) ) ) ;
