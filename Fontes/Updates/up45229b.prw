...
/*/
//--------------------------------------------------------------------
User Function UP45229B( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP45229B" )
				Else
					MsgStop( "Atualização não Realizada.", "UP45229B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Json Carga'															, ; //X3_TITULO
	'Json Carga'															, ; //X3_TITSPA
	'Json Carga'															, ; //X3_TITENG
	'Json completo da Carga'												, ; //X3_DESCRIC
	'Json completo da Carga'												, ; //X3_DESCSPA
	'Json completo da Carga'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Json completo da Carga' )

PutSX1Help( "PZFU_JSONCG", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFU_JSONCG" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP45229B" ) ) ) ;
