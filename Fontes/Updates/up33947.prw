...
/*/
//--------------------------------------------------------------------
User Function UP33947( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP33947" )
				Else
					MsgStop( "Atualização não realizada.", "UP33947" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Env.Email Co'															, ; //X3_TITULO
	'Env.Email Co'															, ; //X3_TITSPA
	'Env.Email Co'															, ; //X3_TITENG
	'Envia E-mail de Cobranca'												, ; //X3_DESCRIC
	'Envia E-mail de Cobranca'												, ; //X3_DESCSPA
	'Envia E-mail de Cobranca'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Envia E-mail de Cobrança?' )

aHlpEng := {}
aAdd( aHlpEng, 'Envia E-mail de Cobrança?' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Envia E-mail de Cobrança?' )

PutSX1Help( "PZFC_ENVCOB", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFC_ENVCOB" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP33947" ) ) ) ;
