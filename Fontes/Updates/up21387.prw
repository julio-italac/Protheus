...
/*/
//--------------------------------------------------------------------
User Function UP21387( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP21387" )
				Else
					MsgStop( "Atualização não Realizada.", "UP21387" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Status Ocorrenc.Fret'													, ; //XB_DESCRI
	'Status Ocorrenc.Fret'													, ; //XB_DESCSPA
	'Status Ocorrenc.Fret'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZFD'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP21387" ) ) ) ;
