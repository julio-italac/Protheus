...
/*/
//--------------------------------------------------------------------
User Function UP29243( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP29243" )
				Else
					MsgStop( "Atualização não Realizada.", "UP29243" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'Z10'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'Z10_HORAIN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Horario Inic'														, .T. }, ; //X3_TITULO
	{ 'Horario Inic'														, .T. }, ; //X3_TITSPA
	{ 'Horario Inic'														, .T. }, ; //X3_TITENG
	{ 'Horario Inicial Ocorrenci'											, .T. }, ; //X3_DESCRIC
	{ 'Horario Inicial Ocorrenci'											, .T. }, ; //X3_DESCSPA
	{ 'Horario Inicial Ocorrenci'											, .T. }, ; //X3_DESCENG
	{ '99:99'															    , .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'U_APON001H(M->Z10_HORAIN)'											, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'Z10'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'Z10_HORAFI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Horario Fin'															, .T. }, ; //X3_TITULO
	{ 'Horario Fin'															, .T. }, ; //X3_TITSPA
	{ 'Horario Fin'															, .T. }, ; //X3_TITENG
	{ 'Horario Final Ocorrencia'											, .T. }, ; //X3_DESCRIC
	{ 'Horario Final Ocorrencia'											, .T. }, ; //X3_DESCSPA
	{ 'Horario Final Ocorrencia'											, .T. }, ; //X3_DESCENG
	{ '99:99'															    , .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'U_APON001H(M->Z10_HORAFI)'											, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'Z10'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'Z10_TEMPOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tempo Decori'														, .T. }, ; //X3_TITULO
	{ 'Tempo Decori'														, .T. }, ; //X3_TITSPA
	{ 'Tempo Decori'														, .T. }, ; //X3_TITENG
	{ 'Tempo Decorrido'														, .T. }, ; //X3_DESCRIC
	{ 'Tempo Decorrido'														, .T. }, ; //X3_DESCSPA
	{ 'Tempo Decorrido'														, .T. }, ; //X3_DESCENG
	{ '99:99'															    , .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX7, { ;
	'Z10_HORAFI'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	"U_APON001P('Z10_HORAFI')"												, ; //X7_REGRA
	'Z10_HORAFI'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'Z10_HORAIN'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	"U_APON001P('Z10_HORAIN')"												, ; //X7_REGRA
	'Z10_HORAIN'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'Z10_MATRIC'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	"U_APON001P('Z10_MATRIC')"												, ; //X7_REGRA
	'Z10_MATRIC'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'Z10_ORIGEM'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	"U_APON001P('Z10_ORIGEM')"												, ; //X7_REGRA
	'Z10_ORIGEM'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Horarios Batimento E'													, ; //XB_DESCRI
	'Horarios Batimento E'													, ; //XB_DESCSPA
	'Horarios Batimento E'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SP8'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Horarios Batimento S'													, ; //XB_DESCRI
	'Horarios Batimento S'													, ; //XB_DESCSPA
	'Horarios Batimento S'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SP8'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP29243" ) ) ) ;
