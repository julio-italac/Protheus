...
/*/
//--------------------------------------------------------------------
User Function UPD52342( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPD52342" )
				Else
					MsgStop( "Atualização não realizada.", "UPD52342" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Stat Emissao'															, ; //X3_TITULO
	'Stat Emissao'															, ; //X3_TITSPA
	'Stat Emissao'															, ; //X3_TITENG
	'Stat Emissao'															, ; //X3_DESCRIC
	'Stat Emissao'															, ; //X3_DESCSPA
	'Stat Emissao'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Ato da Entrega;2=Pos Venda;3=Transferencia;4=Pallet;5=Vazio;6=Check List', ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD52342" ) ) ) ;
