...
/*/
//--------------------------------------------------------------------
User Function UP24028( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP24028" )
				Else
					MsgStop( "Atualização não Realizada.", "UP24028" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Exclusao PV?'															, ; //X3_TITULO
	'Exclusao PV?'															, ; //X3_TITSPA
	'Exclusao PV?'															, ; //X3_TITENG
	'Exclusao de Pedido Ven'												, ; //X3_DESCRIC
	'Exclusao de Pedido Ven'												, ; //X3_DESCSPA
	'Exclusao de Pedido Ven'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Produtos It'													, ; //XB_DESCRI
	'Lista de Produtos It'													, ; //XB_DESCSPA
	'Lista de Produtos It'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SB1'																	} ) //XB_CONTEM
