...
/*/
//--------------------------------------------------------------------
User Function UP21991( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP21991" )
				Else
					MsgStop( "Atualização não Realizada.", "UP21991" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'LISTA CARGA ZZN'														, ; //XB_DESCRI
	'LISTA CARGA ZZN'														, ; //XB_DESCSPA
	'LISTA CARGA ZZN'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZZN'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP21991" ) ) ) ;
