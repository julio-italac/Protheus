...
/*/
//--------------------------------------------------------------------
User Function UPD46079( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPD46079" )
				Else
					MsgStop( "Atualização não realizada.", "UPD46079" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '90'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_TRNF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tem TrocaNF?'														, .T. }, ; //X3_TITULO
	{ 'Tem TrocaNF?'														, .T. }, ; //X3_TITSPA
	{ 'Tem TrocaNF?'														, .T. }, ; //X3_TITENG
	{ 'Tem Troca NF?'														, .T. }, ; //X3_DESCRIC
	{ 'Tem Troca NF?'														, .T. }, ; //X3_DESCSPA
	{ 'Tem Troca NF?'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'Pertence("CFN")'														, .T. }, ; //X3_VALID
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ 'N=NAO;F=Tem troca NF: Faturamento;C=Tem troca NF: Carregamento'		, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '91'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_FITN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Fil.TrocaNF?'														, .T. }, ; //X3_TITULO
	{ 'Fil.TrocaNF?'														, .T. }, ; //X3_TITSPA
	{ 'Fil.TrocaNF?'														, .T. }, ; //X3_TITENG
	{ 'Filial da troca nota'												, .T. }, ; //X3_DESCRIC
	{ 'Filial da troca nota'												, .T. }, ; //X3_DESCSPA
	{ 'Filial da troca nota'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '92'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_CATN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Car.TrocaNF?'														, .T. }, ; //X3_TITULO
	{ 'Car.TrocaNF?'														, .T. }, ; //X3_TITSPA
	{ 'Car.TrocaNF?'														, .T. }, ; //X3_TITENG
	{ 'Carga de troca nota'													, .T. }, ; //X3_DESCRIC
	{ 'Carga de troca nota'													, .T. }, ; //X3_DESCSPA
	{ 'Carga de troca nota'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '93'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_INCC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Int.Carrega?'														, .T. }, ; //X3_TITULO
	{ 'Int.Carrega?'														, .T. }, ; //X3_TITSPA
	{ 'Int.Carrega?'														, .T. }, ; //X3_TITENG
	{ 'Integrou carga de carrega'											, .T. }, ; //X3_DESCRIC
	{ 'Integrou carga de carrega'											, .T. }, ; //X3_DESCSPA
	{ 'Integrou carga de carrega'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '94'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_INCF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Int.faturam?'														, .T. }, ; //X3_TITULO
	{ 'Int.faturam?'														, .T. }, ; //X3_TITSPA
	{ 'Int.faturam?'														, .T. }, ; //X3_TITENG
	{ 'Integrou carga de faturam'											, .T. }, ; //X3_DESCRIC
	{ 'Integrou carga de faturam'											, .T. }, ; //X3_DESCSPA
	{ 'Integrou carga de faturam'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'Pertence("SN")'														, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ '"N"'																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD46079" ) ) ) ;
