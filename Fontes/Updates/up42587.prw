...
/*/
//--------------------------------------------------------------------
User Function UP42587( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP42587" )
				Else
					MsgStop( "Atualização não Realizada.", "UP42587" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Env.Wf.Tit.V'															, ; //X3_TITULO
	'Env.Wf.Tit.V'															, ; //X3_TITSPA
	'Env.Wf.Tit.V'															, ; //X3_TITENG
	'Envia Wofkflow Tit.Vencid'												, ; //X3_DESCRIC
	'Envia Wofkflow Tit.Vencid'												, ; //X3_DESCSPA
	'Envia Wofkflow Tit.Vencid'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Envia Workflow de títulos vencidos.' )

aHlpEng := {}
aAdd( aHlpEng, 'Envia Workflow de títulos vencidos.' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Envia Workflow de títulos vencidos.' )

PutSX1Help( "PZZL_ENVWFT", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZL_ENVWFT" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP42587" ) ) ) ;
