...
/*/
//--------------------------------------------------------------------
User Function UP36841A( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP36841A" )
				Else
					MsgStop( "Atualização não Realizada.", "UP36841A" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 3																		, .T. }, ; //X3_DECIMAL
	{ 'Peso de Car.'														, .T. }, ; //X3_TITULO
	{ 'Peso'																, .T. }, ; //X3_TITSPA
	{ 'Weight'																, .T. }, ; //X3_TITENG
	{ 'Peso de Carregamento'												, .T. }, ; //X3_DESCRIC
	{ 'Peso'																, .T. }, ; //X3_DESCSPA
	{ 'Weight'																, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.999'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP36841A" ) ) ) ;
