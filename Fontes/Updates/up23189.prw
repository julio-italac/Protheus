...
/*/
//--------------------------------------------------------------------
User Function UP23189( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP23189" )
				Else
					MsgStop( "Atualização não Realizada.", "UP23189" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Categorias'													, ; //XB_DESCRI
	'Lista de Categorias'													, ; //XB_DESCSPA
	'Lista de Categorias'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SX5'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP23189" ) ) ) ;
