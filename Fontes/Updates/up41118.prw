...
/*/
//--------------------------------------------------------------------
User Function UP41118( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP41118" )
				Else
					MsgStop( "Atualização não Realizada.", "UP41118" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC6'																	, .T. }, ; //X3_ARQUIVO
	{ '62'																	, .T. }, ; //X3_ORDEM
	{ 'C6_CLASFIS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Sit.Tribut.'															, .T. }, ; //X3_TITULO
	{ 'Sit.Tribut.'															, .T. }, ; //X3_TITSPA
	{ 'Tax Situat.'															, .T. }, ; //X3_TITENG
	{ 'Situacao Tributaria'													, .T. }, ; //X3_DESCRIC
	{ 'Situacion Tributaria'												, .T. }, ; //X3_DESCSPA
	{ 'Taxation Status'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'If(!IsInCallStack("U_AOMS032"),MAFISGET("IT_CLASFIS"),.T.)'			, .T. }, ; //X3_VALID
...
aAdd( aSX9, { ;
	...
	'001'																	, ; //X9_IDENT
	'AB8'																	, ; //X9_CDOM
	'C6_NUM+C6_ITEM'														, ; //X9_EXPDOM
	'AB8_NUMPV'																, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'1'																		, ; //X9_LIGDOM
	'1'																		, ; //X9_LIGCDOM
	''																		, ; //X9_CONDSQL
...
aAdd( aSX9, { ;
	...
	'004'																	, ; //X9_IDENT
	'SC9'																	, ; //X9_CDOM
	'C6_NUM+C6_PRODUTO+C6_ITEM'												, ; //X9_EXPDOM
	'C9_PEDIDO+C9_PRODUTO+C9_ITEM'											, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'1'																		, ; //X9_LIGDOM
	'N'																		, ; //X9_LIGCDOM
	''																		, ; //X9_CONDSQL
...
aAdd( aSX9, { ;
	...
	'TEW'																	, ; //X9_CDOM
	'C6_NUM+C6_ITEM'														, ; //X9_EXPDOM
	'TEW_NUMPED+TEW_ITEMPV'													, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'1'																		, ; //X9_LIGDOM
	'N'																		, ; //X9_LIGCDOM
	''																		, ; //X9_CONDSQL
...
aAdd( aSX9, { ;
	...
	'002'																	, ; //X9_IDENT
	'TCV'																	, ; //X9_CDOM
	'C6_PRODUTO'															, ; //X9_EXPDOM
	'TCV_PRODPV'															, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'N'																		, ; //X9_LIGDOM
	'N'																		, ; //X9_LIGCDOM
	''																		, ; //X9_CONDSQL
...
aAdd( aSX9, { ;
	...
	'003'																	, ; //X9_IDENT
	'F76'																	, ; //X9_CDOM
	'C6_NUM+C6_ITEM+C6_CLI+C6_LOJA'											, ; //X9_EXPDOM
	'F76_PEDIDO+F76_ITEM+F76_CLIFOR+F76_LOJA'								, ; //X9_EXPCDOM
	'S'																		, ; //X9_PROPRI
	'1'																		, ; //X9_LIGDOM
	'1'																		, ; //X9_LIGCDOM
	"#F76_TIPO  ='1'"														, ; //X9_CONDSQL
	'N'																		, ; //X9_USEFIL
	'N'																		, ; //X9_VINFIL
	'N'																		, ; //X9_CHVFOR
	'S'																		} ) //X9_ENABLE
...
PutSX1Help( "PC6_CLASFIS", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "C6_CLASFIS" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP41118" ) ) ) ;
