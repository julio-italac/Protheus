...
/*/
//--------------------------------------------------------------------
User Function UP40209( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP40209" )
				Else
					MsgStop( "Atualização não Realizada.", "UP40209" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
PutSX1Help( "PF2_I_DTRAN", aHlpPor, {}, {}, .T.,,.T. )
...
PutSX1Help( "PF2_I_DTOPE", aHlpPor, {}, {}, .T.,,.T. )
...
PutSX1Help( "PZFC_DTTRAN", aHlpPor, {}, {}, .T.,,.T. )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP40209" ) ) ) ;
