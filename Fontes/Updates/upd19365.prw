...
ฑฑบ Programa ณ UPD19365 บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPD19365   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPD19365( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPD19365" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPD19365" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	...
	'Log cabec desconto contratual'											, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
...
aAdd( aSX2, { ;
	...
	'Log itens desconto contratual'											, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'GETSXENUM("ZAZ","ZAZ_COD")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	1																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'Rede'																	, ; //X3_TITSPA
	'Rede'																	, ; //X3_TITENG
	'Rede/Grupo de Vendas'													, ; //X3_DESCRIC
	'Rede/Grupo de Vendas'													, ; //X3_DESCSPA
	'Rede/Grupo de Vendas'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'VAZIO().OR.ExistCpo("ACY",M->ZAZ_GRPVEN)'								, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'Empty(M->ZAZ_CLIENT).AND.INCLUI'										, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'Cliente'																, ; //X3_TITSPA
	'Cliente'																, ; //X3_TITENG
	'Cliente do Contrato'													, ; //X3_DESCRIC
	'Cliente do Contrato'													, ; //X3_DESCSPA
	'Cliente do Contrato'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'VAZIO().OR.ExistCpo("SA1",M->ZAZ_CLIENT)'								, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'Empty(M->ZAZ_GRPVEN).AND.INCLUI'										, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'VAZIO().OR.ExistCpo("SA1",M->ZAZ_CLIENT+M->ZAZ_LOJA)'					, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	40																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome Cli/Red'															, ; //X3_TITULO
	'Nome Cli/Red'															, ; //X3_TITSPA
	'Nome Cli/Red'															, ; //X3_TITENG
	'Nome do Cliente/Rede'													, ; //X3_DESCRIC
	'Nome do Cliente/Rede'													, ; //X3_DESCSPA
	'Nome do Cliente/Rede'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Data de Inicio do Contr.'												, ; //X3_DESCRIC
	'Data de Inicio do Contr.'												, ; //X3_DESCSPA
	'Data de Inicio do Contr.'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Data Fim'																, ; //X3_TITSPA
	'Data Fim'																, ; //X3_TITENG
	'Data Fim do Contrato'													, ; //X3_DESCRIC
	'Data Fim do Contrato'													, ; //X3_DESCSPA
	'Data Fim do Contrato'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'M->ZAZ_DTFIM >= M->ZAZ_DTINI'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Abatimento'															, ; //X3_TITULO
	'Abatimento'															, ; //X3_TITSPA
	'Abatimento'															, ; //X3_TITENG
	'Abatimento na Duplicada'												, ; //X3_DESCRIC
	'Abatimento na Duplicada'												, ; //X3_DESCSPA
	'Abatimento na Duplicada'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'I=Integral;P=Parcial;N=Nao possui'										, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'!INCLUI .And. !ALTERA'													, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Matricula Ap'															, ; //X3_TITULO
	'Matricula Ap'															, ; //X3_TITSPA
	'Matricula Ap'															, ; //X3_TITENG
	'Matricula do Aprovador'												, ; //X3_DESCRIC
	'Matricula do Aprovador'												, ; //X3_DESCSPA
	'Matricula do Aprovador'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Aprovac'															, ; //X3_TITULO
	'Hora Aprovac'															, ; //X3_TITSPA
	'Hora Aprovac'															, ; //X3_TITENG
	'Hora da Aprovacao'														, ; //X3_DESCRIC
	'Hora da Aprovacao'														, ; //X3_DESCSPA
	'Hora da Aprovacao'														, ; //X3_DESCENG
	'@E 99:99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Status'																, ; //X3_TITSPA
	'Status'																, ; //X3_TITENG
	'Status da Aprovacao'													, ; //X3_DESCRIC
	'Status da Aprovacao'													, ; //X3_DESCSPA
	'Status da Aprovacao'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'ExistCpo("SB1",M->ZB0_SB1COD)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Contr Italac'															, ; //X3_TITULO
	'Contr Italac'															, ; //X3_TITSPA
	'Contr Italac'															, ; //X3_TITENG
	'Nro do Contrato Italac'												, ; //X3_DESCRIC
	'Nro do Contrato Italac'												, ; //X3_DESCSPA
	'Nro do Contrato Italac'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Vazio().Or.ExistCpo("SA1",M->ZB0_CLIENT)'								, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Loja'																	, ; //X3_TITSPA
	'Loja'																	, ; //X3_TITENG
	'Loja do cliente do Contr.'												, ; //X3_DESCRIC
	'Loja do cliente do Contr.'												, ; //X3_DESCSPA
	'Loja do cliente do Contr.'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Vazio().Or.ExistCpo("SA1",GdFieldGet("ZB0_CLIENT",n)+M->ZB0_LOJA)'		, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Abatimento'															, ; //X3_TITSPA
	'Abatimento'															, ; //X3_TITENG
	'Abatimento'															, ; //X3_DESCRIC
	'Abatimento'															, ; //X3_DESCSPA
	'Abatimento'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Eval({|| aCols[n,aScan(aHeader,{|x| AllTrim(x[2])=="ZB0_DESCPA"})] :=0,.T.})', ; //X3_VLDUSER
	'I=Integral;P=Parcial;N=Nao possui'										, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'% Desc. Parc'															, ; //X3_TITSPA
	'% Desc. Parc'															, ; //X3_TITENG
	'% Desconto Parcial'													, ; //X3_DESCRIC
	'% Desconto Parcial'													, ; //X3_DESCSPA
	'% Desconto Parcial'													, ; //X3_DESCENG
	'@E 999.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'IIF(!Empty(M->ZB0_EST),ExistCpo("SX5","12" + M->ZB0_EST),.T.)'			, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'ST Base Desc'															, ; //X3_TITULO
	'ST Base Desc'															, ; //X3_TITSPA
	'ST Base Desc'															, ; //X3_TITENG
	'ST Base Desc'															, ; //X3_DESCRIC
	'ST Base Desc'															, ; //X3_DESCSPA
	'ST Base Desc'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'Z17'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z17_FILIAL+Z17_NOME'													, ; //CHAVE
	'Nome Cli/Red'															, ; //DESCRICAO
	'Nome Cli/Red'															, ; //DESCSPA
	'Nome Cli/Red'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'Z17'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'Z17_FILIAL+Z17_DTINI'													, ; //CHAVE
	'Data Inicio'															, ; //DESCRICAO
	'Data Inicio'															, ; //DESCSPA
	'Data Inicio'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'Z18'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z18_FILIAL+Z18_COD+Z18_ITEM'											, ; //CHAVE
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  05/04/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
