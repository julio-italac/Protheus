...
/*/
//--------------------------------------------------------------------
User Function UP43518( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP43518" )
				Else
					MsgStop( "Atualização não realizada.", "UP43518" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'E4'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_DTRAN'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt.Entr.Tran'														, .T. }, ; //X3_TITULO
	{ 'Dt.Entr.Tran'														, .T. }, ; //X3_TITSPA
	{ 'Dt.Entr.Tran'														, .T. }, ; //X3_TITENG
	{ 'Data Entrega Transport.'												, .T. }, ; //X3_DESCRIC
	{ 'Data Entrega Transport.'												, .T. }, ; //X3_DESCSPA
	{ 'Data Entrega Transport.'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'E5'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_DENOL'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt ent op'															, .T. }, ; //X3_TITULO
	{ 'Dt ent op'															, .T. }, ; //X3_TITSPA
	{ 'Dt ent op'															, .T. }, ; //X3_TITENG
	{ 'Data entrega no op log'												, .T. }, ; //X3_DESCRIC
	{ 'Data entrega no op log'												, .T. }, ; //X3_DESCSPA
	{ 'Data entrega no op log'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'E9'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_DENCL'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data ent cli'														, .T. }, ; //X3_TITULO
	{ 'Data ent cli'														, .T. }, ; //X3_TITSPA
	{ 'Data ent cli'														, .T. }, ; //X3_TITENG
	{ 'Data entrega no cliente'												, .T. }, ; //X3_DESCRIC
	{ 'Data entrega no cliente'												, .T. }, ; //X3_DESCSPA
	{ 'Data entrega no cliente'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'EA'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_DTOPE'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt.Entr.Op.L'														, .T. }, ; //X3_TITULO
	{ 'Dt.Entr.Op.L'														, .T. }, ; //X3_TITSPA
	{ 'Dt.Entr.Op.L'														, .T. }, ; //X3_TITENG
	{ 'Data Entrega Operador Log'											, .T. }, ; //X3_DESCRIC
	{ 'Data Entrega Operador Log'											, .T. }, ; //X3_DESCSPA
	{ 'Data Entrega Operador Log'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFC'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZFC_DTTRAN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Atual.Dt.Ent'														, .T. }, ; //X3_TITULO
	{ 'Atual.Dt.Ent'														, .T. }, ; //X3_TITSPA
	{ 'Atual.Dt.Ent'														, .T. }, ; //X3_TITENG
	{ 'Atualiza Data Entrega Tra'											, .T. }, ; //X3_DESCRIC
	{ 'Atualiza Data Entrega Tra'											, .T. }, ; //X3_DESCSPA
	{ 'Atualiza Data Entrega Tra'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. Pertence("CON")'										, .T. }, ; //X3_VLDUSER
	{ 'C=Atualiza Dt.Entrega Cliente;O=Atualiza Dt.Entrega Operador Logistico;N=Nao atualiza Dt.Entrega', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Data Entrega Transportadora (Data da' )
aAdd( aHlpPor, 'Ocorrência de Frete).' )

aHlpEng := {}
aAdd( aHlpEng, 'Data Entrega Transportadora (Data da' )
aAdd( aHlpEng, 'Ocorrência de Frete).' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Data Entrega Transportadora (Data da' )
aAdd( aHlpSpa, 'Ocorrência de Frete).' )

PutSX1Help( "PF2_I_DTRAN", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "F2_I_DTRAN" )

aHlpPor := {}
aAdd( aHlpPor, 'Data Entrega Operador Logístico (Data' )
aAdd( aHlpPor, 'deentrega do Operador Logistico nas' )
aAdd( aHlpPor, 'Ocorrências de Frete).' )

aHlpEng := {}
aAdd( aHlpEng, 'Data Entrega Operador Logístico (Data' )
aAdd( aHlpEng, 'deentrega do Operador Logistico nas' )
aAdd( aHlpEng, 'Ocorrências de Frete).' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Data Entrega Operador Logístico (Data' )
aAdd( aHlpSpa, 'deentrega do Operador Logistico nas' )
aAdd( aHlpSpa, 'Ocorrências de Frete).' )

PutSX1Help( "PF2_I_DTOPE", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "F2_I_DTOPE" )

//
// Helps Tabela ZFC
//
aHlpPor := {}
aAdd( aHlpPor, 'Atualiza Data Entrega Transportador' )

aHlpEng := {}
aAdd( aHlpEng, 'Atualiza Data Entrega Transportador' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Atualiza Data Entrega Transportador' )

PutSX1Help( "PZFC_DTTRAN", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFC_DTTRAN" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP43518" ) ) ) ;
