...
/*/
//--------------------------------------------------------------------
User Function UPD37491( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD37491" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD37491" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hora Ult. Wf'															, ; //X3_TITULO
	'Hora Ult. Wf'															, ; //X3_TITSPA
	'Hora Ult. Wf'															, ; //X3_TITENG
	'Hora Ult. Wf'															, ; //X3_DESCRIC
	'Hora Ult. Wf'															, ; //X3_DESCSPA
	'Hora Ult. Wf'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	'Dt Ult. WF'															, ; //X3_TITSPA
	'Dt Ult. WF'															, ; //X3_TITENG
	'Dt Ult. WF'															, ; //X3_DESCRIC
	'Dt Ult. WF'															, ; //X3_DESCSPA
	'Dt Ult. WF'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD37491" ) ) ) ;
