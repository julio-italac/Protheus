...
/*/
//--------------------------------------------------------------------
User Function UP49115( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP49115" )
				Else
					MsgStop( "Atualização não realizada.", "UP49115" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SBZ'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'BZ_ESTSEG'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Seguranca'															, .T. }, ; //X3_TITULO
	{ 'Seguridad'															, .T. }, ; //X3_TITSPA
	{ 'Safety Inv.'															, .T. }, ; //X3_TITENG
	{ 'Estoque de Seguranca'												, .T. }, ; //X3_DESCRIC
	{ 'Stock de Seguridad'													, .T. }, ; //X3_DESCSPA
	{ 'Security Inventory'													, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x xxxx  xxxxx  xx       x      xx       x   x xxxxxx    x       x       x       x       x       x       x       x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ '  xx x x'															, .T. }, ; //X3_RESERV
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Positivo() .AND. U_EST27CPO()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Estoq Maximo'														, .T. }, ; //X3_TITULO
	{ 'Stock Maximo'														, .T. }, ; //X3_TITSPA
	{ 'Maxim. Stock'														, .T. }, ; //X3_TITENG
	{ 'Estoque Maximo'														, .T. }, ; //X3_DESCRIC
	{ 'Stock Maximo'														, .T. }, ; //X3_DESCSPA
	{ 'Maximum Stock'														, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Entrega'																, .T. }, ; //X3_TITULO
	{ 'Entrega'																, .T. }, ; //X3_TITSPA
	{ 'Deliv.Term'															, .T. }, ; //X3_TITENG
	{ 'Prazo de Entrega'													, .T. }, ; //X3_DESCRIC
	{ 'Plazo de Entrega'													, .T. }, ; //X3_DESCSPA
	{ 'Delivery Term'														, .T. }, ; //X3_DESCENG
	{ '@E 99999'															, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
...
aAdd( aSX3, { ;
	...
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Prazo'															, .T. }, ; //X3_TITULO
	{ 'Tipo Plazo'															, .T. }, ; //X3_TITSPA
	{ 'Type of Term'														, .T. }, ; //X3_TITENG
	{ 'Tipo Prazo entrega'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo Plazo Entrega'													, .T. }, ; //X3_DESCSPA
	{ 'Type of Deliv.Term(D/M/Y)'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'pertence("HDSMA") .and. U_EST27CPO()'								, .T. }, ; //X3_VLDUSER
	{ 'H=Horas;D=Dias;S=Semana;M=Mes;A=Ano'									, .T. }, ; //X3_CBOX
	{ 'H=Horas;D=Dias;S=Semana;M=Mes;A=Ano'									, .T. }, ; //X3_CBOXSPA
	{ 'H=Hours;D=Days;S=Week;M=Month;A=Year'								, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'SBZ'																	, .T. }, ; //X3_ARQUIVO
	{ '48'																	, .T. }, ; //X3_ORDEM
	{ 'BZ_I_LOCAL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Localizacao'															, .T. }, ; //X3_TITULO
	{ 'Localizacao'															, .T. }, ; //X3_TITSPA
	{ 'Localizacao'															, .T. }, ; //X3_TITENG
	{ 'Localizacao Almoxarifado'											, .T. }, ; //X3_DESCRIC
	{ 'Localizacao Almoxarifado'											, .T. }, ; //X3_DESCSPA
	{ 'Localizacao Almoxarifado'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SBZ'																	, .T. }, ; //X3_ARQUIVO
	{ '71'																	, .T. }, ; //X3_ORDEM
	{ 'BZ_I_OBSOL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Prod Obsolet'														, .T. }, ; //X3_TITULO
	{ 'Prod Obsolet'														, .T. }, ; //X3_TITSPA
	{ 'Prod Obsolet'														, .T. }, ; //X3_TITENG
	{ 'Prod Obsolet'														, .T. }, ; //X3_DESCRIC
	{ 'Prod Obsolet'														, .T. }, ; //X3_DESCSPA
	{ 'Prod Obsolet'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ '"N"'																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("SN") .and. U_EST27CPO()'									, .T. }, ; //X3_VLDUSER
...
aAdd( aSX3, { ;
	{ 'SBZ'																	, .T. }, ; //X3_ARQUIVO
	{ '72'																	, .T. }, ; //X3_ORDEM
	{ 'BZ_I_DIRBI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'BI Diretoria'														, .T. }, ; //X3_TITULO
	{ 'BI Diretoria'														, .T. }, ; //X3_TITSPA
	{ 'BI Diretoria'														, .T. }, ; //X3_TITENG
	{ 'BI Diretoria'														, .T. }, ; //X3_DESCRIC
	{ 'BI Diretoria'														, .T. }, ; //X3_DESCSPA
	{ 'BI Diretoria'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ '"2"'																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Pertence("12") .and. U_EST27CPO()'									, .T. }, ; //X3_VLDUSER
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP49115" ) ) ) ;
