...
/*/
//--------------------------------------------------------------------
User Function UPD44277( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD44277" )
				Else
					MsgStop( "Atualização não realizada.", "UPD44277" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SA3'																	, .T. }, ; //X3_ARQUIVO
	{ '24'																	, .T. }, ; //X3_ORDEM
	{ 'A3_I_MAIL2'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 120																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'E-mail 2'															, .T. }, ; //X3_TITULO
	{ 'E-mail 2'															, .T. }, ; //X3_TITSPA
	{ 'E-mail 2'															, .T. }, ; //X3_TITENG
	{ 'E-mail 2'															, .T. }, ; //X3_DESCRIC
	{ 'E-mail 2'															, .T. }, ; //X3_DESCSPA
	{ 'E-mail 2'															, .T. }, ; //X3_DESCENG
	{ '!@'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD44277" ) ) ) ;
