...
/*/
//--------------------------------------------------------------------
User Function UPD43076( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD43076" )
				Else
					MsgStop( "Atualização não realizada.", "UPD43076" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '64'																	, .T. }, ; //X3_ORDEM
	{ 'C5_ASSCOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Codigo Assi'															, .T. }, ; //X3_TITULO
	{ 'Codigo Assi'															, .T. }, ; //X3_TITSPA
	{ 'Codigo Assi'															, .T. }, ; //X3_TITENG
	{ 'Codigo Assistente'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Assistente'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Assistente'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '64'																	, .T. }, ; //X3_ORDEM
	{ 'C5_ASSNOM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 30																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Assistente'															, .T. }, ; //X3_TITULO
	{ 'Assistente'															, .T. }, ; //X3_TITSPA
	{ 'Assistente'															, .T. }, ; //X3_TITENG
	{ 'Assistente'															, .T. }, ; //X3_DESCRIC
	{ 'Assistente'															, .T. }, ; //X3_DESCSPA
	{ 'Assistente'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZPG'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZPG_SUPCOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Codigo Supe'															, .T. }, ; //X3_TITULO
	{ 'Codigo Supe'															, .T. }, ; //X3_TITSPA
	{ 'Codigo Supe'															, .T. }, ; //X3_TITENG
	{ 'Codigo Supervisor'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Supervisor'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Supervisor'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZPG'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZPG_GERCOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Codigo Geren'														, .T. }, ; //X3_TITULO
	{ 'Codigo Geren'														, .T. }, ; //X3_TITSPA
	{ 'Codigo Geren'														, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Telefone 1'															, .T. }, ; //X3_TITULO
	{ 'Telefone 1'															, .T. }, ; //X3_TITSPA
	{ 'Telefone 1'															, .T. }, ; //X3_TITENG
	{ 'Telefone 1'															, .T. }, ; //X3_DESCRIC
	{ 'Telefone 1'															, .T. }, ; //X3_DESCSPA
	{ 'Telefone 1'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD43076" ) ) ) ;
