...
/*/
//--------------------------------------------------------------------
User Function UPD30921( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD30921" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD30921" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZZL'																	, .T. }, ; //X3_ARQUIVO
	{ '68'																	, .T. }, ; //X3_ORDEM
	{ 'ZZL_CLAIM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Libera CLAIM'														, .T. }, ; //X3_TITULO
	{ 'Libera CLAIM'														, .T. }, ; //X3_TITSPA
	{ 'Libera CLAIM'														, .T. }, ; //X3_TITENG
	{ 'Permite Liberar CLAIM'												, .T. }, ; //X3_DESCRIC
	{ 'Permite Liberar CLAIM'												, .T. }, ; //X3_DESCSPA
	{ 'Permite Liberar CLAIM'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD30921" ) ) ) ;
