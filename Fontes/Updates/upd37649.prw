...
/*/
//--------------------------------------------------------------------
User Function UPD37649( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD37649" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD37649" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_PSEC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 3																		, .T. }, ; //X3_DECIMAL
	{ 'Peso C.Seca'															, .T. }, ; //X3_TITULO
	{ 'Peso C.Seca'															, .T. }, ; //X3_TITSPA
	{ 'Peso C.Seca'															, .T. }, ; //X3_TITENG
	{ 'Peso da carga seca'													, .T. }, ; //X3_DESCRIC
	{ 'Peso da carga seca'													, .T. }, ; //X3_DESCSPA
	{ 'Peso da carga seca'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_PREF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 3																		, .T. }, ; //X3_DECIMAL
	{ 'Peso C.Refr'															, .T. }, ; //X3_TITULO
	{ 'Peso C.Refr'															, .T. }, ; //X3_TITSPA
	{ 'Peso C.Refr'															, .T. }, ; //X3_TITENG
	{ 'Peso da carga refrigerada'											, .T. }, ; //X3_DESCRIC
	{ 'Peso da carga refrigerada'											, .T. }, ; //X3_DESCSPA
	{ 'Peso da carga refrigerada'											, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999.999'													, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SA2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZA'																	, .T. }, ; //X3_ORDEM
	{ 'A2_I_DIRFT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 254																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Diretorio'															, .T. }, ; //X3_TITULO
	{ 'Diretorio'															, .T. }, ; //X3_TITSPA
	{ 'Diretorio'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'SA2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZB'																	, .T. }, ; //X3_ORDEM
	{ 'A2_I_VFRPS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Frt C.Se'														, .T. }, ; //X3_TITULO
	{ 'Vlr Frt C.Se'														, .T. }, ; //X3_TITSPA
	{ 'Vlr Frt C.Se'														, .T. }, ; //X3_TITENG
	{ 'Vlr frete peso p/ carga s'											, .T. }, ; //X3_DESCRIC
	{ 'Vlr frete peso p/ carga s'											, .T. }, ; //X3_DESCSPA
	{ 'Vlr frete peso p/ carga s'											, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SA2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZC'																	, .T. }, ; //X3_ORDEM
	{ 'A2_I_VFRPR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Frt C.Re'														, .T. }, ; //X3_TITULO
	{ 'Vlr Frt C.Re'														, .T. }, ; //X3_TITSPA
	{ 'Vlr Frt C.Re'														, .T. }, ; //X3_TITENG
	{ 'Vlr frete peso p/ carga r'											, .T. }, ; //X3_DESCRIC
	{ 'Vlr frete peso p/ carga r'											, .T. }, ; //X3_DESCSPA
	{ 'Vlr frete peso p/ carga r'											, .T. }, ; //X3_DESCENG
	{ '@E 999,999.99'														, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SA2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZZ'																	, .T. }, ; //X3_ORDEM
	{ 'A2_I_VFRKG'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Fret p/K'														, .T. }, ; //X3_TITULO
	{ 'Vlr Fret p/K'														, .T. }, ; //X3_TITSPA
	{ 'Vlr Fret p/K'														, .T. }, ; //X3_TITENG
	{ 'Valor do frete por KG'												, .T. }, ; //X3_DESCRIC
	{ 'Valor do frete por KG'												, .T. }, ; //X3_DESCSPA
	{ 'Valor do frete por KG'												, .T. }, ; //X3_DESCENG
	{ '@E 999,999.99'														, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD37649" ) ) ) ;
