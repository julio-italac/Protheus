...
/*/
//--------------------------------------------------------------------
User Function UPD44408( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD44408" )
				Else
					MsgStop( "Atualização não realizada.", "UPD44408" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Mat Substitu'															, ; //X3_TITULO
	'Mat Substitu'															, ; //X3_TITSPA
	'Mat Substitu'															, ; //X3_TITENG
	'Mat Funcionario Substitui'												, ; //X3_DESCRIC
	'Mat Funcionario Substitui'												, ; //X3_DESCSPA
	'Mat Funcionario Substitui'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD44408" ) ) ) ;
