...
/*/
//--------------------------------------------------------------------
User Function UPD44407( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD44407" )
				Else
					MsgStop( "Atualização não realizada.", "UPD44407" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Bloq prodXFi'															, ; //X3_TITULO
	'Bloq prodXFi'															, ; //X3_TITSPA
	'Bloq prodXFi'															, ; //X3_TITENG
	'Bloqueio Produto x Filial'												, ; //X3_DESCRIC
	'Bloqueio Produto x Filial'												, ; //X3_DESCSPA
	'Bloqueio Produto x Filial'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD44407" ) ) ) ;
