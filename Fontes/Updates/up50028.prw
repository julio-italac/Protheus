...
/*/
//--------------------------------------------------------------------
User Function UP50028( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP50028" )
				Else
					MsgStop( "Atualização não realizada.", "UP50028" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'Z27'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'Z27_VALEXC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vr Excedido'															, .T. }, ; //X3_TITULO
	{ 'Vr Excedido'															, .T. }, ; //X3_TITSPA
	{ 'Vr Excedido'															, .T. }, ; //X3_TITENG
	{ 'Vr Excedido'															, .T. }, ; //X3_DESCRIC
	{ 'Vr Excedido'															, .T. }, ; //X3_DESCSPA
	{ 'Vr Excedido'															, .T. }, ; //X3_DESCENG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP50028" ) ) ) ;
