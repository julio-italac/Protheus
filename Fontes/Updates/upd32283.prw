...
/*/
//--------------------------------------------------------------------
User Function UPD32283( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD32283" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD32283" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SZW'																	, .F. }, ; //X3_ARQUIVO
	{ 'A0'																	, .F. }, ; //X3_ORDEM
	{ 'ZW_NIVELWF'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 1																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'NIVEL WF'															, .F. }, ; //X3_TITULO
	{ 'NIVEL WF'															, .F. }, ; //X3_TITSPA
	{ 'NIVEL WF'															, .F. }, ; //X3_TITENG
	{ 'NIVEL WF'															, .F. }, ; //X3_DESCRIC
	{ 'NIVEL WF'															, .F. }, ; //X3_DESCSPA
	{ 'NIVEL WF'															, .F. }, ; //X3_DESCENG
	{ '@!'																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SZW'																	, .F. }, ; //X3_ARQUIVO
	{ 'A2'																	, .F. }, ; //X3_ORDEM
	{ 'ZW_DTENVIO'															, .F. }, ; //X3_CAMPO
	{ 'D'																	, .F. }, ; //X3_TIPO
	{ 8																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'DT ENVIO'															, .F. }, ; //X3_TITULO
	{ 'DT ENVIO'															, .F. }, ; //X3_TITSPA
	{ 'DT ENVIO'															, .F. }, ; //X3_TITENG
	{ 'DT ENVIO'															, .F. }, ; //X3_DESCRIC
	{ 'DT ENVIO'															, .F. }, ; //X3_DESCSPA
	{ 'DT ENVIO'															, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZW'																	, .F. }, ; //X3_ARQUIVO
	{ 'A3'																	, .F. }, ; //X3_ORDEM
	{ 'ZW_HRENVIO'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 5																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'HR ENVIO'															, .F. }, ; //X3_TITULO
	{ 'HR ENVIO'															, .F. }, ; //X3_TITSPA
	{ 'HR ENVIO'															, .F. }, ; //X3_TITENG
	{ 'HR ENVIO'															, .F. }, ; //X3_DESCRIC
	{ 'HR ENVIO'															, .F. }, ; //X3_DESCSPA
	{ 'HR ENVIO'															, .F. }, ; //X3_DESCENG
	{ '@!'																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD32283" ) ) ) ;
