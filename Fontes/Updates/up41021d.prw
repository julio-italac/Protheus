...
/*/
//--------------------------------------------------------------------
User Function UP41021D( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP41021D" )
				Else
					MsgStop( "Atualização não Realizada.", "UP41021D" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Codigo Favorecido'														, ; //X3_DESCRIC
	'Codigo Favorecido'														, ; //X3_DESCSPA
	'Codigo Favorecido'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Loja Favorecido'														, ; //X3_DESCRIC
	'Loja Favorecido'														, ; //X3_DESCSPA
	'Loja Favorecido'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome Favorec'															, ; //X3_TITULO
	'Nome Favorec'															, ; //X3_TITSPA
	'Nome Favorec'															, ; //X3_TITENG
...
aAdd( aSX7, { ;
	'ZK3_FAVLOJ'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SA1",1,xFilial("SA1")+M->ZK3_FAVORE+M->ZK3_FAVLOJ,"A1_NREDUZ")'	, ; //X7_REGRA
	'ZK3_FAVDES'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'ZK3_VALOR'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'M->ZK1_FAVORE'															, ; //X7_REGRA
	'ZK3_FAVORE'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'ZK3_VALOR'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'M->ZK1_FAVLOJ'															, ; //X7_REGRA
	'ZK3_FAVLOJ'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP41021D" ) ) ) ;
