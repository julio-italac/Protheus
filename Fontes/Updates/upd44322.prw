...
/*/
//--------------------------------------------------------------------
User Function UPD44322( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD44322" )
				Else
					MsgStop( "Atualização não realizada.", "UPD44322" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Paga p/bolet'															, ; //X3_TITULO
	'Paga p/bolet'															, ; //X3_TITSPA
	'Paga p/bolet'															, ; //X3_TITENG
	'Pagar por boleto?'														, ; //X3_DESCRIC
	'Pagar por boleto?'														, ; //X3_DESCSPA
	'Pagar por boleto?'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD44322" ) ) ) ;
