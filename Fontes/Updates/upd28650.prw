...
/*/
//--------------------------------------------------------------------
User Function UPD28650( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD28650" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD28650" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Prx Mes?'															, .T. }, ; //X3_TITSPA
	{ 'Prx Mes?'															, .T. }, ; //X3_TITENG
	{ 'Proximo Mes?'														, .T. }, ; //X3_DESCRIC
	{ 'Proximo Mes?'														, .T. }, ; //X3_DESCSPA
	{ 'Proximo Mes?'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ "Pertence('SNP')"														, .T. }, ; //X3_VLDUSER
	{ 'S=Sim;N=Nao;P=Periodo'												, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '71'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_PERIOD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Periodo Dia'															, .T. }, ; //X3_TITULO
	{ 'Periodo Dia'															, .T. }, ; //X3_TITSPA
	{ 'Periodo Dia'															, .T. }, ; //X3_TITENG
	{ 'Periodo Dia'															, .T. }, ; //X3_DESCRIC
	{ 'Periodo Dia'															, .T. }, ; //X3_DESCSPA
	{ 'Periodo Dia'															, .T. }, ; //X3_DESCENG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD28650" ) ) ) ;
