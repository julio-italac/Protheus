...
/*/
//--------------------------------------------------------------------
User Function UPD43864( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD43864" )
				Else
					MsgStop( "Atualização não realizada.", "UPD43864" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '64'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_LOCEM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Local de Emb'														, .T. }, ; //X3_TITULO
	{ 'Local de Emb'														, .T. }, ; //X3_TITSPA
	{ 'Local de Emb'														, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'T1'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_TT1TR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tr.Time 1oTr'														, .T. }, ; //X3_TITULO
	{ 'Tr.Time 1oTr'														, .T. }, ; //X3_TITSPA
	{ 'Tr.Time 1oTr'														, .T. }, ; //X3_TITENG
	{ 'Transit Time 1o Trecho'												, .T. }, ; //X3_DESCRIC
	{ 'Transit Time 1o Trecho'												, .T. }, ; //X3_DESCSPA
	{ 'Transit Time 1o Trecho'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'T2'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_TT2TR'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tr.Time 2oTr'														, .T. }, ; //X3_TITULO
	{ 'Tr.Time 2oTr'														, .T. }, ; //X3_TITSPA
	{ 'Tr.Time 2oTr'														, .T. }, ; //X3_TITENG
	{ 'Transit Time 2o Trecho'												, .T. }, ; //X3_DESCRIC
	{ 'Transit Time 2o Trecho'												, .T. }, ; //X3_DESCSPA
	{ 'Transit Time 2o Trecho'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD43864" ) ) ) ;
