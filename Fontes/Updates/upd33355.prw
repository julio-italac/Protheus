...
/*/
//--------------------------------------------------------------------
User Function UPD33355( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD33355" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD33355" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Detalhe'																, .T. }, ; //X3_TITSPA
	{ 'Detalhe'																, .T. }, ; //X3_TITENG
	{ 'Detalhe'																, .T. }, ; //X3_DESCRIC
	{ 'Detalhe'																, .T. }, ; //X3_DESCSPA
	{ 'Detalhe'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SCP'																	, .T. }, ; //X3_ARQUIVO
	{ '61'																	, .T. }, ; //X3_ORDEM
	{ 'CP_I_SITWF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Enviar WF?'															, .T. }, ; //X3_TITULO
	{ 'Enviar WF?'															, .T. }, ; //X3_TITSPA
	{ 'Enviar WF?'															, .T. }, ; //X3_TITENG
	{ 'Enviar WF?'															, .T. }, ; //X3_DESCRIC
	{ 'Enviar WF?'															, .T. }, ; //X3_DESCSPA
	{ 'Enviar WF?'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SCP'																	, .T. }, ; //X3_ARQUIVO
	{ '62'																	, .T. }, ; //X3_ORDEM
	{ 'CP_I_OBSAP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 250																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Obs WF-SA'															, .T. }, ; //X3_TITULO
	{ 'Obs WF-SA'															, .T. }, ; //X3_TITSPA
	{ 'Obs WF-SA'															, .T. }, ; //X3_TITENG
	{ 'Obs WF-SA'															, .T. }, ; //X3_DESCRIC
	{ 'Obs WF-SA'															, .T. }, ; //X3_DESCSPA
	{ 'Obs WF-SA'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Hora'																, .T. }, ; //X3_TITSPA
	{ 'Hora'																, .T. }, ; //X3_TITENG
	{ 'Hora Envio/Recebimento'												, .T. }, ; //X3_DESCRIC
	{ 'Hora Envio/Recebimento'												, .T. }, ; //X3_DESCSPA
	{ 'Hora Envio/Recebimento'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Rotina'																, .T. }, ; //X3_TITSPA
	{ 'Rotina'																, .T. }, ; //X3_TITENG
	{ 'Rotina de execucao'													, .T. }, ; //X3_DESCRIC
	{ 'Rotina de execucao'													, .T. }, ; //X3_DESCSPA
	{ 'Rotina de execucao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZGT'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZGT_FILIAL+ZGT_CDAPRV'													, ; //CHAVE
	'Filial+Cod.Aprov'														, ; //DESCRICAO
	'Filial+Cod.Aprov'														, ; //DESCSPA
	'Filial+Cod.Aprov'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD33355" ) ) ) ;
