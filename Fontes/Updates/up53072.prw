...
/*/
//--------------------------------------------------------------------
User Function UP53072( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP53072" )
				Else
					MsgStop( "Atualização não realizada.", "UP53072" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cart.Profis.'															, ; //X3_TITULO
	'Cart.Profis.'															, ; //X3_TITSPA
	'Cart.Profis.'															, ; //X3_TITENG
	'Carteira Profissional'													, ; //X3_DESCRIC
	'Carteira Profissional'													, ; //X3_DESCSPA
	'Carteira Profissional'													, ; //X3_DESCENG
	'99999999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Serie Cart.'															, ; //X3_TITULO
	'Serie Cart.'															, ; //X3_TITSPA
	'Serie Cart.'															, ; //X3_TITENG
	'Serie Cart. Profissional'												, ; //X3_DESCRIC
	'Serie Cart. Profissional'												, ; //X3_DESCSPA
	'Serie Cart. Profissional'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP53072" ) ) ) ;
