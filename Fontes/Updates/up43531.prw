...
/*/
//--------------------------------------------------------------------
User Function UP43531( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP43531" )
				Else
					MsgStop( "Atualização não realizada.", "UP43531" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZFM'																	, .T. }, ; //X3_ARQUIVO
	{ '29'																	, .T. }, ; //X3_ORDEM
	{ 'ZFM_AUX01'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Auxiliar 01'															, .T. }, ; //X3_TITULO
	{ 'Auxiliar 01'															, .T. }, ; //X3_TITSPA
	{ 'Auxiliar 01'															, .T. }, ; //X3_TITENG
	{ 'Campo Auxiliar 01'													, .T. }, ; //X3_DESCRIC
	{ 'Campo Auxiliar 01'													, .T. }, ; //X3_DESCSPA
	{ 'Campo Auxiliar 01'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZFM'																	, .T. }, ; //X3_ARQUIVO
	{ '30'																	, .T. }, ; //X3_ORDEM
	{ 'ZFM_AUX02'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Auxiliar 02'															, .T. }, ; //X3_TITULO
	{ 'Auxiliar 02'															, .T. }, ; //X3_TITSPA
	{ 'Auxiliar 02'															, .T. }, ; //X3_TITENG
	{ 'Campo Auxiliar 02'													, .T. }, ; //X3_DESCRIC
	{ 'Campo Auxiliar 02'													, .T. }, ; //X3_DESCSPA
	{ 'Campo Auxiliar 02'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFM'																	, .T. }, ; //X3_ARQUIVO
	{ '31'																	, .T. }, ; //X3_ORDEM
	{ 'ZFM_AUX03'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Auxiliar 03'															, .T. }, ; //X3_TITULO
	{ 'Auxiliar 03'															, .T. }, ; //X3_TITSPA
	{ 'Auxiliar 03'															, .T. }, ; //X3_TITENG
	{ 'Campo Auxiliar 03'													, .T. }, ; //X3_DESCRIC
	{ 'Campo Auxiliar 03'													, .T. }, ; //X3_DESCSPA
	{ 'Campo Auxiliar 03'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFM'																	, .T. }, ; //X3_ARQUIVO
	{ '32'																	, .T. }, ; //X3_ORDEM
	{ 'ZFM_AUX04'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Auxiliar 04'															, .T. }, ; //X3_TITULO
	{ 'Auxiliar 04'															, .T. }, ; //X3_TITSPA
	{ 'Auxiliar 04'															, .T. }, ; //X3_TITENG
	{ 'Campo Auxiliar 04'													, .T. }, ; //X3_DESCRIC
	{ 'Campo Auxiliar 04'													, .T. }, ; //X3_DESCSPA
	{ 'Campo Auxiliar 04'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZFM'																	, .T. }, ; //X3_ARQUIVO
	{ '33'																	, .T. }, ; //X3_ORDEM
	{ 'ZFM_AUX05'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Auxiliar 05'															, .T. }, ; //X3_TITULO
	{ 'Auxiliar 05'															, .T. }, ; //X3_TITSPA
	{ 'Auxiliar 05'															, .T. }, ; //X3_TITENG
	{ 'Campo Auxiliar 05'													, .T. }, ; //X3_DESCRIC
	{ 'Campo Auxiliar 05'													, .T. }, ; //X3_DESCSPA
	{ 'Campo Auxiliar 05'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Campo Auxiliar 01' )

aHlpEng := {}
aAdd( aHlpEng, 'Campo Auxiliar 01' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Campo Auxiliar 01' )

PutSX1Help( "PZFM_AUX01 ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFM_AUX01" )

aHlpPor := {}
aAdd( aHlpPor, 'Campo Auxiliar 02' )

aHlpEng := {}
aAdd( aHlpEng, 'Campo Auxiliar 02' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Campo Auxiliar 02' )

PutSX1Help( "PZFM_AUX02 ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFM_AUX02" )

aHlpPor := {}
aAdd( aHlpPor, 'Campo Auxiliar 03' )

aHlpEng := {}
aAdd( aHlpEng, 'Campo Auxiliar 03' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Campo Auxiliar 03' )

PutSX1Help( "PZFM_AUX03 ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFM_AUX03" )

aHlpPor := {}
aAdd( aHlpPor, 'Campo Auxiliar 04' )

aHlpEng := {}
aAdd( aHlpEng, 'Campo Auxiliar 04' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Campo Auxiliar 04' )

PutSX1Help( "PZFM_AUX04 ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFM_AUX04" )

aHlpPor := {}
aAdd( aHlpPor, 'Campo Auxiliar 05' )

aHlpEng := {}
aAdd( aHlpEng, 'Campo Auxiliar 05' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Campo Auxiliar 05' )

PutSX1Help( "PZFM_AUX05 ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFM_AUX05" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP43531" ) ) ) ;
