...
/*/
//--------------------------------------------------------------------
User Function UPD43865( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD43865" )
				Else
					MsgStop( "Atualização não realizada.", "UPD43865" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Alt Imp Fed'															, ; //X3_TITULO
	'Alt Imp Fed'															, ; //X3_TITSPA
	'Alt Imp Fed'															, ; //X3_TITENG
	'Altera Impostos Federais'												, ; //X3_DESCRIC
	'Altera Impostos Federais'												, ; //X3_DESCSPA
	'Altera Impostos Federais'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Alt Imp Est'															, ; //X3_TITULO
	'Alt Imp Est'															, ; //X3_TITSPA
	'Alt Imp Est'															, ; //X3_TITENG
	'Altera Impostos Estaduais'												, ; //X3_DESCRIC
	'Altera Impostos Estaduais'												, ; //X3_DESCSPA
	'Altera Impostos Estaduais'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'"N"'																	, ; //X3_RELACAO
...
aAdd( aSXA, { ;
	'ZZL'																	, ; //XA_ALIAS
	'2'																		, ; //XA_ORDEM
	'Comercial'																, ; //XA_DESCRIC
	'Comercial'																, ; //XA_DESCSPA
	'Comercial'																, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
aAdd( aSXA, { ;
	'ZZL'																	, ; //XA_ALIAS
	'B'																		, ; //XA_ORDEM
	'Especificos Italac'													, ; //XA_DESCRIC
	'Especificos Italac'													, ; //XA_DESCSPA
	'Especificos Italac'													, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
aAdd( aSXA, { ;
	'ZZL'																	, ; //XA_ALIAS
	'C'																		, ; //XA_ORDEM
	'Gestao de Custos'														, ; //XA_DESCRIC
	'Gestao de Custos'														, ; //XA_DESCSPA
	'Gestao de Custos'														, ; //XA_DESCENG
	''																		, ; //XA_AGRUP
	''																		, ; //XA_TIPO
	'U'																		} ) //XA_PROPRI
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Permite alteração de Impostos Federais' )
aAdd( aHlpPor, 'na rotina de Acertos Fiscais Italac' )

aHlpEng := {}
aAdd( aHlpEng, 'Permite alteração de Impostos Federais' )
aAdd( aHlpEng, 'na rotina de Acertos Fiscais Italac' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Permite alteração de Impostos Federais' )
aAdd( aHlpSpa, 'na rotina de Acertos Fiscais Italac' )

PutSX1Help( "PZZL_AIMPF ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZL_AIMPF" )

aHlpPor := {}
aAdd( aHlpPor, 'Permite alteração de Impostos Estaduais' )
aAdd( aHlpPor, 'na rotina de Acertos Fiscais Italac' )

aHlpEng := {}
aAdd( aHlpEng, 'Permite alteração de Impostos Estaduais' )
aAdd( aHlpEng, 'na rotina de Acertos Fiscais Italac' )

aHlpSpa := {}
aAdd( aHlpSpa, 'Permite alteração de Impostos Estaduais' )
aAdd( aHlpSpa, 'na rotina de Acertos Fiscais Italac' )

PutSX1Help( "PZZL_AIMPE ", aHlpPor, aHlpEng, aHlpSpa, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZZL_AIMPE" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD43865" ) ) ) ;
