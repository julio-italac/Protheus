...
/*/
//--------------------------------------------------------------------
User Function UP23647( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP23647" )
				Else
					MsgStop( "Atualização não Realizada.", "UP23647" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'ZGN'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZGN'+cEmpr																, ; //X2_ARQUIVO
	'PARAM.INVENTARIO BLOCO H EFD'											, ; //X2_NOME
	'PARAM.INVENTARIO BLOCO H EFD'											, ; //X2_NOMESPA
	'PARAM.INVENTARIO BLOCO H EFD'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'ZGN'																	, .F. }, ; //X3_ARQUIVO
	{ '02'																	, .F. }, ; //X3_ORDEM
	{ 'ZGN_CSTICM'															, .F. }, ; //X3_CAMPO
	{ 'C'																	, .F. }, ; //X3_TIPO
	{ 3																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'CST ICMS'															, .F. }, ; //X3_TITULO
	{ 'CST ICMS'															, .F. }, ; //X3_TITSPA
	{ 'CST ICMS'															, .F. }, ; //X3_TITENG
	{ 'Codigo CST ICMS'														, .F. }, ; //X3_DESCRIC
	{ 'Codigo CST ICMS'														, .F. }, ; //X3_DESCSPA
	{ 'Codigo CST ICMS'														, .F. }, ; //X3_DESCENG
	{ '999'																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZGN'																	, .F. }, ; //X3_ARQUIVO
	{ '03'																	, .F. }, ; //X3_ORDEM
	{ 'ZGN_DTFECH'															, .F. }, ; //X3_CAMPO
	{ 'D'																	, .F. }, ; //X3_TIPO
	{ 8																		, .F. }, ; //X3_TAMANHO
	{ 0																		, .F. }, ; //X3_DECIMAL
	{ 'Dt.Fechament'														, .F. }, ; //X3_TITULO
	{ 'Dt.Fechament'														, .F. }, ; //X3_TITSPA
	{ 'Dt.Fechament'														, .F. }, ; //X3_TITENG
	{ 'Data de fechamento'													, .F. }, ; //X3_DESCRIC
	{ 'Data de fechamento'													, .F. }, ; //X3_DESCSPA
	{ 'Data de fechamento'													, .F. }, ; //X3_DESCENG
	{ ''																	, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'ZGN'																	, .F. }, ; //X3_ARQUIVO
	{ '04'																	, .F. }, ; //X3_ORDEM
	{ 'ZGN_ALIQUO'															, .F. }, ; //X3_CAMPO
	{ 'N'																	, .F. }, ; //X3_TIPO
	{ 18																	, .F. }, ; //X3_TAMANHO
	{ 6																		, .F. }, ; //X3_DECIMAL
	{ 'Aliquota ICM'														, .F. }, ; //X3_TITULO
	{ 'Aliquota ICM'														, .F. }, ; //X3_TITSPA
	{ 'Aliquota ICM'														, .F. }, ; //X3_TITENG
	{ 'Aliquota ICMS'														, .F. }, ; //X3_DESCRIC
	{ 'Aliquota ICMS'														, .F. }, ; //X3_DESCSPA
	{ 'Aliquota ICMS'														, .F. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.999999'											, .F. }, ; //X3_PICTURE
	{ ''																	, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .F. }, ; //X3_USADO
...
aAdd( aSIX, { ;
	'ZGN'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZGN_FILIAL+DTOS(ZGN_DTFECH)'											, ; //CHAVE
	'Data Fechamento.'														, ; //DESCRICAO
	'Data Fechamento.'														, ; //DESCSPA
	'Data Fechamento.'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP23647" ) ) ) ;
