...
/*/
//--------------------------------------------------------------------
User Function UP39908( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP39908" )
				Else
					MsgStop( "Atualização não Realizada.", "UP39908" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Frete FOB?'															, ; //X3_TITSPA
	'Frete FOB?'															, ; //X3_TITENG
	'Frete FOB?'															, ; //X3_DESCRIC
	'Frete FOB?'															, ; //X3_DESCSPA
	'Frete FOB?'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP39908" ) ) ) ;
