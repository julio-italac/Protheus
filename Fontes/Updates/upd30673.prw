...
/*/
//--------------------------------------------------------------------
User Function UPD30673( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD30673" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD30673" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Nivel 5'																, .T. }, ; //X3_TITSPA
	{ 'Nivel 5'																, .T. }, ; //X3_TITENG
	{ 'Nivel 5'																, .T. }, ; //X3_DESCRIC
	{ 'Nivel 5'																, .T. }, ; //X3_DESCSPA
	{ 'Nivel 5'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'VAZIO() .OR. EXISTCPO("ZA0")'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ "IF(M->B1_TIPO $ 'PA/EM',.T.,.F.) .AND. U_AEST007()"					, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ '1'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'B1_I_DESN5'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Desc Nivel 5'														, .T. }, ; //X3_TITULO
	{ 'Desc Nivel 5'														, .T. }, ; //X3_TITSPA
	{ 'Desc Nivel 5'														, .T. }, ; //X3_TITENG
	{ 'Desc Nivel 5'														, .T. }, ; //X3_DESCRIC
	{ 'Desc Nivel 5'														, .T. }, ; //X3_DESCSPA
	{ 'Desc Nivel 5'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'U_ACOM014(13)'														, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Nivel 5'															, .T. }, ; //X3_TITULO
	{ 'Cod Nivel 5'															, .T. }, ; //X3_TITSPA
	{ 'Cod Nivel 5'															, .T. }, ; //X3_TITENG
	{ 'Cod Nivel 5'															, .T. }, ; //X3_DESCRIC
	{ 'Cod Nivel 5'															, .T. }, ; //X3_DESCSPA
	{ 'Cod Nivel 5'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(176)					, .T. }, ; //X3_USADO
	{ 'GETSXENUM("ZA0","ZA0_COD")'											, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX7, { ;
	'B1_I_NIV5'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'Posicione("ZA0",1,xFilial("ZA0")+M->B1_I_NIV5,"ZA0_DESCRI")'			, ; //X7_REGRA
	'B1_I_DESN5'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Nivel 5 de Produto'													, ; //XB_DESCRI
	'Nivel 5 de Produto'													, ; //XB_DESCSPA
	'Nivel 5 de Produto'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZA0'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD30673" ) ) ) ;
