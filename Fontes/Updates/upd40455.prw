...
/*/
//--------------------------------------------------------------------
User Function UPD40455( cEmpAmb, cFilAmb ) 
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD40455" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD40455" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZZ'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_CUSER'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Canh. User'															, .T. }, ; //X3_TITULO
	{ 'Canh. User'															, .T. }, ; //X3_TITSPA
	{ 'Canh. User'															, .T. }, ; //X3_TITENG
	{ 'Aprovador do Canhoto'												, .T. }, ; //X3_DESCRIC
	{ 'Aprovador do Canhoto'												, .T. }, ; //X3_DESCSPA
	{ 'Aprovador do Canhoto'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZZ'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_CDATA'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Canh. Data'															, .T. }, ; //X3_TITULO
	{ 'Canh. Data'															, .T. }, ; //X3_TITSPA
	{ 'Canh. Data'															, .T. }, ; //X3_TITENG
	{ 'Data da aprovacao do Canh'											, .T. }, ; //X3_DESCRIC
	{ 'Data da aprovacao do Canh'											, .T. }, ; //X3_DESCSPA
	{ 'Data da aprovacao do Canh'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZZ'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_CHORA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Canh. Hora'															, .T. }, ; //X3_TITULO
	{ 'Canh. Hora'															, .T. }, ; //X3_TITSPA
	{ 'Canh. Hora'															, .T. }, ; //X3_TITENG
	{ 'Hora da aprovacao do Canh'											, .T. }, ; //X3_DESCRIC
	{ 'Hora da aprovacao do Canh'											, .T. }, ; //X3_DESCSPA
	{ 'Hora da aprovacao do Canh'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SF2'																	, .T. }, ; //X3_ARQUIVO
	{ 'ZZ'																	, .T. }, ; //X3_ORDEM
	{ 'F2_I_CORIG'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Canh. Origem'														, .T. }, ; //X3_TITULO
	{ 'Canh. Origem'														, .T. }, ; //X3_TITSPA
	{ 'Canh. Origem'														, .T. }, ; //X3_TITENG
	{ 'Origem da aprovacao do Ca'											, .T. }, ; //X3_DESCRIC
	{ 'Origem da aprovacao do Ca'											, .T. }, ; //X3_DESCSPA
	{ 'Origem da aprovacao do Ca'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD40455" ) ) ) ;
