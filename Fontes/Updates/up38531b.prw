...
/*/
//--------------------------------------------------------------------
User Function UP38531B( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP38531B" )
				Else
					MsgStop( "Atualização não Realizada.", "UP38531B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Envia para Cia do Leite' )

PutSX1Help( "PZLJ_I_ENVC", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZLJ_I_ENVC" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP38531B" ) ) ) ;
