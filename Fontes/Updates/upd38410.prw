...
/*/
//--------------------------------------------------------------------
User Function UPD38410( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD38410" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD38410" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'Z16'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'Z16_ULTNOM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Ult.Usr'														, .T. }, ; //X3_TITULO
	{ 'Nome Ult.Usr'														, .T. }, ; //X3_TITSPA
	{ 'Nome Ult.Usr'														, .T. }, ; //X3_TITENG
	{ 'Nome Ultimo Usuario'													, .T. }, ; //X3_DESCRIC
	{ 'Nome Ultimo Usuario'													, .T. }, ; //X3_DESCSPA
	{ 'Nome Ultimo Usuario'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'Z16'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'Z16_PENOME'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Pen.Usr'														, .T. }, ; //X3_TITULO
	{ 'Nome Pen.Usr'														, .T. }, ; //X3_TITSPA
	{ 'Nome Pen.Usr'														, .T. }, ; //X3_TITENG
	{ 'Nome Penultimo Usuario'												, .T. }, ; //X3_DESCRIC
	{ 'Nome Penultimo Usuario'												, .T. }, ; //X3_DESCSPA
	{ 'Nome Penultimo Usuario'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z16'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'Z16_PONTO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 200																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ponto Exec.'															, .T. }, ; //X3_TITULO
	{ 'Ponto Exec.'															, .T. }, ; //X3_TITSPA
	{ 'Ponto Exec.'															, .T. }, ; //X3_TITENG
	{ 'Ponto de Execucao'													, .T. }, ; //X3_DESCRIC
	{ 'Ponto de Execucao'													, .T. }, ; //X3_DESCSPA
	{ 'Ponto de Execucao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD38410" ) ) ) ;
