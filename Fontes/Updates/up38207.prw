...
/*/
//--------------------------------------------------------------------
User Function UP38207( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP38207" )
				Else
					MsgStop( "Atualização não Realizada.", "UP38207" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Coordenador'													, ; //XB_DESCRI
	'Lista de Coordenador'													, ; //XB_DESCSPA
	'Lista de Coordenador'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SA3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Gerente'														, ; //XB_DESCRI
	'Lista de Gerente'														, ; //XB_DESCSPA
	'Lista de Gerente'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SA3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Supervisor'													, ; //XB_DESCRI
	'Lista de Supervisor'													, ; //XB_DESCSPA
	'Lista de Supervisor'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SA3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Lista de Vendedor'														, ; //XB_DESCRI
	'Lista de Vendedor'														, ; //XB_DESCSPA
	'Lista de Vendedor'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SA3'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP38207" ) ) ) ;
