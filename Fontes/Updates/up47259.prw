...
/*/
//--------------------------------------------------------------------
User Function UP47259( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP47259" )
				Else
					MsgStop( "Atualização não Realizada.", "UP47259" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZEL'																	, .T. }, ; //X3_ARQUIVO
	{ '15'																	, .T. }, ; //X3_ORDEM
	{ 'ZEL_IPANTE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'IP Antenas'															, .T. }, ; //X3_TITULO
	{ 'IP Antenas'															, .T. }, ; //X3_TITSPA
	{ 'IP Antenas'															, .T. }, ; //X3_TITENG
	{ 'Endereco IP das Antenas'												, .T. }, ; //X3_DESCRIC
	{ 'Endereco IP das Antenas'												, .T. }, ; //X3_DESCSPA
	{ 'Endereco IP das Antenas'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZEL'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'ZEL_FAIXAI'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr.Inc.Pager'														, .T. }, ; //X3_TITULO
	{ 'Nr.Inc.Pager'														, .T. }, ; //X3_TITSPA
	{ 'Nr.Inc.Pager'														, .T. }, ; //X3_TITENG
	{ 'Faixa Inicial Nr.Pager'												, .T. }, ; //X3_DESCRIC
	{ 'Faixa Inicial Nr.Pager'												, .T. }, ; //X3_DESCSPA
	{ 'Faixa Inicial Nr.Pager'												, .T. }, ; //X3_DESCENG
	{ '9999'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZEL'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZEL_FAIXAF'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr.Fin.Pager'														, .T. }, ; //X3_TITULO
	{ 'Nr.Fin.Pager'														, .T. }, ; //X3_TITSPA
	{ 'Nr.Fin.Pager'														, .T. }, ; //X3_TITENG
	{ 'Faixa Final Nr.Pager'												, .T. }, ; //X3_DESCRIC
	{ 'Faixa Final Nr.Pager'												, .T. }, ; //X3_DESCSPA
	{ 'Faixa Final Nr.Pager'												, .T. }, ; //X3_DESCENG
	{ '9999'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Endereço IP das Antenas' )

PutSX1Help( "PZEL_IPANTE", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZEL_IPANTE" )

aHlpPor := {}
aAdd( aHlpPor, 'Faixa Inicial Nr.Pager' )

PutSX1Help( "PZEL_FAIXAI", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZEL_FAIXAI" )

aHlpPor := {}
aAdd( aHlpPor, 'Faixa Final Nr.Pager' )

PutSX1Help( "PZEL_FAIXAF", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZEL_FAIXAF" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP47259" ) ) ) ;
