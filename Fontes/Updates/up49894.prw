...
/*/
//--------------------------------------------------------------------
User Function UP49894( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP49894" )
				Else
					MsgStop( "Atualização não realizada.", "UP49894" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Valor Rateio Vale Pededag'											, .T. }, ; //X3_DESCRIC
	{ 'Valor Rateio Vale Pededag'											, .T. }, ; //X3_DESCSPA
	{ 'Valor Rateio Vale Pededag'											, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'DAI'																	, .T. }, ; //X3_ARQUIVO
	{ '46'																	, .T. }, ; //X3_ORDEM
	{ 'DAI_I_FROL'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 16																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Frete 2o Per'														, .T. }, ; //X3_TITULO
	{ 'Frete 2o Per'														, .T. }, ; //X3_TITSPA
	{ 'Frete 2o Per'														, .T. }, ; //X3_TITENG
	{ 'Valor Frete 2o percurso'												, .T. }, ; //X3_DESCRIC
	{ 'Valor Frete 2o percurso'												, .T. }, ; //X3_DESCSPA
	{ 'Valor Frete 2o percurso'												, .T. }, ; //X3_DESCENG
	{ '@E 9,999,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'FA'																	, .T. }, ; //X3_ORDEM
	{ 'D2_I_VLPED'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Pedagio'															, .T. }, ; //X3_TITULO
	{ ''																	, .T. }, ; //X3_TITSPA
	{ ''																	, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'FC'																	, .T. }, ; //X3_ORDEM
	{ 'D2_I_VLCHE'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Chep'															, .T. }, ; //X3_TITULO
	{ ''																	, .T. }, ; //X3_TITSPA
	{ ''																	, .T. }, ; //X3_TITENG
	{ 'Valor do CHEP'														, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SD2'																	, .T. }, ; //X3_ARQUIVO
	{ 'FD'																	, .T. }, ; //X3_ORDEM
	{ 'D2_I_FREOL'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vlr Frete OL'														, .T. }, ; //X3_TITULO
	{ ''																	, .T. }, ; //X3_TITSPA
	{ ''																	, .T. }, ; //X3_TITENG
	{ 'Valor do Frete OL'													, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ '@E 999,999,999.99'													, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP49894" ) ) ) ;
