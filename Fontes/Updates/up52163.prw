...
/*/
//--------------------------------------------------------------------
User Function UP52163( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP52163" )
				Else
					MsgStop( "Atualização não realizada.", "UP52163" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '38'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_DOTIF'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data OTIF'															, .T. }, ; //X3_TITULO
	{ 'Data OTIF'															, .T. }, ; //X3_TITSPA
	{ 'Data OTIF'															, .T. }, ; //X3_TITENG
	{ 'Data OTIF'															, .T. }, ; //X3_DESCRIC
	{ 'Data OTIF'															, .T. }, ; //X3_DESCSPA
	{ 'Data OTIF'															, .T. }, ; //X3_DESCENG
	{ '@D'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'ZEL'																	, .T. }, ; //X3_ARQUIVO
	{ '22'																	, .T. }, ; //X3_ORDEM
	{ 'ZEL_TMPOPE'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Temp.Operac.'														, .T. }, ; //X3_TITULO
	{ 'Temp.Operac.'														, .T. }, ; //X3_TITSPA
	{ 'Temp.Operac.'														, .T. }, ; //X3_TITENG
	{ 'Tempo operacional/contrat'											, .T. }, ; //X3_DESCRIC
	{ 'Tempo operacional/contrat'											, .T. }, ; //X3_DESCSPA
	{ 'Tempo operacional/contrat'											, .T. }, ; //X3_DESCENG
	{ '@E 99'																, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'ZEL'																	, .T. }, ; //X3_ARQUIVO
	{ '23'																	, .T. }, ; //X3_ORDEM
	{ 'ZEL_HORCOR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hora Corte'															, .T. }, ; //X3_TITULO
	{ 'Hora Corte'															, .T. }, ; //X3_TITSPA
	{ 'Hora Corte'															, .T. }, ; //X3_TITENG
	{ 'Horário de corte'													, .T. }, ; //X3_DESCRIC
	{ 'Horário de corte'													, .T. }, ; //X3_DESCSPA
	{ 'Horário de corte'													, .T. }, ; //X3_DESCENG
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP52163" ) ) ) ;
