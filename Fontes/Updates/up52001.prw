...
/*/
//--------------------------------------------------------------------
User Function UP52001( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP52001" )
				Else
					MsgStop( "Atualização não realizada.", "UP52001" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'Z41'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'Z41'+cEmpr																, ; //X2_ARQUIVO
	'Memoria Calculo Premissas'												, ; //X2_NOME
	'Memoria Calculo Premissas'												, ; //X2_NOMESPA
	'Memoria Calculo Premissas'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Tipo do registro'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo do registro'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo do registro'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Premissa'														, .T. }, ; //X3_TITULO
	{ 'Cod Premissa'														, .T. }, ; //X3_TITSPA
	{ 'Cod Premissa'														, .T. }, ; //X3_TITENG
	{ 'Codigo da premissa'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo da premissa'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo da premissa'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_TPCALC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tp Calculo'															, .T. }, ; //X3_TITULO
	{ 'Tp Calculo'															, .T. }, ; //X3_TITSPA
	{ 'Tp Calculo'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_GRCLI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Seg Cliente'															, .T. }, ; //X3_TITULO
	{ 'Seg Cliente'															, .T. }, ; //X3_TITSPA
	{ 'Seg Cliente'															, .T. }, ; //X3_TITENG
	{ 'Seguimento Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Seguimento Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Seguimento Cliente'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_GRPVEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Rede'															, .T. }, ; //X3_TITULO
	{ 'Cod Rede'															, .T. }, ; //X3_TITSPA
	{ 'Cod Rede'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Loja'															, .T. }, ; //X3_TITULO
	{ 'Cod Loja'															, .T. }, ; //X3_TITSPA
	{ 'Cod Loja'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_FAT_A'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 3																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd Fat Alfa'														, .T. }, ; //X3_TITULO
	{ 'Qtd Fat Alfa'														, .T. }, ; //X3_TITSPA
	{ 'Qtd Fat Alfa'														, .T. }, ; //X3_TITENG
	{ 'Quantidade faturada Alfa'											, .T. }, ; //X3_DESCRIC
	{ 'Quantidade faturada Alfa'											, .T. }, ; //X3_DESCSPA
	{ 'Quantidade faturada Alfa'											, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_FAT_B'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 12																	, .T. }, ; //X3_TAMANHO
	{ 3																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd Fat Beta'														, .T. }, ; //X3_TITULO
	{ 'Qtd Fat Beta'														, .T. }, ; //X3_TITSPA
	{ 'Qtd Fat Beta'														, .T. }, ; //X3_TITENG
	{ 'Quantidade faturada Beta'											, .T. }, ; //X3_DESCRIC
	{ 'Quantidade faturada Beta'											, .T. }, ; //X3_DESCSPA
	{ 'Quantidade faturada Beta'											, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999.999'													, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z41'																	, .T. }, ; //X3_ARQUIVO
	{ '20'																	, .T. }, ; //X3_ORDEM
	{ 'Z41_ATING'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 9																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Percent Beta'														, .T. }, ; //X3_TITULO
	{ 'Percent Beta'														, .T. }, ; //X3_TITSPA
	{ 'Percent Beta'														, .T. }, ; //X3_TITENG
	{ 'Percentual Beta'														, .T. }, ; //X3_DESCRIC
	{ 'Percentual Beta'														, .T. }, ; //X3_DESCSPA
	{ 'Percentual Beta'														, .T. }, ; //X3_DESCENG
...
aAdd( aSIX, { ;
	'Z41'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z41_FILIAL+Z41_PERIOD+Z41_COD'											, ; //CHAVE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP52001" ) ) ) ;
