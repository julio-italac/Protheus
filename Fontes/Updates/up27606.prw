...
/*/
//--------------------------------------------------------------------
User Function UP27606( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP27606" )
				Else
					MsgStop( "Atualização não Realizada.", "UP27606" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'TES'															        , .T. }, ; //X3_TITSPA
	{ 'TES'														            , .T. }, ; //X3_TITENG
	{ 'Tipo de Entrada e Saida NF'											, .T. }, ; //X3_DESCRIC
	{ 'Tipo Entrada e Salida Factura'										, .T. }, ; //X3_DESCSPA
	{ 'Inv inflow and outflow Type'											, .T. }, ; //X3_DESCENG
	{ '@9'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Cód. Fiscal'															, .T. }, ; //X3_TITSPA
	{ 'Fiscal Code'															, .T. }, ; //X3_TITENG
	{ 'Codigo Fiscal da Operacao'											, .T. }, ; //X3_DESCRIC
	{ 'Cód Fiscal de operación'												, .T. }, ; //X3_DESCSPA
	{ 'Oper Fiscal Code'													, .T. }, ; //X3_DESCENG
	{ '@9'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SM4'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'M4_I_CLIEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cliente/For'															, .T. }, ; //X3_TITULO
	{ 'Cliente/For'															, .T. }, ; //X3_TITSPA
	{ 'Cliente/For'															, .T. }, ; //X3_TITENG
	{ 'Codigo do Cliente/Forn.'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo del cliente/Forn.'											, .T. }, ; //X3_DESCSPA
	{ 'Customer´s Code/Forn.'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SM4'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'M4_I_CLOJA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja Cli/For'														, .T. }, ; //X3_TITULO
	{ 'Tienda Cli/F'														, .T. }, ; //X3_TITSPA
	{ 'Unit Cli/For'														, .T. }, ; //X3_TITENG
	{ 'Loja do Cliente/For.'												, .T. }, ; //X3_DESCRIC
...
aAdd( aSX3, { ;
	...
	{ 'Estado'																, .T. }, ; //X3_TITSPA
	{ 'State'																, .T. }, ; //X3_TITENG
	{ 'Estado Destino Material'												, .T. }, ; //X3_DESCRIC
	{ 'Estado Destino Mercaderia'											, .T. }, ; //X3_DESCSPA
	{ 'Destination State Goods'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SM4'																	, .T. }, ; //X3_ARQUIVO
	{ '15'																	, .T. }, ; //X3_ORDEM
	{ 'M4_I_DUPL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Gera Dupl.'															, .T. }, ; //X3_TITULO
	{ 'Gen. Titulo'															, .T. }, ; //X3_TITSPA
	{ 'Gener.Tr.Nt?'														, .T. }, ; //X3_TITENG
	{ 'S - para gerar duplicata'											, .T. }, ; //X3_DESCRIC
	{ 'S: para Generar Titulo'												, .T. }, ; //X3_DESCSPA
	{ 'S- to generate Trade Note'											, .T. }, ; //X3_DESCENG
	{ '!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SM4'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'M4_I_DOCMS'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Objetivo Msg'														, .T. }, ; //X3_TITULO
	{ 'Objetivo Msg'														, .T. }, ; //X3_TITSPA
	{ 'Objetivo Msg'														, .T. }, ; //X3_TITENG
	{ 'Objetivo da Mensagem'												, .T. }, ; //X3_DESCRIC
	{ 'Objetivo da Mensagem'												, .T. }, ; //X3_DESCSPA
	{ 'Objetivo da Mensagem'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SM4'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'M4_FILIAL+M4_I_CLIEN'													, ; //CHAVE
	'Codigo Cliente'														, ; //DESCRICAO
	'Codigo Cliente'														, ; //DESCSPA
	'Codigo Cliente'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'CLIENTE'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SM4'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'M4_FILIAL+M4_I_CLIEN+M4_I_CLOJA'										, ; //CHAVE
	'Cliente e Loja'														, ; //DESCRICAO
	'Cliente e Loja'														, ; //DESCSPA
	'Cliente e Loja'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'CLIENLOJA'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SM4'																	, ; //INDICE
	'5'																		, ; //ORDEM
	'M4_FILIAL+M4_I_TES+M4_I_CF'											, ; //CHAVE
	'TES + Codigo Fiscal'													, ; //DESCRICAO
	'TES + Codigo Fiscal'													, ; //DESCSPA
	'TES + Codigo Fiscal'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'TESCF'																	, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SM4'																	, ; //INDICE
	'7'																		, ; //ORDEM
	'M4_FILIAL+M4_I_CLIEN+M4_I_EST'											, ; //CHAVE
	'Cliente + estado'														, ; //DESCRICAO
	'Cliente + estado'														, ; //DESCSPA
	'Cliente + estado'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'CLIENEST'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SM4'																	, ; //INDICE
	'8'																		, ; //ORDEM
	'M4_FILIAL+M4_I_DUPL'													, ; //CHAVE
	'Gera Duplicata?'														, ; //DESCRICAO
	'Gera Duplicata?'														, ; //DESCSPA
	'Gera Duplicata?'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'GERADUPL'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Cadastro de TES'														, ; //XB_DESCRI
	'Cadastro de TES'														, ; //XB_DESCSPA
	'Cadastro de TES'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SF4'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Codigo Fiscal'															, ; //XB_DESCRI
	'Codigo Fiscal'															, ; //XB_DESCSPA
	'Codigo Fiscal'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SX5'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Clientes/Fornecedor'													, ; //XB_DESCRI
	'Clientes/Fornecedor'													, ; //XB_DESCSPA
	'Clientes/Fornecedor'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SA1'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'RE'																	, ; //XB_COLUNA
	'Estado (UF)'															, ; //XB_DESCRI
	'Estado (UF)'															, ; //XB_DESCSPA
	'Estado (UF)'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SX5'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP27606" ) ) ) ;
