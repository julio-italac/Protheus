...
/*/
//--------------------------------------------------------------------
User Function UP42158( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP42158" )
				Else
					MsgStop( "Atualização não Realizada.", "UP42158" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'ESTADO'																, ; //X3_TITSPA
	'ESTADO'																, ; //X3_TITENG
	'Estado do Cliente'														, ; //X3_DESCRIC
	'Estado do Cliente'														, ; //X3_DESCSPA
	'Estado do Cliente'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'IIF(EMPTY(M->ZX_SITST) .OR. EMPTY(M->ZX_EST),.T.,.F.)'					, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP42158" ) ) ) ;
