...
/*/
//--------------------------------------------------------------------
User Function UP31089A( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP31089A" )
				Else
					MsgStop( "Atualização não Realizada.", "UP31089A" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Reposicao entre Filiais;2=Operador Logistico;3=Reposicao entre Armazens', .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Emiss. Dias?'														, .T. }, ; //X3_TITULO
	{ 'Emiss. Dias?'														, .T. }, ; //X3_TITSPA
	{ 'Emiss. Dias?'														, .T. }, ; //X3_TITENG
	{ 'Emiss. Dias?'														, .T. }, ; //X3_DESCRIC
	{ 'Emiss. Dias?'														, .T. }, ; //X3_DESCSPA
	{ 'Emiss. Dias?'														, .T. }, ; //X3_DESCENG
	{ '999'																	, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ '30'																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z19'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'Z19_OPERAD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod. OP.Log.'														, .T. }, ; //X3_TITULO
	{ 'Cod. OP.Log.'														, .T. }, ; //X3_TITSPA
	{ 'Cod. OP.Log.'														, .T. }, ; //X3_TITENG
	{ 'Codigo Operador Logistico'											, .T. }, ; //X3_DESCRIC
	{ 'Codigo Operador Logistico'											, .T. }, ; //X3_DESCSPA
	{ 'Codigo Operador Logistico'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "ExistCpo('SA2')"														, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ 'SA2'																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'Z19'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'Z19_OPELOJ'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja OP.Log.'														, .T. }, ; //X3_TITULO
	{ 'Loja OP.Log.'														, .T. }, ; //X3_TITSPA
	{ 'Loja OP.Log.'														, .T. }, ; //X3_TITENG
	{ 'Loja Operador Logistico'												, .T. }, ; //X3_DESCRIC
	{ 'Loja Operador Logistico'												, .T. }, ; //X3_DESCSPA
	{ 'Loja Operador Logistico'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'IF(Empty(M->Z19_OPERAD),.T.,ExistCpo("SA2",M->Z19_OPERAD+M->Z19_OPELOJ))', .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'Z19'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'Z19_OPEDES'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 70																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome+Cidade'															, .T. }, ; //X3_TITULO
	{ 'Nome+Cidade'															, .T. }, ; //X3_TITSPA
	{ 'Nome+Cidade'															, .T. }, ; //X3_TITENG
	{ 'Nome + Cidade'														, .T. }, ; //X3_DESCRIC
	{ 'Nome + Cidade'														, .T. }, ; //X3_DESCSPA
	{ 'Nome + Cidade'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'ALLTRIM(POSICIONE("SA2",1,XFILIAL("SA2")+Z19->Z19_OPERAD+Z19->Z19_OPELOJ,"A2_NREDUZ"))+" / "+SA2->A2_MUN', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SA2",1,XFILIAL("SA2")+Z19->Z19_OPERAD+Z19->Z19_OPELOJ,"A2_NREDUZ")', .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'Z20'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'Z20_ESTIDE'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Estoq ideal'															, .T. }, ; //X3_TITULO
	{ 'Estoq ideal'															, .T. }, ; //X3_TITSPA
	{ 'Estoq ideal'															, .T. }, ; //X3_TITENG
	{ 'Estoque ideal'														, .T. }, ; //X3_DESCRIC
	{ 'Estoque ideal'														, .T. }, ; //X3_DESCSPA
	{ 'Estoque ideal'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'Z20'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'Z20_MINREP'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Minimo repos'														, .T. }, ; //X3_TITULO
	{ 'Minimo repos'														, .T. }, ; //X3_TITSPA
	{ 'Minimo repos'														, .T. }, ; //X3_TITENG
	{ 'Estoque minimo reposicao'											, .T. }, ; //X3_DESCRIC
	{ 'Estoque minimo reposicao'											, .T. }, ; //X3_DESCSPA
	{ 'Estoque minimo reposicao'											, .T. }, ; //X3_DESCENG
	{ '@E 999,999.99'														, .T. }, ; //X3_PICTURE
	{ 'Positivo()'															, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z20'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'Z20_PODER3'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Poder 3o?'															, .T. }, ; //X3_TITULO
	{ 'Poder 3o?'															, .T. }, ; //X3_TITSPA
	{ 'Poder 3o?'															, .T. }, ; //X3_TITENG
	{ 'Estoque Poder 3o?'													, .T. }, ; //X3_DESCRIC
	{ 'Estoque Poder 3o?'													, .T. }, ; //X3_DESCSPA
	{ 'Estoque Poder 3o?'													, .T. }, ; //X3_DESCENG
	{ '9'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ "'2'"																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z20'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'Z20_FORN3O'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod. Forn.3o'														, .T. }, ; //X3_TITULO
	{ 'Cod. Forn.3o'														, .T. }, ; //X3_TITSPA
	{ 'Cod. Forn.3o'														, .T. }, ; //X3_TITENG
	{ 'Codigo Forneceor Poder 3o'											, .T. }, ; //X3_DESCRIC
	{ 'Codigo Forneceor Poder 3o'											, .T. }, ; //X3_DESCSPA
	{ 'Codigo Forneceor Poder 3o'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ "ExistCpo('SA2')"														, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z20'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'Z20_FO3OLJ'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja Forn.3o'														, .T. }, ; //X3_TITULO
	{ 'Loja Forn.3o'														, .T. }, ; //X3_TITSPA
	{ 'Loja Forn.3o'														, .T. }, ; //X3_TITENG
	{ 'Loja Forneceor Poder 3o'												, .T. }, ; //X3_DESCRIC
	{ 'Loja Forneceor Poder 3o'												, .T. }, ; //X3_DESCSPA
	{ 'Loja Forneceor Poder 3o'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'IF(Empty(M->Z20_FORN3O),.T.,ExistCpo("SA2",M->Z20_FORN3O+M->Z20_FO3OLJ))', .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'ALLTRIM(POSICIONE("SA2",1,XFILIAL("SA2")+Z20->Z20_FORN3O+Z20->Z20_FO3OLJ,"A2_NREDUZ"))+" / "+SA2->A2_MUN', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SA2",1,XFILIAL("SA2")+Z20->Z20_FORN3O+Z20->Z20_FO3OLJ,"A2_NREDUZ")', .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX7, { ;
	'Z19_OPERAD'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ALLTRIM(POSICIONE("SA2",1,XFILIAL("SA2")+M->Z19_OPERAD+M->Z19_OPELOJ,"A2_NREDUZ"))+" / "+SA2->A2_MUN', ; //X7_REGRA
	'Z19_OPEDES'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'Z20_FORN3O'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ALLTRIM(POSICIONE("SA2",1,XFILIAL("SA2")+M->Z20_FORN3O+M->Z20_FO3OLJ,"A2_NREDUZ"))+" / "+SA2->A2_MUN', ; //X7_REGRA
	'Z20_FORDES'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP31089A" ) ) ) ;
