...
/*/
//--------------------------------------------------------------------
User Function UP42331C( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP42331C" )
				Else
					MsgStop( "Atualização não Realizada.", "UP42331C" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'ID Origem'																, ; //X3_TITSPA
	'ID Origem'																, ; //X3_TITENG
	'ID Origem'																, ; //X3_DESCRIC
	'ID Origem'																, ; //X3_DESCSPA
	'ID Origem'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP42331C" ) ) ) ;
