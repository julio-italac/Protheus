...
/*/
//--------------------------------------------------------------------
User Function UP46400( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP46400" )
				Else
					MsgStop( "Atualização não realizada.", "UP46400" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Status Emissao'														, .T. }, ; //X3_DESCRIC
	{ 'Status Emissao'														, .T. }, ; //X3_DESCSPA
	{ 'Status Emissao'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Ato da Entrega;2=Pos Venda;3=Transferencia;4=Pallet;5=Vazio'		, .T. }, ; //X3_CBOX
	{ '1=Ato da Entrega;2=Pos Venda;3=Transferencia;4=Pallet;5=Vazio'		, .T. }, ; //X3_CBOXSPA
	{ '1=Ato da Entrega;2=Pos Venda;3=Transferencia;4=Pallet;5=Vazio'		, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	{ 'Status Situacao'														, .T. }, ; //X3_DESCRIC
	{ 'Status Situacao'														, .T. }, ; //X3_DESCSPA
	{ 'Status Situacao'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ ''																	, .T. }, ; //X3_VLDUSER
	{ '1=Canhoto Cobrado;2=Canhoto Recebido;3=Solicitado Recusa;4=Check List;5=Com Fiscal;6=Com Logistica;7=Com Comercial;8=Com Estoque', .T. }, ; //X3_CBOX
	{ '1=Canhoto Cobrado;2=Canhoto Recebido;3=Solicitado Recusa;4=Check List;5=Com Fiscal;6=Com Logistica;7=Com Comercial;8=Com Estoque', .T. }, ; //X3_CBOXSPA
	{ '1=Canhoto Cobrado;2=Canhoto Recebido;3=Solicitado Recusa;4=Check List;5=Com Fiscal;6=Com Logistica;7=Com Comercial;8=Com Estoque', .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ ''																	, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	{ 'ZF5'																	, .T. }, ; //X3_ARQUIVO
	{ '9K'																	, .T. }, ; //X3_ORDEM
	{ 'ZF5_OBSCOM'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Obs Logistic'														, .T. }, ; //X3_TITULO
	{ 'Obs Logistic'														, .T. }, ; //X3_TITSPA
	{ 'Obs Logistic'														, .T. }, ; //X3_TITENG
	{ 'Obs Logistica'														, .T. }, ; //X3_DESCRIC
	{ 'Obs Logistica'														, .T. }, ; //X3_DESCSPA
	{ 'Obs Logistica'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP46400" ) ) ) ;
