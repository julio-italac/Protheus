...
/*/
//--------------------------------------------------------------------
User Function UPD53028( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UPD53028" )
				Else
					MsgStop( "Atualização não realizada.", "UPD53028" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Stat Situaca'															, ; //X3_TITULO
	'Stat Situaca'															, ; //X3_TITSPA
	'Stat Situaca'															, ; //X3_TITENG
	'Stat Situacao'															, ; //X3_DESCRIC
	'Stat Situacao'															, ; //X3_DESCSPA
	'Stat Situacao'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Canhoto Cobrado;2=Canhoto Recebido;3=Solicitado Recusa;4=Operador;5=Fiscal;6=Transportador;7=Comercial;8=Fabrica;9=Oper.Triang', ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD53028" ) ) ) ;
