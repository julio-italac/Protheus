...
/*/
//--------------------------------------------------------------------
User Function UPD27267( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD27267" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD27267" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SE1'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'E1_I_DTPRO'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dt Prorrogac'														, .T. }, ; //X3_TITULO
	{ 'Dt Prorrogac'														, .T. }, ; //X3_TITSPA
	{ 'Dt Prorrogac'														, .T. }, ; //X3_TITENG
	{ 'Data Prorrogacao'													, .T. }, ; //X3_DESCRIC
	{ 'Data Prorrogacao'													, .T. }, ; //X3_DESCSPA
	{ 'Data Prorrogacao'													, .T. }, ; //X3_DESCENG
	{ '@D'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD27267" ) ) ) ;
