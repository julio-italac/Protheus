...
/*/
//--------------------------------------------------------------------
User Function UPD30288( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD30288" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD30288" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'M0'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_CLITN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cli TrocaNF'															, .T. }, ; //X3_TITULO
	{ 'Cli TrocaNF'															, .T. }, ; //X3_TITSPA
	{ 'Cli TrocaNF'															, .T. }, ; //X3_TITENG
	{ 'Codigo do Cliente Troca N'											, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Cliente Troca N'											, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Cliente Troca N'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'M0'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_LOJTN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loj TrocaNF'															, .T. }, ; //X3_TITULO
	{ 'Loj TrocaNF'															, .T. }, ; //X3_TITSPA
	{ 'Loj TrocaNF'															, .T. }, ; //X3_TITENG
	{ 'Loja do Cliente Troca NF'											, .T. }, ; //X3_DESCRIC
	{ 'Loja do Cliente Troca NF'											, .T. }, ; //X3_DESCSPA
	{ 'Loja do Cliente Troca NF'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD30288" ) ) ) ;
