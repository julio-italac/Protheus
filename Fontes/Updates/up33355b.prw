...
/*/
//--------------------------------------------------------------------
User Function UP33355B( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP33355B" )
				Else
					MsgStop( "Atualização não Realizada.", "UP33355B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Hora'																	, ; //X3_TITSPA
	'Hora'																	, ; //X3_TITENG
	'Hora Envio/Recebimento'												, ; //X3_DESCRIC
	'Hora Envio/Recebimento'												, ; //X3_DESCSPA
	'Hora Envio/Recebimento'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	'Rotina'																, ; //X3_TITSPA
	'Rotina'																, ; //X3_TITENG
	'Rotina de execucao'													, ; //X3_DESCRIC
	'Rotina de execucao'													, ; //X3_DESCSPA
	'Rotina de execucao'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP33355B" ) ) ) ;
