...
/*/
//--------------------------------------------------------------------
User Function UP41946( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP41946" )
				Else
					MsgStop( "Atualização não Realizada.", "UP41946" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX7, { ;
	'ZZI_DTINIC'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'U_ACOM03DT("ZZI_DTINIC")'												, ; //X7_REGRA
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP41946" ) ) ) ;
