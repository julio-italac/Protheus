...
/*/
//--------------------------------------------------------------------
User Function UPD29718( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD29718" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD29718" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZL6'																	, .T. }, ; //X3_ARQUIVO
	{ '95'																	, .T. }, ; //X3_ORDEM
	{ 'ZL6_REDIME'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Rendimento?'															, .T. }, ; //X3_TITULO
	{ 'Rendimento?'															, .T. }, ; //X3_TITSPA
	{ 'Rendimento?'															, .T. }, ; //X3_TITENG
	{ 'Rendimento?'															, .T. }, ; //X3_DESCRIC
	{ 'Rendimento?'															, .T. }, ; //X3_DESCSPA
	{ 'Rendimento?'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'ZZL'																	, .T. }, ; //X3_ARQUIVO
	{ '62'																	, .T. }, ; //X3_ORDEM
	{ 'ZZL_FCUSTO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Fecha Custo'															, .T. }, ; //X3_TITULO
	{ 'Fecha Custo'															, .T. }, ; //X3_TITSPA
	{ 'Fecha Custo'															, .T. }, ; //X3_TITENG
	{ 'Fecha custo gerencial'												, .T. }, ; //X3_DESCRIC
	{ 'Fecha custo gerencial'												, .T. }, ; //X3_DESCSPA
	{ 'Fecha custo gerencial'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD29718" ) ) ) ;
