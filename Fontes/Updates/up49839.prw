...
/*/
//--------------------------------------------------------------------
User Function UP49839( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgInfo( "Atualização realizada.", "UP49839" )
				Else
					MsgStop( "Atualização não realizada.", "UP49839" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_NRATCC'															, .T. }, ; //X3_CAMPO
	{ 'L'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nao Rat. CC'															, .T. }, ; //X3_TITULO
	{ 'Nao Rat. CC'															, .T. }, ; //X3_TITSPA
	{ 'Nao Rat. CC'															, .T. }, ; //X3_TITENG
	{ 'Nao rat. p/ Centro Cust0'											, .T. }, ; //X3_DESCRIC
	{ 'Nao rat. p/ Centro Cust0'											, .T. }, ; //X3_DESCSPA
	{ 'Nao rat. p/ Centro Cust0'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_ACONTA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Conta Corren'														, .T. }, ; //X3_TITULO
	{ 'Conta Corren'														, .T. }, ; //X3_TITSPA
	{ 'Conta Corren'														, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("SED") .or. Vazio()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_ACCON'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Conta Cont.'															, .T. }, ; //X3_TITULO
	{ 'Conta Cont.'															, .T. }, ; //X3_TITSPA
	{ 'Conta Cont.'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	{ 'Centro Custo'														, .T. }, ; //X3_DESCSPA
	{ 'Centro Custo'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'ExistCpo("CTT")  .OR. Vazio()'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_RCCON'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Conta Contab'														, .T. }, ; //X3_TITULO
	{ 'Conta Contab'														, .T. }, ; //X3_TITSPA
	{ 'Conta Contab'														, .T. }, ; //X3_TITENG
	{ 'Conta Contabil'														, .T. }, ; //X3_DESCRIC
	{ 'Conta Contabil'														, .T. }, ; //X3_DESCSPA
	{ 'Conta Contabil'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_EMAILW'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 200																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Email Dp Com'														, .T. }, ; //X3_TITULO
	{ 'Email Dp Com'														, .T. }, ; //X3_TITSPA
	{ 'Email Dp Com'														, .T. }, ; //X3_TITENG
	{ 'Email Depto Comercial'												, .T. }, ; //X3_DESCRIC
	{ 'Email Depto Comercial'												, .T. }, ; //X3_DESCSPA
	{ 'Email Depto Comercial'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_EMAILF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 200																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Email Dp Fin'														, .T. }, ; //X3_TITULO
	{ 'Email Dp Fin'														, .T. }, ; //X3_TITSPA
	{ 'Email Dp Fin'														, .T. }, ; //X3_TITENG
	{ 'Email Depto Financeiro'												, .T. }, ; //X3_DESCRIC
	{ 'Email Depto Financeiro'												, .T. }, ; //X3_DESCSPA
	{ 'Email Depto Financeiro'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'Z30'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'Z30_NINTFI'															, .T. }, ; //X3_CAMPO
	{ 'L'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nao Int Fin'															, .T. }, ; //X3_TITULO
	{ 'Nao Int Fin'															, .T. }, ; //X3_TITSPA
	{ 'Nao Int Fin'															, .T. }, ; //X3_TITENG
	{ 'Nao Integra Financeiro'												, .T. }, ; //X3_DESCRIC
	{ 'Nao Integra Financeiro'												, .T. }, ; //X3_DESCSPA
	{ 'Nao Integra Financeiro'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP49839" ) ) ) ;
