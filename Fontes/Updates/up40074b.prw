...
/*/
//--------------------------------------------------------------------
User Function UP40074B( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP40074B" )
				Else
					MsgStop( "Atualização não Realizada.", "UP40074B" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ZF5'																	, .T. }, ; //X3_ARQUIVO
	{ '98'																	, .T. }, ; //X3_ORDEM
	{ 'ZF5_CODRDC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod.Ocor.RDC'														, .T. }, ; //X3_TITULO
	{ 'Cod.Ocor.RDC'														, .T. }, ; //X3_TITSPA
	{ 'Cod.Ocor.RDC'														, .T. }, ; //X3_TITENG
	{ 'Codigo Ocorrencia RDC'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo Ocorrencia RDC'												, .T. }, ; //X3_DESCSPA
	{ 'Codigo Ocorrencia RDC'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Código Ocorrência RDC' )

PutSX1Help( "PZF5_CODRDC", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZF5_CODRDC" )
...
PutSX1Help( "PZFO_CODRDC", aHlpPor, {}, {}, .T.,,.T. )
AutoGrLog( "Atualizado o Help do campo " + "ZFO_CODRDC" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP40074B" ) ) ) ;
