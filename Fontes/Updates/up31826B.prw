...
/*/
//--------------------------------------------------------------------
User Function UP31826B( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	{ 'SZW'																	, .T. }, ; //X3_ARQUIVO
	{ 'B1'																	, .T. }, ; //X3_ORDEM
	{ 'ZW_I_PEDDW'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Pedido DW'															, .T. }, ; //X3_TITULO
	{ 'Pedido DW'															, .T. }, ; //X3_TITSPA
	{ 'Pedido DW'															, .T. }, ; //X3_TITENG
	{ 'Pedido DW'															, .T. }, ; //X3_DESCRIC
	{ 'Pedido DW'															, .T. }, ; //X3_DESCSPA
	{ 'Pedido DW'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Item DW'																, .T. }, ; //X3_TITSPA
	{ 'Item DW'																, .T. }, ; //X3_TITENG
	{ 'Item DW'																, .T. }, ; //X3_DESCRIC
	{ 'Item DW'																, .T. }, ; //X3_DESCSPA
	{ 'Item DW'																, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
