...
/*/
//--------------------------------------------------------------------
User Function UPD33443( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD33443" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD33443" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Alt Dt ULMES'															, ; //X3_TITULO
	'Alt Dt ULMES'															, ; //X3_TITSPA
	'Alt Dt ULMES'															, ; //X3_TITENG
	'Alterar Data MV_ULMES'													, ; //X3_DESCRIC
	'Alterar Data MV_ULMES'													, ; //X3_DESCSPA
	'Alterar Data MV_ULMES'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD33443" ) ) ) ;
