...
/*/
//--------------------------------------------------------------------
User Function UPD44503( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UPD44503" )
				Else
					MsgStop( "Atualização não realizada.", "UPD44503" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	'ZS6'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'ZS6'+cEmpr																, ; //X2_ARQUIVO
	'Cadastro de Subsequencia'												, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
	'ZS6_FILIAL+ZS6_CODSEG+ZS6_CODSUB'										, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	''																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'CL'																	, .T. }, ; //X3_ORDEM
	{ 'A1_I_SUBCO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 5																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod.Subseg'															, .T. }, ; //X3_TITULO
	{ 'Cod.Subseg'															, .T. }, ; //X3_TITSPA
	{ 'Cod.Subseg'															, .T. }, ; //X3_TITENG
	{ 'Cod. Subseguime'														, .T. }, ; //X3_DESCRIC
	{ 'Cod. Subseguime'														, .T. }, ; //X3_DESCSPA
	{ 'Cod. Subseguime'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'U_AOMS31Val()'														, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SA1'																	, .T. }, ; //X3_ARQUIVO
	{ 'CL'																	, .T. }, ; //X3_ORDEM
	{ 'A1_I_SUBDE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Subseguime'															, .T. }, ; //X3_TITULO
	{ 'Subseguime'															, .T. }, ; //X3_TITSPA
	{ 'Subseguime'															, .T. }, ; //X3_TITENG
	{ 'Subseguime'															, .T. }, ; //X3_DESCRIC
	{ 'Subseguime'															, .T. }, ; //X3_DESCSPA
	{ 'Subseguime'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'IF(INCLUI,"",POSICIONE("ZS6",1,XFILIAL()+SA1->A1_I_GRCLI+SA1->A1_I_SUBCO,"ZS6_DESCRI"))', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'E_Field2(SA1->A1_I_GRCLI+SA1->A1_I_SUBCO,"ZS6",1,"ZS6_DESCRI")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ '1'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'IF(INCLUI,"",POSICIONE("ZS6",1,XFILIAL()+SZX->ZX_GRCLI+SZX->ZX_SUB_COD,"ZS6_DESCRI"))', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'E_Field2(SZX->ZX_GRCLI+SZX->ZX_SUB_COD,"ZS6",1,"ZS6_DESCRI")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'ZS6'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZS6_CODSEG'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod.Seguim'															, .T. }, ; //X3_TITULO
	{ 'Cod.Seguim'															, .T. }, ; //X3_TITSPA
	{ 'Cod.Seguim'															, .T. }, ; //X3_TITENG
	{ 'Cod. Seguimento'														, .T. }, ; //X3_DESCRIC
	{ 'Cod. Seguimento'														, .T. }, ; //X3_DESCSPA
	{ 'Cod. Seguimento'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'U_AOMS31Val()'														, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Descricao do Sub'													, .T. }, ; //X3_DESCRIC
	{ 'Descricao do Sub'													, .T. }, ; //X3_DESCSPA
	{ 'Descricao do Sub'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'IF(INCLUI,"",POSICIONE("ZZ6",1,XFILIAL("ZZ6")+ZS6->ZS6_CODSEG,"ZZ6_DESCRO"))', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'E_Field2(ZS6->ZS6_CODSEG,"ZZ6",1,"ZZ6_DESCRO")'						, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'Cod.Subseg'															, .T. }, ; //X3_TITSPA
	{ 'Cod.Subseg'															, .T. }, ; //X3_TITENG
	{ 'Cod. Subseguimento'													, .T. }, ; //X3_DESCRIC
	{ 'Cod. Subseguimento'													, .T. }, ; //X3_DESCSPA
	{ 'Cod. Subseguimento'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'U_AOMS31Val()'														, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x xx', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSIX, { ;
	'ZS6'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZS6_FILIAL+ZS6_CODSEG+ZS6_CODSUB'										, ; //CHAVE
	'Cod. Seguimento + Cod. Subseguimento'									, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'ZS6'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZS6_FILIAL+ZS6_DESCRI'													, ; //CHAVE
	'Descricao dos Subseguimentos'											, ; //DESCRICAO
	''																		, ; //DESCSPA
	''																		, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Subseguimentos'														, ; //XB_DESCRI
	'Subseguimentos'														, ; //XB_DESCSPA
	'Subseguimentos'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZS6'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod. Subseguimento'													, ; //XB_DESCRI
	'Cod. Subseguimento'													, ; //XB_DESCSPA
	'Cod. Subseguimento'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZS6_CODSUB'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Cod. Seguimento'														, ; //XB_DESCRI
	'Cod. Seguimento'														, ; //XB_DESCSPA
	'Cod. seguimento'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZS6_CODSEG'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'Nome Subseguimento'													, ; //XB_DESCRI
	'Nome Subseguimento'													, ; //XB_DESCSPA
	'Nome Subseguimento'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZS6_DESCRI'															} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD44503" ) ) ) ;
