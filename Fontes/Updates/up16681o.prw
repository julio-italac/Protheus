...
ฑฑบ Programa ณ UP16681O บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UP16681O   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UP16681O( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UP16681O" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UP16681O" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Enviado RDC?'															, ; //X3_TITULO
	'Enviado RDC?'															, ; //X3_TITSPA
	'Enviado RDC?'															, ; //X3_TITENG
	'Enviado para RDC?'														, ; //X3_DESCRIC
	'Enviado para RDC?'														, ; //X3_DESCSPA
	'Enviado para RDC?'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Pertence("SNR")'														, ; //X3_VLDUSER
	'S=Sim;N=Nao;R=Retorno'													, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Descr.Sit.Pd'															, ; //X3_TITULO
	'Descr.Sit.Pd'															, ; //X3_TITSPA
	'Descr.Sit.Pd'															, ; //X3_TITENG
	'Descricao Situacao Pedido'												, ; //X3_DESCRIC
	'Descricao Situacao Pedido'												, ; //X3_DESCSPA
	'Descricao Situacao Pedido'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'TABELA("W0",ZFQ->ZFQ_SITPED,.F.)'										, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX5 บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX5, { ;
	...
	'00'																	, ; //X5_TABELA
	'W0'																	, ; //X5_CHAVE
	'SITUACAO DOS PEDIDOS DE VENDAS'										, ; //X5_DESCRI
	'SITUACAO DOS PEDIDOS DE VENDAS'										, ; //X5_DESCSPA
	'SITUACAO DOS PEDIDOS DE VENDAS'										} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'W0'																	, ; //X5_TABELA
	'01'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA EM ABERTO'												, ; //X5_DESCRI
	'PEDIDO DE VENDA EM ABERTO'												, ; //X5_DESCSPA
	'PEDIDO DE VENDA EM ABERTO'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'02'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA ENCERRADO'												, ; //X5_DESCRI
	'PEDIDO DE VENDA ENCERRADO'												, ; //X5_DESCSPA
	'PEDIDO DE VENDA ENCERRADO'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'03'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA LIBERADO'												, ; //X5_DESCRI
	'PEDIDO DE VENDA LIBERADO'												, ; //X5_DESCSPA
	'PEDIDO DE VENDA LIBERADO'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'04'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BLOQUEIO DE REGRA'									, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BLOQUEIO DE REGRA'									, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BLOQUEIO DE REGRA'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'05'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BLOQUEIO DE VERBA'									, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BLOQUEIO DE VERBA'									, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BLOQUEIO DE VERBA'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'06'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BLOQUEIO DE BONIFICACAO'							, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BLOQUEIO DE BONIFICACAO'							, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BLOQUEIO DE BONIFICACAO'							} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'07'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BONIFICACAO REJEITADA'								, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BONIFICACAO REJEITADA'								, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BONIFICACAO REJEITADA'								} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'08'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BLOQUEIO DE PRECO'									, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BLOQUEIO DE PRECO'									, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BLOQUEIO DE PRECO'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'09'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM PRECO REJEITADO'									, ; //X5_DESCRI
	'PEDIDO DE VENDA COM PRECO REJEITADO'									, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM PRECO REJEITADO'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'10'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM BLOQUEIO DE CREDITO'								, ; //X5_DESCRI
	'PEDIDO DE VENDA COM BLOQUEIO DE CREDITO'								, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM BLOQUEIO DE CREDITO'								} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'11'																	, ; //X5_CHAVE
	'PEDIDO DE VENDA COM CREDITO REJEITADO'									, ; //X5_DESCRI
	'PEDIDO DE VENDA COM CREDITO REJEITADO'									, ; //X5_DESCSPA
	'PEDIDO DE VENDA COM CREDITO REJEITADO'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'12'																	, ; //X5_CHAVE
	'PEDIDO CARREGAMENTO TROCA NOTA ABERTO'									, ; //X5_DESCRI
	'PEDIDO CARREGAMENTO TROCA NOTA ABERTO'									, ; //X5_DESCSPA
	'PEDIDO CARREGAMENTO TROCA NOTA ABERTO'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'13'																	, ; //X5_CHAVE
	'PEDIDO CARREGAMENTO TROCA NOTA LIBERADO'								, ; //X5_DESCRI
	'PEDIDO CARREGAMENTO TROCA NOTA LIBERADO'								, ; //X5_DESCSPA
	'PEDIDO CARREGAMENTO TROCA NOTA LIBERADO'								} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'14'																	, ; //X5_CHAVE
	'PEDIDO FATURAMENTO TROCA NOTA ABERTO'									, ; //X5_DESCRI
	'PEDIDO FATURAMENTO TROCA NOTA ABERTO'									, ; //X5_DESCSPA
	'PEDIDO FATURAMENTO TROCA NOTA ABERTO'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'01'																	, ; //X5_FILIAL
	'W0'																	, ; //X5_TABELA
	'15'																	, ; //X5_CHAVE
	'PEDIDO FATURAMENTO TROCA NOTA LIBERADO'								, ; //X5_DESCRI
	'PEDIDO FATURAMENTO TROCA NOTA LIBERADO'								, ; //X5_DESCSPA
	'PEDIDO FATURAMENTO TROCA NOTA LIBERADO'								} ) //X5_DESCENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX9 บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX9 - Relacionament ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX9   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Descri็ใo da Situa็ใo do Pedido de' )
aAdd( aHlpPor, 'Vendas.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZFQ_DSCSIT", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZFQ_DSCSIT" + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  18/05/17   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
