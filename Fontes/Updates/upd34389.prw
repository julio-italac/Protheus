...
/*/
//--------------------------------------------------------------------
User Function UPD34389( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD34389" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD34389" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	3																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Temp. Operac'															, ; //X3_TITULO
	'Temp. Operac'															, ; //X3_TITSPA
	'Temp. Operac'															, ; //X3_TITENG
	'Tempo Operacional'														, ; //X3_DESCRIC
	'Tempo Operacional'														, ; //X3_DESCSPA
	'Tempo Operacional'														, ; //X3_DESCENG
	'@E 999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD34389" ) ) ) ;
