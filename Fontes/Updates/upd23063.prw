...
/*/
//--------------------------------------------------------------------
User Function UPD23063( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD23063" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD23063" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'NNS'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'NNS_SOLICN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Solic'															, .T. }, ; //X3_TITULO
	{ 'Nome Solic'															, .T. }, ; //X3_TITSPA
	{ 'Nome Solic'															, .T. }, ; //X3_TITENG
	{ 'Nome solicitante'													, .T. }, ; //X3_DESCRIC
	{ 'Nome solicitante'													, .T. }, ; //X3_DESCSPA
	{ 'Nome solicitante'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'ALLTRIM(UsrFullName(RetCodUsr()))'									, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'ALLTRIM(UsrFullName(NNS->NNS_SOLICT))'								, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'NNT'																	, .T. }, ; //X3_ARQUIVO
	{ '03'																	, .T. }, ; //X3_ORDEM
	{ 'NNT_FILORI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Filial Orig.'														, .T. }, ; //X3_TITULO
	{ 'Sucur. Orig.'														, .T. }, ; //X3_TITSPA
	{ 'Orig.Br.'															, .T. }, ; //X3_TITENG
	{ 'Filial Origem'														, .T. }, ; //X3_DESCRIC
...
aAdd( aSX3, { ;
	{ 'NNT'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'NNT_FILDES'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Filial Dest.'														, .T. }, ; //X3_TITULO
	{ 'Sucursal Des'														, .T. }, ; //X3_TITSPA
	{ 'Dest.Br.'															, .T. }, ; //X3_TITENG
	{ 'Filial Destino'														, .T. }, ; //X3_DESCRIC
	{ 'Sucursal Destino'													, .T. }, ; //X3_DESCSPA
	{ 'Destination Branch'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'cFilAnt'																, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'NNT'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'NNT_PRODD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 15																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Prod.Destino'														, .T. }, ; //X3_TITULO
	{ 'Prod.Destino'														, .T. }, ; //X3_TITSPA
	{ 'Dest.Prod.'															, .T. }, ; //X3_TITENG
	{ 'Produto Destino'														, .T. }, ; //X3_DESCRIC
	{ 'Producto Destino'													, .T. }, ; //X3_DESCSPA
	{ 'Destination Product'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'A311VPrdDs()'														, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
	{ 'SB1FIL'																, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	{ 'ZZL'																	, .T. }, ; //X3_ARQUIVO
	{ '9M'																	, .T. }, ; //X3_ORDEM
	{ 'ZZL_ARMEFE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 250																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Arms Efeti'															, .T. }, ; //X3_TITULO
	{ 'Arms Efeti'															, .T. }, ; //X3_TITSPA
	{ 'Arms Efeti'															, .T. }, ; //X3_TITENG
	{ 'Armazens de EfetiVACAO'												, .T. }, ; //X3_DESCRIC
	{ 'Armazens de EfetiVACAO'												, .T. }, ; //X3_DESCSPA
	{ 'Armazens de EfetiVACAO'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD23063" ) ) ) ;
