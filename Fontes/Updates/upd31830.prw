...
/*/
//--------------------------------------------------------------------
User Function UPD31830( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD31830" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD31830" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'DAK'																	, .T. }, ; //X3_ARQUIVO
	{ 'W6'																	, .T. }, ; //X3_ORDEM
	{ 'DAK_I_ROTE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'No.Roteirizador'														, .T. }, ; //X3_TITULO
	{ 'No.Roteirizador'														, .T. }, ; //X3_TITSPA
	{ 'No.Roteirizador'														, .T. }, ; //X3_TITENG
	{ 'No. Carga no Roteirizador'											, .T. }, ; //X3_DESCRIC
	{ 'No. Carga no Roteirizador'											, .T. }, ; //X3_DESCSPA
	{ 'No. Carga no Roteirizador'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SA3'																	, .T. }, ; //X3_ARQUIVO
	{ 'W6'																	, .T. }, ; //X3_ORDEM
	{ 'A3_I_ROTE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Roteirizar?'															, .T. }, ; //X3_TITULO
	{ 'Roteirizar?'															, .T. }, ; //X3_TITSPA
	{ 'Roteirizar?'															, .T. }, ; //X3_TITENG
	{ 'Roteirizar?'															, .T. }, ; //X3_DESCRIC
	{ 'Roteirizar?'															, .T. }, ; //X3_DESCSPA
	{ 'Roteirizar?'															, .T. }, ; //X3_DESCENG
	{ '9'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD31830" ) ) ) ;
