...
/*/
//--------------------------------------------------------------------
User Function UPD36102( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD36102" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD36102" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Obs ITALAC'															, .T. }, ; //X3_TITULO
	{ 'Obs ITALAC'															, .T. }, ; //X3_TITSPA
	{ 'Obs ITALAC'															, .T. }, ; //X3_TITENG
	{ 'Obs ITALAC'															, .T. }, ; //X3_DESCRIC
	{ 'Obs ITALAC'															, .T. }, ; //X3_DESCSPA
	{ 'Obs ITALAC'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'Note'																, .T. }, ; //X3_TITENG
	{ 'Observacao dos Movimentos'											, .T. }, ; //X3_DESCRIC
	{ 'Observacion de movimiento'											, .T. }, ; //X3_DESCSPA
	{ 'Observation of Movements'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD36102" ) ) ) ;
