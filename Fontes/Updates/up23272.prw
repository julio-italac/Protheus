...
/*/
//--------------------------------------------------------------------
User Function UP23272( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UP23272" )
				Else
					MsgStop( "Atualização não Realizada.", "UP23272" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'Tipos de Agendamento'													, ; //XB_DESCRI
	'Tipos de Agendamento'													, ; //XB_DESCSPA
	'Tipos de Agendamento'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SC5'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP23272" ) ) ) ;
