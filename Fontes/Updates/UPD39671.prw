...
/*/
//--------------------------------------------------------------------
User Function UIPD3941( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UIPD3941" )
				Else
					MsgStop( "Atualização não Realizada.", "UIPD3941" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SE1'																	, .T. }, ; //X3_ARQUIVO
	{ 'F0'																	, .T. }, ; //X3_ORDEM
	{ 'E1_I_CLIEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cli Remessa'															, .T. }, ; //X3_TITULO
	{ 'Cli Remessa'															, .T. }, ; //X3_TITSPA
	{ 'Cli Remessa'															, .T. }, ; //X3_TITENG
	{ 'Codigo do Cliente de Reme'											, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Cliente de Reme'											, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Cliente de Reme'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SE1'																	, .T. }, ; //X3_ARQUIVO
	{ 'F0'																	, .T. }, ; //X3_ORDEM
	{ 'E1_I_LOJEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loj Remessa'															, .T. }, ; //X3_TITULO
	{ 'Loj Remessa'															, .T. }, ; //X3_TITSPA
	{ 'Loj Remessa'															, .T. }, ; //X3_TITENG
	{ 'Loja do Cliente de Remess'											, .T. }, ; //X3_DESCRIC
	{ 'Loja do Cliente de Remess'											, .T. }, ; //X3_DESCSPA
	{ 'Loja do Cliente de Remess'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SE1'																	, .T. }, ; //X3_ARQUIVO
	{ 'F0'																	, .T. }, ; //X3_ORDEM
	{ 'E1_I_NOMEN'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Cli Rem'														, .T. }, ; //X3_TITULO
	{ 'Nome Cli Rem'														, .T. }, ; //X3_TITSPA
	{ 'Nome Cli Rem'														, .T. }, ; //X3_TITENG
	{ 'Nome do Cliente de Remess'											, .T. }, ; //X3_DESCRIC
	{ 'Nome do Cliente de Remess'											, .T. }, ; //X3_DESCSPA
	{ 'Nome do Cliente de Remess'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ 'IF(!INCLUI,POSICIONE("SA1",1,XFILIAL("SA1")+SE1->E1_I_CLIEN+SE1->E1_I_LOJEN,"A1_NOME"),"")', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 1																		, .T. }, ; //X3_NIVEL
	{ 'xxxxxx x'															, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SA1",1,XFILIAL("SA1")+SE1->E1_I_CLIEN+SE1->E1_I_LOJEN,"A1_NOME")', .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ '1'																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UIPD3941" ) ) ) ;
