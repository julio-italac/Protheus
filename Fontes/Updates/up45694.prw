...
/*/
//--------------------------------------------------------------------
User Function UP45694( cEmpAmb, cFilAmb )
Local   aSay      := {}
Local   aButton   := {}
Local   aMarcadas := {}
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização realizada.", "UP45694" )
				Else
					MsgStop( "Atualização não realizada.", "UP45694" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nao Int Fin'															, ; //X3_TITULO
	'Nao Int Fin'															, ; //X3_TITSPA
	'Nao Int Fin'															, ; //X3_TITENG
	'Nao Integra Financeiro'												, ; //X3_DESCRIC
	'Nao Integra Financeiro'												, ; //X3_DESCSPA
	'Nao Integra Financeiro'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UP45694" ) ) ) ;
