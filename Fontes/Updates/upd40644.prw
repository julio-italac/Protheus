...
/*/
//--------------------------------------------------------------------
User Function UPD40644( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPD40644" )
				Else
					MsgStop( "Atualização não Realizada.", "UPD40644" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_QTDA'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd Agendam'															, .T. }, ; //X3_TITULO
	{ 'Qtd Agendam'															, .T. }, ; //X3_TITSPA
	{ 'Qtd Agendam'															, .T. }, ; //X3_TITENG
	{ 'Quantidade de Agendamento'											, .T. }, ; //X3_DESCRIC
	{ 'Quantidade de Agendamento'											, .T. }, ; //X3_DESCSPA
	{ 'Quantidade de Agendamento'											, .T. }, ; //X3_DESCENG
	{ '99'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	{ 'SC5'																	, .T. }, ; //X3_ARQUIVO
	{ 'DX'																	, .T. }, ; //X3_ORDEM
	{ 'C5_I_LILO'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lib.p/ Logi'															, .T. }, ; //X3_TITULO
	{ 'Lib.p/ Logi'															, .T. }, ; //X3_TITSPA
	{ 'Lib.p/ Logi'															, .T. }, ; //X3_TITENG
	{ 'Liberacao para a Logistic'											, .T. }, ; //X3_DESCRIC
	{ 'Liberacao para a Logistic'											, .T. }, ; //X3_DESCSPA
	{ 'Liberacao para a Logistic'											, .T. }, ; //X3_DESCENG
	{ '@D'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ 'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', .T. }, ; //X3_USADO
	{ ''																	, .T. }, ; //X3_RELACAO
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPD40644" ) ) ) ;
